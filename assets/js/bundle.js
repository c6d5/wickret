!(function (t) {
                ...
                return (function (t) {
                    ...
                    function (t, e, n) {
                        ...
                        (i.create = function (t, e) {
                            ...
                            (i.centre = function (t) {
                                for (var e, n, o, s = i.area(t, !0), a = { x: 0, y: 0 }, l = 0; l < t.length; l++) (o = (l + 1) % t.length), (e = r.cross(t[l], t[o])), (n = r.mult(r.add(t[l], t[o]), e)), (a = r.add(a, n));
                                return r.div(a, 6 * s);
                            }),
                            (i.mean = function (t) {
                            ...
                            (i.rotate = function (t, e, n) {
                                if (0 !== e) {
                                    var i,
                                        ...
                                        c = n.y,
                                        d = t.length;
                                    for (s = 0; s < d; s++) (r = (i = t[s]).x - u), (o = i.y - c), (i.x = u + (r * a - o * l)), (i.y = c + (r * l + o * a));
                                    return t;
                                }
                            }),
                            ...
                            (i.chamfer = function (t, e, n, i, s) {
                                ...
                                for (var a = [], l = 0; l < t.length; l++) {
                                    ...
                                    if (0 !== p) {
                                        var f = r.normalise({ x: c.y - u.y, y: u.x - c.x }),
                                            h = r.normalise({ x: d.y - c.y, y: c.x - d.x }),
                                            m = Math.sqrt(2 * Math.pow(p, 2)),
                                            v = r.mult(o.clone(f), p),
                                            g = r.normalise(r.mult(r.add(f, h), 0.5)),
                                            y = r.sub(c, r.mult(g, m)),
                                            b = n;
                                        -1 === n && (b = 1.75 * Math.pow(p, 0.32)), (b = o.clamp(b, i, s)) % 2 == 1 && (b += 1);
                                        for (var x = Math.acos(r.dot(f, h)) / b, w = 0; w < b; w++) a.push(r.add(r.rotate(v, x * w), y));
                                    } else a.push(c);
                                }
                                return a;
                            }),
                            ...
                            (i.isConvex = function (t) {
                                ...
                                if (s < 3) return null;
                                for (e = 0; e < s; e++)
                                    if (((i = (e + 2) % s), (r = (t[(n = (e + 1) % s)].x - t[e].x) * (t[i].y - t[n].y)), (r -= (t[n].y - t[e].y) * (t[i].x - t[n].x)) < 0 ? (o |= 1) : r > 0 && (o |= 2), 3 === o)) return !1;
                                return 0 !== o || null;
                            }),
                            (i.hull = function (t) {
                                var e,
                    ...
                    function (t, e, n) {
                        ...
                        (i.create = function (t) {
                            ...
                            (i.setModified = function (t, e, n, r) {
                                if (((t.isModified = e), e && t.cache && ((t.cache.allBodies = null), (t.cache.allConstraints = null), (t.cache.allComposites = null)), n && t.parent && i.setModified(t.parent, e, n, r), r))
                            ...
                            (i.rotate = function (t, e, n, r) {
                                for (var o = Math.cos(e), s = Math.sin(e), l = r ? i.allBodies(t) : t.bodies, u = 0; u < l.length; u++) {
                                    var c = l[u],
                                        d = c.position.x - n.x,
                                        p = c.position.y - n.y;
                                    a.setPosition(c, { x: n.x + (d * o - p * s), y: n.y + (d * s + p * o) }), a.rotate(c, e);
                                }
                                return t;
                            }),
                            (i.scale = function (t, e, n, r, o) {
                                for (var s = o ? i.allBodies(t) : t.bodies, l = 0; l < s.length; l++) {
                                    var u = s[l],
                                        c = u.position.x - r.x,
                                        d = u.position.y - r.y;
                                    a.setPosition(u, { x: r.x + c * e, y: r.y + d * n }), a.scale(u, e, n);
                                }
                                return t;
                            }),
                            (i.bounds = function (t) {
                        ...
                        !(function () {
                            (i._inertiaScale = 4),
                                ...
                                (i.create = function (e) {
                                    var n = {
                                            ...
                                            slop: 0.05,
                                            timeScale: 1,
                                            render: { visible: !0, opacity: 1, strokeStyle: null, fillStyle: null, lineWidth: null, sprite: { xScale: 1, yScale: 1, xOffset: 0, yOffset: 0 } },
                                            events: null,
                                            bounds: null,
                                            chamfer: null,
                                            circleRadius: 0,
                            ...
                            var t = function (t, e) {
                                (e = e || {}),
                                    ...
                                    i.set(t, { axes: e.axes || t.axes, area: e.area || t.area, mass: e.mass || t.mass, inertia: e.inertia || t.inertia });
                            ...
                            (i.set = function (t, e, n) {
                                ...
                                (i.setStatic = function (t, e) {
                                    for (var n = 0; n < t.parts.length; n++) {
                                        ...
                                        (i.isStatic = e),
                                            e
                                                ? ((i._original = { restitution: i.restitution, friction: i.friction, mass: i.mass, inertia: i.inertia, density: i.density, inverseMass: i.inverseMass, inverseInertia: i.inverseInertia }),
                                                  (i.restitution = 0),
                                                  (i.friction = 1),
                                ...
                                (i.setVertices = function (t, e) {
                                    e[0].body === t ? (t.vertices = e) : (t.vertices = r.create(e, t)), (t.axes = u.fromVertices(t.vertices)), (t.area = r.area(t.vertices)), i.setMass(t, t.density * t.area);
                                ...
                                (i.setAngle = function (t, e) {
                                    ...
                                    for (var i = 0; i < t.parts.length; i++) {
                                        var s = t.parts[i];
                                        (s.angle += n), r.rotate(s.vertices, n, t.position), u.rotate(s.axes, n), l.update(s.bounds, s.vertices, t.velocity), i > 0 && o.rotateAbout(s.position, n, t.position, s.position);
                                    }
                                }),
                                ...
                                (i.rotate = function (t, e, n) {
                                    if (n) {
                                        var r = Math.cos(e),
                                            ...
                                            s = t.position.x - n.x,
                                            a = t.position.y - n.y;
                                        i.setPosition(t, { x: n.x + (s * r - a * o), y: n.y + (s * o + a * r) }), i.setAngle(t, t.angle + e);
                                ...
                                (i.update = function (t, e, n, i) {
                                    ...
                                    (t.velocity.x = c * a * i + (t.force.x / t.mass) * s),
                                        ...
                                        (t.angularVelocity = (t.angle - t.anglePrev) * a * i + (t.torque / t.inertia) * s),
                                        (t.anglePrev = t.angle),
                                    ...
                                    for (var p = 0; p < t.parts.length; p++) {
                                        ...
                                        r.translate(f.vertices, t.velocity),
                                            p > 0 && ((f.position.x += t.velocity.x), (f.position.y += t.velocity.y)),
                                            0 !== t.angularVelocity &&
                                                (r.rotate(f.vertices, t.angularVelocity, t.position), u.rotate(f.axes, t.angularVelocity), p > 0 && o.rotateAbout(f.position, t.angularVelocity, t.position, f.position)),
                        ...
                        (i._motionWakeThreshold = 0.18),
                                ...
                                for (var n = e * e * e, r = 0; r < t.length; r++) {
                                    ...
                                    if (0 === o.force.x && 0 === o.force.y) {
                                        ...
                                        (o.motion = i._minBias * a + (1 - i._minBias) * l),
                                            o.sleepThreshold > 0 && o.motion < i._motionSleepThreshold * n ? ((o.sleepCounter += 1), o.sleepCounter >= o.sleepThreshold && i.set(o, !0)) : o.sleepCounter > 0 && (o.sleepCounter -= 1);
                                    } else i.set(o, !1);
                                }
                            }),
                                    ...
                                    if (o.isActive) {
                                        ...
                                        if (!((a.isSleeping && l.isSleeping) || a.isStatic || l.isStatic) && (a.isSleeping || l.isSleeping)) {
                                            var u = a.isSleeping && !a.isStatic ? a : l,
                                                c = u === a ? l : a;
                                            !u.isStatic && c.motion > i._motionWakeThreshold * n && i.set(u, !1);
                                        }
                                    }
                                }
                            }),
                            (i.set = function (t, e) {
                                ...
                                e
                                    ...
                                    : ((t.isSleeping = !1), (t.sleepCounter = 0), n && r.trigger(t, "sleepEnd"));
                            });
                    },
                    function (t, e, n) {
                        var i = {};
                        ...
                        (r = []),
                            ...
                            (i.create = function (t, e) {
                                return { pair: null, collided: !1, bodyA: t, bodyB: e, parentA: t.parent, parentB: e.parent, depth: 0, normal: { x: 0, y: 0 }, tangent: { x: 0, y: 0 }, penetration: { x: 0, y: 0 }, supports: [] };
                            }),
                            (i.collides = function (t, e, n) {
                                ...
                                c ? (r = c.collision) : (((r = i.create(t, e)).collided = !0), (r.bodyA = t.id < e.id ? t : e), (r.bodyB = t.id < e.id ? e : t), (r.parentA = r.bodyA.parent), (r.parentB = r.bodyB.parent)),
                                    (t = r.bodyA),
                                    (e = r.bodyB),
                                ...
                                var d = r.normal,
                                    ...
                                    h = f.x,
                                    m = f.y;
                                h * (e.position.x - t.position.x) + m * (e.position.y - t.position.y) < 0 ? ((d.x = h), (d.y = m)) : ((d.x = -h), (d.y = -m)),
                                    (r.tangent.x = -d.y),
                                    (r.tangent.y = d.x),
                                    (r.depth = u.overlap),
                                ...
                                var v = i._findSupports(t, e, d, 1),
                                    g = 0;
                                if ((a.contains(t.vertices, v[0]) && (p[g++] = v[0]), a.contains(t.vertices, v[1]) && (p[g++] = v[1]), g < 2)) {
                                    var y = i._findSupports(e, t, d, -1);
                                    a.contains(e.vertices, y[0]) && (p[g++] = y[0]), g < 2 && a.contains(e.vertices, y[1]) && (p[g++] = y[1]);
                                }
                            ...
                            (i._overlapAxes = function (t, e, n, i) {
                                ...
                                for (l = 0; l < v; l++) {
                                    var b = i[l],
                                        ...
                                        S = D,
                                        C = _;
                                    for (u = 1; u < c; u += 1) (a = e[u].x * x + e[u].y * w) > S ? (S = a) : a < D && (D = a);
                                    for (u = 1; u < d; u += 1) (a = n[u].x * x + n[u].y * w) > C ? (C = a) : a < _ && (_ = a);
                                    if ((r = (o = S - _) < (s = C - D) ? o : s) < g && ((g = r), (y = l), r <= 0)) break;
                                }
                            ...
                            (i._findSupports = function (t, e, n, i) {
                                var o,
                                    ...
                                    m = n.y * i,
                                    v = Number.MAX_VALUE;
                                for (u = 0; u < d; u += 1) (l = h * (p - (s = c[u]).x) + m * (f - s.y)) < v && ((v = l), (o = s));
                                return (v = h * (p - (a = c[(d + o.index - 1) % d]).x) + m * (f - a.y)), h * (p - (s = c[(o.index + 1) % d]).x) + m * (f - s.y) < v ? ((r[0] = o), (r[1] = s), r) : ((r[0] = o), (r[1] = a), r);
                            });
                    },
                    function (t, e, n) {
                        var i = {};
                        ...
                        (i.create = function (t, e) {
                            ...
                            (i.update = function (t, e, n) {
                                ...
                                (t.isActive = !0),
                                    ...
                                    (t.friction = a.friction < l.friction ? a.friction : l.friction),
                                    (t.frictionStatic = a.frictionStatic > l.frictionStatic ? a.frictionStatic : l.frictionStatic),
                                    (t.restitution = a.restitution > l.restitution ? a.restitution : l.restitution),
                    ...
                    function (t, e, n) {
                        ...
                        (i._warming = 0.4),
                            ...
                            (i.create = function (t) {
                                ...
                                return 0 === e.length && e.stiffness > 0.1 ? ((s.type = "pin"), (s.anchors = !1)) : e.stiffness < 0.9 && (s.type = "spring"), (e.render = u.extend(s, e.render)), e;
                            }),
                            ...
                            (i.solve = function (t, e) {
                                ...
                                if (n || r) {
                                    ...
                                    var l = s,
                                        u = a;
                                    if ((n && (l = o.add(n.position, s)), r && (u = o.add(r.position, a)), l && u)) {
                                        var c = o.sub(l, u),
                                            d = o.magnitude(c);
                                        ...
                                        var p,
                                            ...
                                            w = x + ((n ? n.inverseInertia : 0) + (r ? r.inverseInertia : 0));
                                        if (t.damping) {
                                            var D = o.create();
                                            (h = o.div(c, d)), (v = o.sub((r && o.sub(r.position, r.positionPrev)) || D, (n && o.sub(n.position, n.positionPrev)) || D)), (m = o.dot(h, v));
                                        }
                                        n &&
                                            !n.isStatic &&
                                            ((f = n.inverseMass / x),
                                            ...
                                            (n.position.x -= b.x * f),
                                            (n.position.y -= b.y * f),
                                            t.damping && ((n.positionPrev.x -= t.damping * h.x * m * f), (n.positionPrev.y -= t.damping * h.y * m * f)),
                                            (p = (o.cross(s, b) / w) * i._torqueDampen * n.inverseInertia * (1 - t.angularStiffness)),
                                            ...
                                            r &&
                                                ...
                                                (r.position.x += b.x * f),
                                                (r.position.y += b.y * f),
                                                t.damping && ((r.positionPrev.x += t.damping * h.x * m * f), (r.positionPrev.y += t.damping * h.y * m * f)),
                                                (p = (o.cross(a, b) / w) * i._torqueDampen * r.inverseInertia * (1 - t.angularStiffness)),
                                    ...
                                    if (!(n.isStatic || (0 === u.x && 0 === u.y && 0 === u.angle))) {
                                        ...
                                        for (var c = 0; c < n.parts.length; c++) {
                                            ...
                                            r.translate(d.vertices, u),
                                                c > 0 && ((d.position.x += u.x), (d.position.y += u.y)),
                                                0 !== u.angle && (r.rotate(d.vertices, u.angle, n.position), l.rotate(d.axes, u.angle), c > 0 && o.rotateAbout(d.position, u.angle, n.position, d.position)),
                    ...
                    function (t, e, n) {
                        ...
                        (i.fromVertices = function (t) {
                            for (var e = {}, n = 0; n < t.length; n++) {
                                var i = (n + 1) % t.length,
                                    s = r.normalise({ x: t[i].y - t[n].y, y: t[n].x - t[i].x }),
                                    a = 0 === s.y ? 1 / 0 : s.x / s.y;
                    ...
                    function (t, e, n) {
                        ...
                        (i.rectangle = function (t, e, n, i, a) {
                            ...
                            if (a.chamfer) {
                                var u = a.chamfer;
                                (l.vertices = r.chamfer(l.vertices, u.radius, u.quality, u.qualityMin, u.qualityMax)), delete a.chamfer;
                            }
                            ...
                            (i.trapezoid = function (t, e, n, i, a, l) {
                                ...
                                var u,
                                    ...
                                    d = c + (1 - 2 * a) * n,
                                    p = d + c;
                                u = a < 0.5 ? "L 0 0 L " + c + " " + -i + " L " + d + " " + -i + " L " + p + " 0" : "L 0 0 L " + d + " " + -i + " L " + p + " 0";
                                var f = { label: "Trapezoid Body", position: { x: t, y: e }, vertices: r.fromPath(u) };
                                if (l.chamfer) {
                                    var h = l.chamfer;
                                    (f.vertices = r.chamfer(f.vertices, h.radius, h.quality, h.qualityMin, h.qualityMax)), delete l.chamfer;
                                }
                            ...
                            (i.polygon = function (t, e, n, a, l) {
                                ...
                                for (var u = (2 * Math.PI) / n, c = "", d = 0.5 * u, p = 0; p < n; p += 1) {
                                    var f = d + p * u,
                                        h = Math.cos(f) * a,
                                        m = Math.sin(f) * a;
                                    c += "L " + h.toFixed(3) + " " + m.toFixed(3) + " ";
                                }
                                var v = { label: "Polygon Body", position: { x: t, y: e }, vertices: r.fromPath(c) };
                                if (l.chamfer) {
                                    var g = l.chamfer;
                                    (v.vertices = r.chamfer(v.vertices, g.radius, g.quality, g.qualityMin, g.qualityMax)), delete l.chamfer;
                                }
                            ...
                            (i.fromVertices = function (t, e, n, i, u, c, d, p) {
                                var f,
                                    ...
                                    _ = o.getDecomp();
                                for (
                                    f = Boolean(_ && _.quickDecomp), i = i || {}, m = [], u = void 0 !== u && u, c = void 0 !== c ? c : 0.01, d = void 0 !== d ? d : 10, p = void 0 !== p ? p : 0.01, o.isArray(n[0]) || (n = [n]), w = 0;
                                    w < n.length;
                                    w += 1
                                )
                                    if (
                                        ((g = n[w]),
                                        !(v = r.isConvex(g)) && !f && o.warnOnce("Bodies.fromVertices: Install the 'poly-decomp' library and use Common.setDecomp or provide 'decomp' as a global to decompose concave vertices."),
                                        v || !f)
                                    )
                                        (g = v ? r.clockwiseSort(g) : r.hull(g)), m.push({ position: { x: t, y: e }, vertices: g });
                                    else {
                                        var S = g.map(function (t) {
                                            return [t.x, t.y];
                                        });
                                        _.makeCCW(S), !1 !== c && _.removeCollinearPoints(S, c), !1 !== p && _.removeDuplicatePoints && _.removeDuplicatePoints(S, p);
                                        var C = _.quickDecomp(S);
                                        for (y = 0; y < C.length; y++) {
                                            var E = C[y].map(function (t) {
                                                return { x: t[0], y: t[1] };
                                            });
                                            (d > 0 && r.area(E) < d) || m.push({ position: r.centre(E), vertices: E });
                                        }
                                    }
                                            ...
                                            if (a.overlaps(T.bounds, P.bounds)) {
                                                ...
                                                for (x = 0; x < T.vertices.length; x++)
                                                    for (D = 0; D < P.vertices.length; D++) {
                                                        var O = l.magnitudeSquared(l.sub(A[(x + 1) % A.length], k[D])),
                                                            M = l.magnitudeSquared(l.sub(A[x], k[(D + 1) % k.length]));
                                                        O < 5 && M < 5 && ((A[x].isInternal = !0), (k[D].isInternal = !0));
                                                    }
                                            }
                                        }
                                    }
                                return m.length > 1 ? ((h = s.create(o.extend({ parts: m.slice(0) }, i))), s.setPosition(h, { x: t, y: e }), h) : m[0];
                            });
                    },
                    function (t, e, n) {
                        var i = {};
                        ...
                        (i.create = function (t) {
                            ...
                            return (
                                ...
                                (e.wheelDelta = 0),
                                (e.button = -1),
                                (e.pixelRatio = parseInt(e.element.getAttribute("data-pixel-ratio"), 10) || 1),
                                ...
                                (e.mousedown = function (t) {
                                    var n = i._getRelativeMousePosition(t, e.element, e.pixelRatio);
                                    t.changedTouches ? ((e.button = 0), t.preventDefault()) : (e.button = t.button),
                                        (e.absolute.x = n.x),
                                        (e.absolute.y = n.y),
                                        (e.position.x = e.absolute.x * e.scale.x + e.offset.x),
                                        (e.position.y = e.absolute.y * e.scale.y + e.offset.y),
                            ...
                            (i._getRelativeMousePosition = function (t, e, n) {
                                var i,
                                    ...
                                    u = t.changedTouches;
                                return (
                                    u ? ((i = u[0].pageX - o.left - a), (r = u[0].pageY - o.top - l)) : ((i = t.pageX - o.left - a), (r = t.pageY - o.top - l)),
                            ...
                            (i.collisions = function (t) {
                                ...
                                for (a.sort(i._compareBoundsX), e = 0; e < l; e++) {
                                    ...
                                    for (n = e + 1; n < l; n++) {
                                        ...
                                        if (!(h < T.min.y || m > T.max.y) && (!v || (!b.isStatic && !b.isSleeping)) && u(d.collisionFilter, b.collisionFilter)) {
                                            var x = b.parts.length;
                                            if (y && 1 === x) (C = c(d, b, s)) && r.push(C);
                                            else
                                                for (var w = x > 1 ? 1 : 0, D = g > 1 ? 1 : 0; D < g; D++)
                                                    for (var _ = d.parts[D], S = ((p = _.bounds), w); S < x; S++) {
                                                        var C,
                                                            E = b.parts[S],
                                                            T = E.bounds;
                                                        p.min.x > T.max.x || p.max.x < T.min.x || p.max.y < T.min.y || p.min.y > T.max.y || ((C = c(_, E, s)) && r.push(C));
                                                    }
                                        }
                                    }
                                }
                        ...
                        (i._registry = {}),
                            (i.register = function (t) {
                                if ((i.isPlugin(t) || r.warn("Plugin.register:", i.toString(t), "does not implement all required fields."), t.name in i._registry)) {
                                    ...
                                    n > o
                                        ? (r.warn("Plugin.register:", i.toString(e), "was upgraded to", i.toString(t)), (i._registry[t.name] = t))
                                        : n < o
                                        ? r.warn("Plugin.register:", i.toString(e), "can not be downgraded to", i.toString(t))
                                        : t !== e && r.warn("Plugin.register:", i.toString(t), "is already registered to different plugin object");
                            ...
                            (i.use = function (t, e) {
                                if (((t.uses = (t.uses || []).concat(e || [])), 0 !== t.uses.length)) {
                                    for (var n = i.dependencies(t), o = r.topologicalSort(n), s = [], a = 0; a < o.length; a += 1)
                                        if (o[a] !== t.name) {
                                            var l = i.resolve(o[a]);
                                            l
                                                ? i.isUsed(t, l.name) ||
                                                  (i.isFor(l, t) || (r.warn("Plugin.use:", i.toString(l), "is for", l.for, "but installed on", i.toString(t) + "."), (l._warned = !0)),
                                                  l.install ? l.install(t) : (r.warn("Plugin.use:", i.toString(l), "does not specify an install function."), (l._warned = !0)),
                                                  l._warned ? (s.push("🔶 " + i.toString(l)), delete l._warned) : s.push("✅ " + i.toString(l)),
                                                  t.used.push(l.name))
                                                : s.push("❌ " + o[a]);
                                        }
                                        ...
                                        (e[o] = r.map(t.uses || [], function (e) {
                                            ...
                                            return (
                                                s && !i.versionSatisfies(s.version, o.range)
                                                    ? (r.warn("Plugin.dependencies:", i.toString(s), "does not satisfy", i.toString(o), "used by", i.toString(n) + "."), (s._warned = !0), (t._warned = !0))
                                                    : s || (r.warn("Plugin.dependencies:", i.toString(e), "used by", i.toString(n), "could not be resolved."), (t._warned = !0)),
                                                o.name
                                            );
                                        }));
                            ...
                            (i.dependencyParse = function (t) {
                                return r.isString(t)
                                    ? (/^[\w-]+(@(\*|[\^~]?\d+\.\d+\.\d+(-[0-9A-Za-z-+]+)?))?$/.test(t) || r.warn("Plugin.dependencyParse:", t, "is not a valid dependency string."), { name: t.split("@")[0], range: t.split("@")[1] || "*" })
                            ...
                            (i.versionParse = function (t) {
                                ...
                                var n = e.exec(t),
                                    ...
                                    o = Number(n[5]),
                                    s = Number(n[6]);
                                return { isRange: Boolean(n[1] || n[2]), version: n[3], range: t, operator: n[1] || n[2] || "", major: i, minor: o, patch: s, parts: [i, o, s], prerelease: n[7], number: 1e8 * i + 1e4 * o + s };
                            }),
                        ...
                        !(function () {
                            ...
                            "undefined" != typeof window &&
                                ...
                                (i.create = function (t) {
                                    var e = {
                                        ...
                                        n = r.extend(e, t);
                                    return (
                                        n.canvas && ((n.canvas.width = n.options.width || n.canvas.width), (n.canvas.height = n.options.height || n.canvas.height)),
                                        (n.mouse = t.mouse),
                                        (n.engine = t.engine),
                                        (n.canvas = n.canvas || d(n.options.width, n.options.height)),
                                        (n.context = n.canvas.getContext("2d")),
                                        (n.textures = {}),
                                        (n.bounds = n.bounds || { min: { x: 0, y: 0 }, max: { x: n.canvas.width, y: n.canvas.height } }),
                                        (n.options.showBroadphase = !1),
                                        1 !== n.options.pixelRatio && i.setPixelRatio(n, n.options.pixelRatio),
                                        r.isElement(n.element) ? n.element.appendChild(n.canvas) : n.canvas.parentNode || r.log("Render.create: options.element was undefined, render.canvas was created but not appended", "warn"),
                                        n
                                    );
                                }),
                                (i.run = function (e) {
                                    !(function r(o) {
                                        (e.frameRequestId = t(r)),
                                            n(e, o),
                                            i.world(e, o),
                                            (e.options.showStats || e.options.showDebug) && i.stats(e, e.context, o),
                                            (e.options.showPerformance || e.options.showDebug) && i.performance(e, e.context, o);
                                    })();
                                }),
                                (i.stop = function (t) {
                                    e(t.frameRequestId);
                                ...
                                (i.lookAt = function (t, e, n, i) {
                                    ...
                                    for (var o = { min: { x: 1 / 0, y: 1 / 0 }, max: { x: -1 / 0, y: -1 / 0 } }, s = 0; s < e.length; s += 1) {
                                        var a = e[s],
                                            l = a.bounds ? a.bounds.min : a.min || a.position || a,
                                            c = a.bounds ? a.bounds.max : a.max || a.position || a;
                                        l && c && (l.x < o.min.x && (o.min.x = l.x), c.x > o.max.x && (o.max.x = c.x), l.y < o.min.y && (o.min.y = l.y), c.y > o.max.y && (o.max.y = c.y));
                                    }
                                    ...
                                    m > h ? (g = m / h) : (v = h / m),
                                        ...
                                        i && ((t.bounds.min.x += 0.5 * d - d * v * 0.5), (t.bounds.max.x += 0.5 * d - d * v * 0.5), (t.bounds.min.y += 0.5 * p - p * g * 0.5), (t.bounds.max.y += 0.5 * p - p * g * 0.5)),
                                        (t.bounds.min.x -= n.x),
                                        (t.bounds.max.x -= n.x),
                                        (t.bounds.min.y -= n.y),
                                        (t.bounds.max.y -= n.y),
                                        t.mouse && (u.setScale(t.mouse, { x: (t.bounds.max.x - t.bounds.min.x) / t.canvas.width, y: (t.bounds.max.y - t.bounds.min.y) / t.canvas.height }), u.setOffset(t.mouse, t.bounds.min));
                                }),
                                    ...
                                    if (
                                        ...
                                        for (n = 0; n < b.length; n++) {
                                            var C = b[n],
                                                ...
                                                P = C.pointA,
                                                A = C.pointB;
                                            E && (P = l.add(E.position, C.pointA)), T && (A = l.add(T.position, C.pointB)), P && A && (s.contains(t.bounds, P) || s.contains(t.bounds, A)) && D.push(C);
                                        }
                                        i.startViewTransform(t),
                                            t.mouse && (u.setScale(t.mouse, { x: (t.bounds.max.x - t.bounds.min.x) / t.options.width, y: (t.bounds.max.y - t.bounds.min.y) / t.options.height }), u.setOffset(t.mouse, t.bounds.min));
                                    } else (D = b), (w = y), 1 !== t.options.pixelRatio && t.context.setTransform(t.options.pixelRatio, 0, 0, t.options.pixelRatio, 0, 0);
                                    !v.wireframes || (d.enableSleeping && v.showSleeping) ? i.bodies(t, w, m) : (v.showConvexHulls && i.bodyConvexHulls(t, w, m), i.bodyWireframes(t, w, m)),
                                ...
                                (i.stats = function (t, e, n) {
                                    for (var i = t.engine, r = i.world, s = o.allBodies(r), a = 0, l = 0, u = 0; u < s.length; u += 1) a += s[u].parts.length;
                                    var c = { Part: a, Body: s.length, Cons: o.allConstraints(r).length, Comp: o.allComposites(r).length, Pair: i.pairs.list.length };
                                    for (var d in ((e.fillStyle = "#0e0f19"), e.fillRect(l, 0, 302.5, 44), (e.font = "12px Arial"), (e.textBaseline = "top"), (e.textAlign = "right"), c)) {
                                        var p = c[d];
                                        (e.fillStyle = "#aaa"), e.fillText(d, l + 55, 8), (e.fillStyle = "#eee"), e.fillText(p, l + 55, 26), (l += 55);
                                    }
                                }),
                                (i.performance = function (t, e) {
                                    ...
                                    (e.fillStyle = "#0e0f19"),
                                        ...
                                        i.status(e, 10, 69, 60, 4, o.length, Math.round(g) + " fps", g / i._goodFps, function (t) {
                                            return o[t] / p - 1;
                                        }),
                                        i.status(e, 82, 69, 60, 4, l.length, d.toFixed(2) + " dt", i._goodDelta / d, function (t) {
                                            return l[t] / h - 1;
                                        }),
                                        i.status(e, 154, 69, 60, 4, u.length, m.toFixed(2) + " ut", 1 - m / i._goodFps, function (t) {
                                            return u[t] / m - 1;
                                        }),
                                        i.status(e, 226, 69, 60, 4, s.length, f.toFixed(2) + " rt", 1 - f / i._goodFps, function (t) {
                                            return s[t] / f - 1;
                                        }),
                                        i.status(e, 298, 69, 60, 4, a.length, v.toFixed(2) + " x", v * v * v, function (t) {
                                            return (a[t] / o[t] / v || 0) - 1;
                                        });
                                }),
                                (i.status = function (t, e, n, i, o, s, a, l, u) {
                                    (t.strokeStyle = "#888"), (t.fillStyle = "#444"), (t.lineWidth = 1), t.fillRect(e, n + 7, i, 1), t.beginPath(), t.moveTo(e, n + 7 - o * r.clamp(0.4 * u(0), -2, 2));
                                    for (var c = 0; c < i; c += 1) t.lineTo(e + c, n + 7 - (c < s ? o * r.clamp(0.4 * u(c), -2, 2) : 0));
                                    t.stroke(),
                                        (t.fillStyle = "hsl(" + r.clamp(25 + 95 * l, 0, 120) + ",100%,60%)"),
                                    ...
                                    for (var n = e, i = 0; i < t.length; i++) {
                                        ...
                                        if (o.render.visible && o.pointA && o.pointB) {
                                            var s,
                                                ...
                                                u = o.bodyA,
                                                c = o.bodyB;
                                            if (((s = u ? l.add(u.position, o.pointA) : o.pointA), "pin" === o.render.type)) n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.closePath();
                                            else {
                                                if (((a = c ? l.add(c.position, o.pointB) : o.pointB), n.beginPath(), n.moveTo(s.x, s.y), "spring" === o.render.type))
                                                    for (var d, p = l.sub(a, s), f = l.perp(l.normalise(p)), h = Math.ceil(r.clamp(o.length / 5, 12, 20)), m = 1; m < h; m += 1)
                                                        (d = m % 2 == 0 ? 1 : -1), n.lineTo(s.x + p.x * (m / h) + f.x * d * 4, s.y + p.y * (m / h) + f.y * d * 4);
                                                n.lineTo(a.x, a.y);
                                            }
                                            o.render.lineWidth && ((n.lineWidth = o.render.lineWidth), (n.strokeStyle = o.render.strokeStyle), n.stroke()),
                                                o.render.anchors && ((n.fillStyle = o.render.strokeStyle), n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.arc(a.x, a.y, 3, 0, 2 * Math.PI), n.closePath(), n.fill());
                                        }
                                    }
                                }),
                                        ...
                                        if ((i = e[o]).render.visible)
                                            for (s = i.parts.length > 1 ? 1 : 0; s < i.parts.length; s++)
                                                if ((r = i.parts[s]).render.visible) {
                                                    if (
                                                        (l.showSleeping && i.isSleeping ? (a.globalAlpha = 0.5 * r.render.opacity) : 1 !== r.render.opacity && (a.globalAlpha = r.render.opacity),
                                                        r.render.sprite && r.render.sprite.texture && !l.wireframes)
                                                    ) {
                                                        var c = r.render.sprite,
                                                            d = f(t, c.texture);
                                                        a.translate(r.position.x, r.position.y),
                                                            a.rotate(r.angle),
                                                            a.drawImage(d, d.width * -c.xOffset * c.xScale, d.height * -c.yOffset * c.yScale, d.width * c.xScale, d.height * c.yScale),
                                                            a.rotate(-r.angle),
                                                            a.translate(-r.position.x, -r.position.y);
                                                    } else {
                                                        if (r.circleRadius) a.beginPath(), a.arc(r.position.x, r.position.y, r.circleRadius, 0, 2 * Math.PI);
                                                            ...
                                                            for (var p = 1; p < r.vertices.length; p++)
                                                                !r.vertices[p - 1].isInternal || u ? a.lineTo(r.vertices[p].x, r.vertices[p].y) : a.moveTo(r.vertices[p].x, r.vertices[p].y),
                                                                    r.vertices[p].isInternal && !u && a.moveTo(r.vertices[(p + 1) % r.vertices.length].x, r.vertices[(p + 1) % r.vertices.length].y);
                                                            a.lineTo(r.vertices[0].x, r.vertices[0].y), a.closePath();
                                                        }
                                                        l.wireframes
                                                            ? ((a.lineWidth = 1), (a.strokeStyle = "#bbb"), a.stroke())
                                                            : ((a.fillStyle = r.render.fillStyle), r.render.lineWidth && ((a.lineWidth = r.render.lineWidth), (a.strokeStyle = r.render.strokeStyle), a.stroke()), a.fill());
                                                    }
                                                    a.globalAlpha = 1;
                                                }
                                }),
                                    ...
                                    for (l.beginPath(), o = 0; o < e.length; o++)
                                        if ((i = e[o]).render.visible)
                                            for (a = i.parts.length > 1 ? 1 : 0; a < i.parts.length; a++) {
                                                for (r = i.parts[a], l.moveTo(r.vertices[0].x, r.vertices[0].y), s = 1; s < r.vertices.length; s++)
                                                    !r.vertices[s - 1].isInternal || u ? l.lineTo(r.vertices[s].x, r.vertices[s].y) : l.moveTo(r.vertices[s].x, r.vertices[s].y),
                                                        r.vertices[s].isInternal && !u && l.moveTo(r.vertices[(s + 1) % r.vertices.length].x, r.vertices[(s + 1) % r.vertices.length].y);
                                    ...
                                    for (i = 0; i < e.length; i++) {
                                        ...
                                        for (o = a.length > 1 ? 1 : 0; o < a.length; o++) {
                                            ...
                                            for (r = 0; r < l.vertices.length; r++)
                                                (s.fillStyle = "rgba(255,255,255,0.2)"), s.fillText(i + "_" + r, l.position.x + 0.8 * (l.vertices[r].x - l.position.x), l.position.y + 0.8 * (l.vertices[r].y - l.position.y));
                                        }
                                    }
                                }),
                                            ...
                                            if (l.showAxes)
                                                for (o = c.length > 1 ? 1 : 0; o < c.length; o++)
                                                    for (i = c[o], s = 0; s < i.axes.length; s++) {
                                                        var d = i.axes[s];
                                                        a.moveTo(i.position.x, i.position.y), a.lineTo(i.position.x + 20 * d.x, i.position.y + 20 * d.y);
                                                    }
                                            else
                                                for (o = c.length > 1 ? 1 : 0; o < c.length; o++)
                                                    for (i = c[o], s = 0; s < i.axes.length; s++)
                                                        a.moveTo(i.position.x, i.position.y), a.lineTo((i.vertices[0].x + i.vertices[i.vertices.length - 1].x) / 2, (i.vertices[0].y + i.vertices[i.vertices.length - 1].y) / 2);
                                    }
                                ...
                                (i.bodyPositions = function (t, e, n) {
                                    ...
                                    for (l.wireframes ? (a.fillStyle = "indianred") : (a.fillStyle = "rgba(0,0,0,0.5)"), a.fill(), a.beginPath(), o = 0; o < e.length; o++)
                                        (i = e[o]).render.visible && (a.arc(i.positionPrev.x, i.positionPrev.y, 2, 0, 2 * Math.PI, !1), a.closePath());
                                ...
                                (i.collisions = function (t, e, n) {
                                    ...
                                    for (a.beginPath(), o = 0; o < e.length; o++)
                                        if ((i = e[o]).isActive)
                                            for (r = i.collision, s = 0; s < i.activeContacts.length; s++) {
                                                var u = i.activeContacts[s].vertex;
                                                a.rect(u.x - 1.5, u.y - 1.5, 3.5, 3.5);
                                            }
                                    for (l.wireframes ? (a.fillStyle = "rgba(255,255,255,0.7)") : (a.fillStyle = "orange"), a.fill(), a.beginPath(), o = 0; o < e.length; o++)
                                        if ((i = e[o]).isActive && ((r = i.collision), i.activeContacts.length > 0)) {
                                            var c = i.activeContacts[0].vertex.x,
                                                d = i.activeContacts[0].vertex.y;
                                            2 === i.activeContacts.length && ((c = (i.activeContacts[0].vertex.x + i.activeContacts[1].vertex.x) / 2), (d = (i.activeContacts[0].vertex.y + i.activeContacts[1].vertex.y) / 2)),
                                                r.bodyB === r.supports[0].body || !0 === r.bodyA.isStatic ? a.moveTo(c - 8 * r.normal.x, d - 8 * r.normal.y) : a.moveTo(c + 8 * r.normal.x, d + 8 * r.normal.y),
                                                a.lineTo(c, d);
                                        }
                                    ...
                                    for (l.beginPath(), a = 0; a < e.length; a++)
                                        if ((i = e[a]).isActive) {
                                            ...
                                            (s = r.bodyB).isStatic || o.isStatic || (c = 0.5),
                                                ...
                                                l.lineTo(s.position.x - r.penetration.x * c, s.position.y - r.penetration.y * c),
                                                (c = 1),
                                                s.isStatic || o.isStatic || (c = 0.5),
                                                o.isStatic && (c = 0),
                                                l.moveTo(o.position.x, o.position.y),
                                                l.lineTo(o.position.x + r.penetration.x * c, o.position.y + r.penetration.y * c);
                                        }
                                    u.wireframes ? (l.strokeStyle = "rgba(255,165,0,0.5)") : (l.strokeStyle = "orange"), l.stroke();
                                }),
                                (i.inspector = function (t, e) {
                                    ...
                                    if (o.hasBounds) {
                                        ...
                                        e.scale(1 / l, 1 / u), e.translate(-r.bounds.min.x, -r.bounds.min.y);
                                    }
                                    for (var c = 0; c < i.length; c++) {
                                        var d = i[c].data;
                                        switch ((e.translate(0.5, 0.5), (e.lineWidth = 1), (e.strokeStyle = "rgba(255,165,0,0.9)"), e.setLineDash([1, 2]), d.type)) {
                                            case "body":
                                                (n = d.bounds), e.beginPath(), e.rect(Math.floor(n.min.x - 3), Math.floor(n.min.y - 3), Math.floor(n.max.x - n.min.x + 6), Math.floor(n.max.y - n.min.y + 6)), e.closePath(), e.stroke();
                                                break;
                                            case "constraint":
                                                var p = d.pointA;
                                                d.bodyA && (p = d.pointB), e.beginPath(), e.arc(p.x, p.y, 10, 0, 2 * Math.PI), e.closePath(), e.stroke();
                                        }
                            ...
                            var n = function (t, e) {
                                    ...
                                    (r.delta = e - r.lastTime || i._goodDelta),
                                        ...
                                        (r.deltaHistory.length = Math.min(r.deltaHistory.length, o)),
                                        r.engineDeltaHistory.unshift(n.timing.lastDelta),
                                        (r.engineDeltaHistory.length = Math.min(r.engineDeltaHistory.length, o)),
                                        r.timestampElapsedHistory.unshift(r.timestampElapsed),
                                        (r.timestampElapsedHistory.length = Math.min(r.timestampElapsedHistory.length, o)),
                                        r.engineElapsedHistory.unshift(n.timing.lastElapsed),
                                        (r.engineElapsedHistory.length = Math.min(r.engineElapsedHistory.length, o)),
                                        r.elapsedHistory.unshift(r.lastElapsed),
                                        (r.elapsedHistory.length = Math.min(r.elapsedHistory.length, o));
                                },
                                c = function (t) {
                    ...
                    function (t, e, n) {
                        ...
                        (i.create = function (t) {
                            ...
                            return (
                                (e.world = t.world || u.create({ label: "World" })),
                            ...
                            (i.update = function (t, e, n) {
                                ...
                                for (
                                    a.update(v, D, y),
                                        ...
                                        v.collisionStart.length > 0 && l.trigger(t, "collisionStart", { pairs: v.collisionStart }),
                                ...
                                for (o.postSolvePosition(x), c.preSolveAll(x), f = 0; f < t.constraintIterations; f++) c.solveAll(w, g.timeScale);
                                for (c.postSolveAll(x), o.preSolveVelocity(v.list), f = 0; f < t.velocityIterations; f++) o.solveVelocity(v.list, g.timeScale);
                                return (
                                    v.collisionActive.length > 0 && l.trigger(t, "collisionActive", { pairs: v.collisionActive }),
                                    v.collisionEnd.length > 0 && l.trigger(t, "collisionEnd", { pairs: v.collisionEnd }),
                            ...
                            (i.solvePosition = function (t, e) {
                                ...
                                for (n = 0; n < p; n++)
                                    (r = t[n]).isActive &&
                                        ...
                                        (a = o.parentB),
                                        (l = o.normal),
                                        (r.separation = l.x * (a.positionImpulse.x + o.penetration.x - s.positionImpulse.x) + l.y * (a.positionImpulse.y + o.penetration.y - s.positionImpulse.y)));
                                for (n = 0; n < p; n++)
                                    (r = t[n]).isActive &&
                                        !r.isSensor &&
                                        ((s = (o = r.collision).parentA),
                                        ...
                                        s.isStatic || s.isSleeping || ((u = d / s.totalContacts), (s.positionImpulse.x += l.x * c * u), (s.positionImpulse.y += l.y * c * u)),
                                        a.isStatic || a.isSleeping || ((u = d / a.totalContacts), (a.positionImpulse.x -= l.x * c * u), (a.positionImpulse.y -= l.y * c * u)));
                            }),
                                ...
                                for (var e = i._positionWarming, n = t.length, s = r.translate, a = o.update, l = 0; l < n; l++) {
                                    ...
                                    if (((u.totalContacts = 0), 0 !== d || 0 !== p)) {
                                        for (var h = 0; h < u.parts.length; h++) {
                                            var m = u.parts[h];
                                            s(m.vertices, c), a(m.bounds, m.vertices, f), (m.position.x += d), (m.position.y += p);
                                        }
                                        (u.positionPrev.x += d), (u.positionPrev.y += p), d * f.x + p * f.y < 0 ? ((c.x = 0), (c.y = 0)) : ((c.x *= e), (c.y *= e));
                                    }
                                }
                            }),
                                    ...
                                    if (r.isActive && !r.isSensor) {
                                        ...
                                        for (n = 0; n < s; n++) {
                                            ...
                                            if (0 !== h || 0 !== m) {
                                                ...
                                                l.isStatic ||
                                                    l.isSleeping ||
                                                    ((l.positionPrev.x += v * l.inverseMass), (l.positionPrev.y += g * l.inverseMass), (l.anglePrev += l.inverseInertia * ((f.x - l.position.x) * g - (f.y - l.position.y) * v))),
                                                    u.isStatic ||
                                                        u.isSleeping ||
                                                        ((u.positionPrev.x -= v * u.inverseMass), (u.positionPrev.y -= g * u.inverseMass), (u.anglePrev -= u.inverseInertia * ((f.x - u.position.x) * g - (f.y - u.position.y) * v)));
                                            }
                                        }
                                    }
                                }
                                    ...
                                    if (f.isActive && !f.isSensor) {
                                        ...
                                        for (
                                            ...
                                            var P = _[s],
                                                ...
                                                q = Math.min(N, 1),
                                                W = (q = N < 0 ? 0 : q) * T;
                                            z > W || -z > W ? ((r = z > 0 ? z : -z), (n = f.friction * (z > 0 ? 1 : -1) * a) < -r ? (n = -r) : n > r && (n = r)) : ((n = z), (r = d));
                                            var V = k * x - O * b,
                                                H = M * x - F * b,
                                                G = C / (E + m.inverseInertia * V * V + v.inverseInertia * H * H),
                                                $ = (1 + f.restitution) * R * G;
                                            if (((n *= G), R * R > l && R < 0)) P.normalImpulse = 0;
                                            else {
                                                var X = P.normalImpulse;
                                                (P.normalImpulse += $), (P.normalImpulse = Math.min(P.normalImpulse, 0)), ($ = P.normalImpulse - X);
                                            }
                                            ...
                                            var U = b * $ + w * n,
                                                Q = x * $ + D * n;
                                            m.isStatic || m.isSleeping || ((m.positionPrev.x += U * m.inverseMass), (m.positionPrev.y += Q * m.inverseMass), (m.anglePrev += (k * Q - O * U) * m.inverseInertia)),
                                                v.isStatic || v.isSleeping || ((v.positionPrev.x -= U * v.inverseMass), (v.positionPrev.y -= Q * v.inverseMass), (v.anglePrev -= (M * Q - F * U) * v.inverseInertia));
                                        }
                                    }
                                }
                            });
                    ...
                    function (t, e, n) {
                        ...
                        var r = n(9),
                            o = n(0);
                        (i.create = function (t) {
                            return o.extend({ table: {}, list: [], collisionStart: [], collisionActive: [], collisionEnd: [] }, t);
                        }),
                            (i.update = function (t, e, n) {
                                var i,
                                    o,
                                    ...
                                    f = t.collisionEnd,
                                    h = t.collisionActive;
                                for (p.length = 0, f.length = 0, h.length = 0, a = 0; a < u; a++) l[a].confirmedActive = !1;
                                for (a = 0; a < d; a++) (s = (i = e[a]).pair) ? (s.isActive ? h.push(s) : p.push(s), r.update(s, i, n), (s.confirmedActive = !0)) : ((c[(s = r.create(i, n)).id] = s), p.push(s), l.push(s));
                                var m = [];
                                for (u = l.length, a = 0; a < u; a++) (s = l[a]).confirmedActive || (r.setActive(s, !1, n), f.push(s), s.collision.bodyA.isSleeping || s.collision.bodyB.isSleeping || m.push(a));
                                for (a = 0; a < m.length; a++) (s = l[(o = m[a] - a)]), l.splice(o, 1), delete c[s.id];
                            }),
                            (i.clear = function (t) {
                    ...
                    function (t, e, n) {
                        ...
                        (i.stack = function (t, e, n, i, o, s, l) {
                            for (var u, c = r.create({ label: "Stack" }), d = t, p = e, f = 0, h = 0; h < i; h++) {
                                for (var m = 0, v = 0; v < n; v++) {
                                    var g = l(d, p, v, h, u, f);
                                    if (g) {
                                        var y = g.bounds.max.y - g.bounds.min.y,
                                            b = g.bounds.max.x - g.bounds.min.x;
                                        y > m && (m = y), a.translate(g, { x: 0.5 * b, y: 0.5 * y }), (d = g.bounds.max.x + o), r.addBody(c, g), (u = g), (f += 1);
                                    } else d += o;
                                }
                                (p += m + s), (d = t);
                            }
                            ...
                            (i.chain = function (t, e, n, i, a, l) {
                                for (var u = t.bodies, c = 1; c < u.length; c++) {
                                    var d = u[c - 1],
                                        ...
                                        v = { bodyA: d, pointA: { x: h * e, y: f * n }, bodyB: p, pointB: { x: (p.bounds.max.x - p.bounds.min.x) * i, y: m * a } },
                                        g = s.extend(v, l);
                            ...
                            (i.mesh = function (t, e, n, i, a) {
                                var l,
                                    ...
                                    f = t.bodies;
                                for (l = 0; l < n; l++) {
                                    for (u = 1; u < e; u++) (c = f[u - 1 + l * e]), (d = f[u + l * e]), r.addConstraint(t, o.create(s.extend({ bodyA: c, bodyB: d }, a)));
                                    if (l > 0)
                                        for (u = 0; u < e; u++)
                                            (c = f[u + (l - 1) * e]),
                                                (d = f[u + l * e]),
                                                r.addConstraint(t, o.create(s.extend({ bodyA: c, bodyB: d }, a))),
                                                i && u > 0 && ((p = f[u - 1 + (l - 1) * e]), r.addConstraint(t, o.create(s.extend({ bodyA: p, bodyB: d }, a)))),
                                                i && u < e - 1 && ((p = f[u + 1 + (l - 1) * e]), r.addConstraint(t, o.create(s.extend({ bodyA: p, bodyB: d }, a))));
                                }
                            ...
                            (i.pyramid = function (t, e, n, r, o, s, l) {
                                return i.stack(t, e, n, r, o, s, function (e, i, s, u, c, d) {
                                    ...
                                    if (!(u > p || s < (u = p - u) || s > n - 1 - u)) return 1 === d && a.translate(c, { x: (s + (n % 2 == 1 ? 1 : -1)) * f, y: 0 }), l(t + (c ? s * f : 0) + s * o, i, s, u, c, d);
                                });
                            }),
                            (i.newtonsCradle = function (t, e, n, i, s) {
                                for (var a = r.create({ label: "Newtons Cradle" }), u = 0; u < n; u++) {
                                    var c = l.circle(t + u * (1.9 * i), e + s, i, { inertia: 1 / 0, restitution: 1, friction: 0, frictionAir: 1e-4, slop: 1 }),
                                        d = o.create({ pointA: { x: t + u * (1.9 * i), y: e }, bodyB: c });
                                    r.addBody(a, c), r.addConstraint(a, d);
                                }
                                return a;
                            }),
                            u(i, "newtonsCradle", "Composites.newtonsCradle ➤ moved to newtonsCradle example"),
                            (i.car = function (t, e, n, i, s) {
                                var u = a.nextGroup(!0),
                                    c = 0.5 * -n + 20,
                                    d = 0.5 * n - 20,
                                    p = r.create({ label: "Car" }),
                                    f = l.rectangle(t, e, n, i, { collisionFilter: { group: u }, chamfer: { radius: 0.5 * i }, density: 2e-4 }),
                                    h = l.circle(t + c, e + 0, s, { collisionFilter: { group: u }, friction: 0.8 }),
                                    m = l.circle(t + d, e + 0, s, { collisionFilter: { group: u }, friction: 0.8 }),
                                    v = o.create({ bodyB: f, pointB: { x: c, y: 0 }, bodyA: h, stiffness: 1, length: 0 }),
                                    g = o.create({ bodyB: f, pointB: { x: d, y: 0 }, bodyA: m, stiffness: 1, length: 0 });
                                return r.addBody(p, f), r.addBody(p, h), r.addBody(p, m), r.addConstraint(p, v), r.addConstraint(p, g), p;
                            }),
                            u(i, "car", "Composites.car ➤ moved to car example"),
                            (i.softBody = function (t, e, n, r, o, a, u, c, d, p) {
                                (d = s.extend({ inertia: 1 / 0 }, d)), (p = s.extend({ stiffness: 0.2, render: { type: "line", anchors: !1 } }, p));
                                var f = i.stack(t, e, n, r, o, a, function (t, e) {
                                    return l.circle(t, e, c, d);
                                });
                                return i.mesh(f, n, r, u, p), (f.label = "Soft Body"), f;
                            }),
                            u(i, "softBody", "Composites.softBody ➤ moved to softBody and cloth examples");
                    },
                    function (t, e, n) {
                        var i = {};
                        t.exports = i;
                        ...
                        (i.create = function (t) {
                            ...
                            (i.update = function (t, e, n, r) {
                                ...
                                for (o = 0; o < e.length; o++) {
                                    var f = e[o];
                                    if ((!f.isSleeping || r) && (!c.bounds || !(f.bounds.max.x < c.bounds.min.x || f.bounds.min.x > c.bounds.max.x || f.bounds.max.y < c.bounds.min.y || f.bounds.min.y > c.bounds.max.y))) {
                                        ...
                                        if (!f.region || h.id !== f.region.id || r) {
                                            ...
                                            for (s = m.startCol; s <= m.endCol; s++)
                                                for (a = m.startRow; a <= m.endRow; a++) {
                                                    ...
                                                    !v && g && g && l && i._bucketRemoveBody(t, l, f), (f.region === h || (v && !g) || r) && (l || (l = i._createBucket(d, u)), i._bucketAddBody(t, l, f));
                                                }
                                            (f.region = h), (p = !0);
                                        }
                                    }
                        ...
                        (i.create = function (t, e) {
                            ...
                            n ||
                                (t && t.render && t.render.canvas
                                    ...
                                    : ((n = s.create()), d.warn("MouseConstraint.create: options.mouse was undefined, options.element was undefined, may not function as expected")));
                            var r = {
                                    type: "mouseConstraint",
                                    mouse: n,
                                    element: null,
                                    body: null,
                                    constraint: u.create({ label: "Mouse Constraint", pointA: n.position, pointB: { x: 0, y: 0 }, length: 0.01, stiffness: 0.1, angularStiffness: 1, render: { strokeStyle: "#90EE90", lineWidth: 3 } }),
                                    collisionFilter: { category: 1, mask: 4294967295, group: 0 },
                                },
                                o = d.extend(r, e);
                            return (
                                ...
                                if (0 === n.button) {
                                    if (i.bodyB) o.set(i.bodyB, !1), (i.pointA = n.position);
                                        ...
                                        for (var u = 0; u < e.length; u++)
                                            if (((s = e[u]), p.contains(s.bounds, n.position) && l.canCollide(s.collisionFilter, t.collisionFilter)))
                                                for (var c = s.parts.length > 1 ? 1 : 0; c < s.parts.length; c++) {
                                                    var d = s.parts[c];
                                                    if (r.contains(d.vertices, n.position)) {
                                                        (i.pointA = n.position),
                                                            (i.bodyB = t.body = s),
                                                            (i.pointB = { x: n.position.x - s.position.x, y: n.position.y - s.position.y }),
                                                            (i.angleB = s.angle),
                                                            o.set(s, !1),
                                                            a.trigger(t, "startdrag", { mouse: n, body: s });
                                                        break;
                                                    }
                                                }
                                } else (i.bodyB = t.body = null), (i.pointB = null), s && a.trigger(t, "enddrag", { mouse: n, body: s });
                            }),
                    ...
                    function (t, e, n) {
                        ...
                        (i.collides = function (t, e) {
                            for (var n = [], i = e.length, r = t.bounds, a = o.collides, l = s.overlaps, u = 0; u < i; u++) {
                                var c = e[u],
                                    d = c.parts.length,
                                    p = 1 === d ? 0 : 1;
                                if (l(c.bounds, r))
                            ...
                            (i.ray = function (t, e, n, o) {
                                o = o || 1e-100;
                                for (var s = r.angle(e, n), l = r.magnitude(r.sub(e, n)), u = 0.5 * (n.x + e.x), c = 0.5 * (n.y + e.y), d = a.rectangle(u, c, l, o, { angle: s }), p = i.collides(d, t), f = 0; f < p.length; f += 1) {
                                    var h = p[f];
                    ...
                    function (t, e, n) {
                        ...
                        var r,
                            ...
                            u = n(0);
                        "undefined" != typeof window &&
                            ((r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame),
                            ...
                            (i.create = function (t) {
                                var e = u.extend({ fps: 60, correction: 1, deltaSampleSize: 60, counterTimestamp: 0, frameCounter: 0, deltaHistory: [], timePrev: null, timeScalePrev: 1, frameRequestId: null, isFixed: !1, enabled: !0 }, t);
                                ...
                                a.trigger(t, "beforeTick", s),
                                    t.isFixed
                                        ...
                                        : ((i = n - t.timePrev || t.delta),
                                          ...
                                          (o = (i = (i = (i = Math.min.apply(null, t.deltaHistory)) < t.deltaMin ? t.deltaMin : i) > t.deltaMax ? t.deltaMax : i) / t.delta),
                                          (t.delta = i)),
                    ...
                    function (t, e, n) {
                        ...
                        (i.pathToVertices = function (t, e) {
                            ...
                            for (i._svgPathToAbsolute(t), s = t.getTotalLength(), u = [], n = 0; n < t.pathSegList.numberOfItems; n += 1) u.push(t.pathSegList.getItem(n));
                            for (c = u.concat(); v < s; ) {
                            ...
                            (i._svgPathToAbsolute = function (t) {
                                for (var e, n, i, r, o, s, a = t.pathSegList, l = 0, u = 0, c = a.numberOfItems, d = 0; d < c; ++d) {
                                    var p = a.getItem(d),
                                        f = p.pathSegTypeAsLetter;
                                    if (/[MLHVCSQTA]/.test(f)) "x" in p && (l = p.x), "y" in p && (u = p.y);
                                    else
                                        switch (("x1" in p && (i = l + p.x1), "x2" in p && (o = l + p.x2), "y1" in p && (r = u + p.y1), "y2" in p && (s = u + p.y2), "x" in p && (l += p.x), "y" in p && (u += p.y), f)) {
                                            case "m":
                                            ...
                                            case "h":
                                                ...
                                                break;
                                            case "v":
                                                a.replaceItem(t.createSVGPathSegLinetoVerticalAbs(u), d);
                                                break;
                                            case "c":
                                                a.replaceItem(t.createSVGPathSegCurvetoCubicAbs(l, u, i, r, o, s), d);
                                                break;
                                            case "s":
                                                a.replaceItem(t.createSVGPathSegCurvetoCubicSmoothAbs(l, u, o, s), d);
                                                break;
                                            case "q":
                                                a.replaceItem(t.createSVGPathSegCurvetoQuadraticAbs(l, u, i, r), d);
                                                break;
                                            case "t":
                                                a.replaceItem(t.createSVGPathSegCurvetoQuadraticSmoothAbs(l, u), d);
                                                break;
                                            case "a":
                                                a.replaceItem(t.createSVGPathSegArcAbs(l, u, p.r1, p.r2, p.angle, p.largeArcFlag, p.sweepFlag), d);
                                                break;
                                            case "z":
                                            case "Z":
                                                (l = e), (u = n);
    ...
    function (t, e, n) {
        ...
        (t.exports = function (t, e, n, l) {
            ...
            r(n) &&
                ...
                t !== i ? (d ? !m && t[e] && (h = !0) : delete t[e], h ? (t[e] = n) : s(t, e, n)) : h ? (t[e] = n) : a(e, n);
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e) {
            ...
            if ((n = m ? i : v ? i[h] || a(h, {}) : (i[h] || {}).prototype))
                for (c in e) {
                    if (((p = e[c]), (d = t.noTargetGet ? (f = r(n, c)) && f.value : n[c]), !u(m ? c : h + (v ? "." : "#") + c, t.forced) && void 0 !== d)) {
    ...
    function (t, e, n) {
            ...
            m = function () {
                ...
                m =
                    "undefined" != typeof document
                        ? document.domain && i
                            ? h(i)
                            : (((e = u("iframe")).style.display = "none"), l.appendChild(e), (e.src = String("javascript:")), (t = e.contentWindow.document).open(), t.write(f("document.F=Object")), t.close(), t.F)
                        : h(i);
        ...
        (a[d] = !0),
            (t.exports =
                ...
                function (t, e) {
                    var n;
                    return null !== t ? ((p.prototype = r(t)), (n = new p()), (p.prototype = null), (n[d] = t)) : (n = m()), void 0 === e ? n : o(n, e);
                });
    },
    function (t, e, n) {
        var i = n(94);
    ...
    function (t, e, n) {
        var i = n(19),
            ...
            v = 0,
            g = function (t) {
                l(t, m, { value: { objectID: "O" + v++, weakData: {} } });
            },
            y = (t.exports = {
                enable: function () {
                    ...
                    (n[m] = 1),
                        t(n).length &&
                            ...
                            i({ target: "Object", stat: !0, forced: !0 }, { getOwnPropertyNames: c.f }));
                },
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, s, h, v, _) {
            ...
            if (
                (F && (S = u(F.call(new t()))) !== Object.prototype && S.next && (o || u(S) === b || (c ? c(S, b) : a(S[w]) || f(S, w, D)), d(S, P, !0, !0), o && (m[P] = D)),
                g &&
                    "values" == h &&
                    O &&
                    "values" !== O.name &&
                ...
                if (((C = { values: T("values"), keys: v ? M : T("keys"), entries: T("entries") }), _)) for (E in C) (x || A || !(E in k)) && f(k, E, C[E]);
                else i({ target: e, proto: !0, forced: x || A }, C);
            return (o && !_) || k[w] === M || f(k, w, M, { name: h }), (m[e] = M), C;
        };
    },
    function (t, e, n) {
        var i = n(64),
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
            ...
            if (
                ...
                P ||
                    (((D = e(function (t, e) {
                        c(t, w);
                        var n = v(new x(), t, D);
                        return null != e && u(e, n[b], { that: n, AS_ENTRIES: g }), n;
                    })).prototype = w),
                    (w.constructor = D)),
            ...
            return (_[t] = D), i({ global: !0, forced: D != x }, _), m(D, t), y || n.setStrong(D, t, g), D;
        };
    },
    function (t, e, n) {
        var i = n(1),
    ...
    function (t, e, n) {
        var i,
            ...
            f = d("iterator"),
            h = !1;
        [].keys && ("next" in (o = [].keys()) ? (r = u(u(o))) !== Object.prototype && (i = r) : (h = !0)),
            null == i ||
            s(function () {
                var t = {};
                return i[f].call(t) !== t;
        ...
        t.exports = {
            getConstructor: function (t, e, n, u) {
                var c = t(function (t, i) {
                        a(t, f), h(t, { type: e, index: r(null), first: void 0, last: void 0, size: 0 }), d || (t.size = 0), null != i && l(i, t[u], { that: t, AS_ENTRIES: n });
                    }),
                    f = c.prototype,
                    v = m(e),
                    g = function (t, e, n) {
                        ...
                        return (
                            s
                                ? (s.value = n)
                                : ((o.last = s = { index: (r = p(e, !0)), key: e, value: n, previous: (i = o.last), next: void 0, removed: !1 }),
                                  o.first || (o.first = s),
                                  i && (i.next = s),
                                  d ? o.size++ : t.size++,
                                  "F" !== r && (o.index[r] = s)),
                    ...
                    o(f, {
                        ...
                        delete: function (t) {
                            ...
                            if (n) {
                                var i = n.next,
                                    r = n.previous;
                                delete e.index[n.index], (n.removed = !0), r && (r.next = i), i && (i.previous = r), e.first == n && (e.first = i), e.last == n && (e.last = r), d ? e.size-- : this.size--;
                            }
                            return !!n;
                        },
                        forEach: function (t) {
                            for (var e, n = v(this), i = s(t, arguments.length > 1 ? arguments[1] : void 0); (e = e ? e.next : n.first); ) for (i(e.value, e.key, this); e && e.removed; ) e = e.previous;
                        },
                        has: function (t) {
                            return !!y(this, t);
                        },
        ...
        (function (t) {
                            ...
                            return r
                                ...
                                .map(function (t) {
                                    var e,
                                        n = t.value[0] || "";
                                    return (
                                        t.pattern && t.name && /^Win/i.test(n) && !/^Windows Phone /i.test(n) && (e = o[n.replace(/[^\d.]/g, "")]) && (n = "Windows " + e),
            ...
            var c = u(function (t) {
                ...
                T = u(function (t) {
                    ...
                    (d.inspectSource = function (t) {
                        ...
                        (t.exports = function (t, n, r, o) {
                            ...
                            s && (_(r, "name") || w(r, "name", n)), t[n] !== r && (s && (_(r, e) || w(r, e, t[n] ? "" + t[n] : i.join(String(n)))), t === c ? (t[n] = r) : o ? (t[n] ? (t[n] = r) : w(t, n, r)) : (delete t[n], w(t, n, r)));
                        })(Function.prototype, "toString", function () {
                ...
                A = function (t, e, n) {
                    ...
                    for (i in (l && (n = e), n))
                        (o = ((r = !a && h && void 0 !== h[i]) ? h : n)[i]), (s = f && r ? P(o, c) : p && "function" == typeof o ? P(Function.call, o) : o), h && T(h, i, o, t & A.U), m[i] != o && w(m, i, s), p && v[i] != o && (v[i] = o);
                };
            (c.core = d), (A.F = 1), (A.G = 2), (A.S = 4), (A.P = 8), (A.B = 16), (A.W = 32), (A.U = 64), (A.R = 128);
            var k = A,
                O = {}.toString,
                M = function (t) {
                ...
                N = u(function (t) {
                    ...
                    })("versions", []).push({ version: d.version, mode: "global", copyright: "© 2018 Denis Pushkarev (zloirock.ru)" });
                }),
                q = u(function (t) {
                    var e = N("wks"),
                        n = c.Symbol,
                ...
                W = function (t, e) {
                    return new ((function (t) {
                        var e;
                        return z(t) && ("function" != typeof (e = t.constructor) || (e !== Array && !z(e.prototype)) || (e = void 0), p(e) && null === (e = e[q]) && (e = void 0)), void 0 === e ? Array : e;
                    })(t))(e);
                },
                V = function (t, e) {
                    var n = 1 == t,
                    ...
                    return function (e, u, c) {
                        for (var d, p, f = Object(B(e)), h = F(f), m = P(u, c, 3), v = R(h.length), g = 0, y = n ? l(e, v) : i ? l(e, 0) : void 0; v > g; g++)
            ...
            var X = "\t\n\v\f\r   ᠎             　\u2028\u2029\ufeff",
                ...
                Z = (K.trim = function (t, e) {
                    return (t = String(B(t))), 1 & e && (t = t.replace(U, "")), 2 & e && (t = t.replace(Q, "")), t;
                });
            K("trim", function (t) {
                return function () {
                    return t(this, 3);
    ...
    function (t, e, n) {
        var i,
            ...
            c = u && u.v8;
        c && (r = (i = c.split("."))[0] > 0 && i[0] < 4 ? 1 : +(i[0] + i[1])), !r && s && (!(i = s.match(/Edge\/(\d+)/)) || i[1] >= 74) && (i = s.match(/Chrome\/(\d+)/)) && (r = +i[1]), (t.exports = r);
    },
    function (t, e, n) {
        var i = n(13);
    ...
    function (t, e, n) {
        ...
        t.exports = i
            ...
            : function (t, e) {
                  o(t);
                  for (var n, i = s(e), l = a(e), u = l.length, c = 0; u > c; ) r.f(t, (n = l[c++]), i[n]);
                  return t;
              };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
            var u = e + " Iterator";
            return (t.prototype = r(i, { next: o(1, n) })), s(t, u, !1, !0), (a[u] = l), t;
        };
    },
    function (t, e, n) {
        var i = n(4);
            ...
            c = function (t) {
                return function (e, n) {
                    var i,
                        ...
                        p = r(n),
                        f = d.length;
                    return p < 0 || p >= f ? (t ? "" : void 0) : (i = l(d, p)) < 55296 || i > 56319 || p + 1 === f || (c = l(d, p + 1)) < 56320 || c > 57343 ? (t ? a(d, p) : i) : t ? u(d, p, p + 2) : c - 56320 + ((i - 55296) << 10) + 65536;
                };
            };
            ...
            (t.exports = {
                getConstructor: function (t, e, n, i) {
                    var c = t(function (t, r) {
                            l(t, p), f(t, { type: e, id: y++, frozen: void 0 }), null != r && u(r, t[i], { that: t, AS_ENTRIES: n });
                        }),
                        p = c.prototype,
                        m = h(e),
                        v = function (t, e, n) {
                    ...
                    return (
                        r(p, {
                            delete: function (t) {
                                ...
                                if (!a(t)) return !1;
                                var n = o(t);
                                return !0 === n ? b(e).delete(t) : n && d(n, e.id) && delete n[e.id];
                            },
                            has: function (t) {
                                var e = m(this);
                                if (!a(t)) return !1;
        ...
        var i = n(27),
            ...
            c = function (t) {
                ...
                return function (h, m, v, g) {
                    for (var y, b, x = s(h), w = o(x), D = i(m, v), _ = a(w), S = 0, C = g || l, E = e ? C(h, _) : n || p ? C(h, 0) : void 0; _ > S; S++)
    ...
    function (t, e, n) {
        ...
        t.exports = function (t) {
            ...
            var g,
                ...
                _ = f(e),
                S = 0;
            if (!_ || (this == h && l(_))) for (g = c(e), y = n ? new this(g) : h(g); g > S; S++) (D = v ? m(e[S], S) : e[S]), d(y, S, D);
            else for (w = (x = p(e, _)).next, y = n ? new this() : []; !(b = o(w, x)).done; S++) (D = v ? a(x, m, [b.value, S], !0) : b.value), d(y, S, D);
            return (y.length = S), y;
        };
    },
    function (t, e, n) {
            ...
            s(function () {
                ...
                ? function (t, e) {
                      for (var n = c(t), r = arguments.length, s = 1, p = l.f, f = u.f; r > s; )
                          for (var m, v = d(arguments[s++]), g = p ? h(a(v), p(v)) : a(v), y = g.length, b = 0; y > b; ) (m = g[b++]), (i && !o(f, v, m)) || (n[m] = v[m]);
                      return n;
                  }
                : p;
    },
    function (t, e, n) {
            ...
            o = (function () {
                function t(t) {
                    (this.store = new Map()),
                        ...
                        (this.events = []),
                        (this.options = Object.assign({}, { start: !0, cleanupNodes: !0 }, t)),
                ...
                return (
                                ...
                                return (
                                    ...
                                    this.registry.forEach(function (t, e) {
                                        if ((n.store.has(e) || n.store.set(e, []), t.assign))
                                            for (var i = n.queryAll(t.assign), r = 0; r < i.length; r++) {
                                                var o = i[r];
                                                n.attach(e, o, null, !1);
                                            }
                                        ...
                                        function (n) {
                                            try {
                                                return Promise.resolve(this.execute("init")).then(
                                                    function (n) {
                                                        try {
                                                            return Promise.resolve(this.execute("enter")).then(
                                                                function (n) {
                                                                    try {
                                                                        return Promise.resolve(this.execute("complete")).then(function (n) {
                                                                            try {
                                                                                return t();
                                                                            } catch (t) {
                                                                                return e(t);
                                        ...
                                        if (e.assign) {
                                            ...
                                            i.options.cleanupNodes &&
                                                s.forEach(function (e, r) {
                                                    e.el && !e.el.isConnected && o.push(i.detach(n, r, t));
                                                });
                                            for (
                                                var l = function (e) {
                                                        var o = a[e],
                                                        ...
                                                        l ? l.onRefresh && t && r.push(l.onRefresh()) : r.push(i.attach(n, o, null, t));
                                                    },
                                                    u = 0;
                                                u < a.length;
                                                u++
                    ...
                    (e.attach = function (t, e, n, i) {
                        return new Promise(
                            function (r, o) {
                                var s, a, l;
                                if ((void 0 === i && (i = !0), (s = n || this.registry.get(t).options), (a = this.registry.get(t).component), (l = new a(this, e, s)), this.store.get(t).push(l), i && l.onInit))
                    ...
                    (e.detach = function (t, e, n) {
                        return new Promise(
                            function (i, r) {
                                var o;
                                if ((void 0 === n && (n = !0), (o = this.store.get(t).splice(e, 1)[0]), n && o.onDestroy))
                    ...
                    (e.define = function (t, e, n, i) {
                        return this.registry.set(t, { assign: n, component: e, options: i }), this;
                    }),
                    ...
                    (e.on = function (t, e) {
                        return this.events[t] instanceof Array || this.off(t), this.events[t].push(e), this;
                    }),
                    (e.off = function (t) {
                    ...
                    (e.queryAll = function (t) {
                        return "string" == typeof t ? document.querySelectorAll(t) : "object" == typeof t ? t : [];
                    }),
                    t
                );
            })();
                ...
                function i() {
                    ...
                    return (
                        ((e = t.apply(this, arguments) || this).options = Object.assign(
                            {},
                            { bindLinks: !0, bindHistory: !0, updateSelectors: ["title", "meta", "#view-main"], updateRemoveNodes: !0, scrollRestoration: "manual", reqOptions: { history: "push" } },
                            e.options
                        )),
                        (e.parser = new DOMParser()),
                        "scrollRestoration" in window.history && (window.history.scrollRestoration = e.options.scrollRestoration),
                ...
                return (
                        ...
                        document.addEventListener(
                            ...
                            function (e) {
                                for (var n = e.target; n && n !== document; n = n.parentNode)
                                    if ("A" === n.tagName && n.href && n.host === window.location.host) {
                    ...
                    (r.bindHistory = function () {
                        ...
                        window.addEventListener("popstate", function () {
                            t.goTo(window.location.pathname, { history: !1 });
                        });
                    }),
                    ...
                    (r.goTo = function (t, e) {
                        return new Promise(
                            function (n, i) {
                                return (
                                    (this.reqOptions = Object.assign({}, { url: t, fetch: {} }, this.options.reqOptions, e)),
                                    this.reqOptions.history && this.pushHistory(t, this.reqOptions.history),
                                    Promise.resolve(this.app.execute("leave")).then(
                                        function (t) {
                                            try {
                                                return Promise.resolve(this.app.execute("loading")).then(
                                                    function (t) {
                                                        try {
                                                            return Promise.resolve(this.app.execute("loaded")).then(
                                                                function (t) {
                                                                    try {
                                                                        return Promise.resolve(this.app.update()).then(
                                                                            function (t) {
                                                                                try {
                                                                                    return Promise.resolve(this.app.execute("enter")).then(
                                                                                        function (t) {
                                                                                            try {
                                                                                                return Promise.resolve(this.app.execute("complete")).then(function (t) {
                                                                                                    try {
                                                                                                        return n();
                                                                                                    } catch (t) {
                                                                                                        return i(t);
                    ...
                    (r.onLoading = function () {
                        return new Promise(
                            function (t, e) {
                                return Promise.resolve(fetch(this.reqOptions.url, this.reqOptions.fetch)).then(
                                    function (n) {
                                        try {
                                            return (
                                                (this.req = n),
                                                Promise.resolve(this.req.text()).then(
                                                    function (n) {
                                                        try {
                                                            return (this.data = n), (this.document = this.data ? this.parser.parseFromString(this.data, "text/html") : null), t();
                                                        } catch (t) {
                                                            return e(t);
                                                        }
                                                    }.bind(this),
                                ...
                                return (
                                    this.options.updateSelectors &&
                                        ...
                                        this.options.updateSelectors.forEach(function (t) {
                                            n.replaceBySelector(t, n.document, n.options.updateRemoveNodes);
                                        }),
                                    t()
                                );
                            }.bind(this)
        ...
        var d,
            ...
            D,
            _,
            S = { autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: { lineHeight: "" } },
            ...
            ft = function (t, e, n) {
                return (n = t[e]) && B(n) ? t[e]() : (I(n) && t.getAttribute && t.getAttribute(e)) || n;
            },
            ht = function (t, e) {
            ...
            yt = function () {
                var t,
                    ...
                    n = rt.length,
                    i = rt.slice(0);
                for (ot = {}, rt.length = 0, t = 0; t < n; t++) (e = i[t]) && e._lazy && (e.render(e._lazy[0], e._lazy[1], !0)._lazy = 0);
            },
            bt = function (t, e, n, i) {
            ...
            It = function (t, e) {
                var n = t._dp;
                return n && n.smoothChildTiming && t._ts && ((t._start = vt(n._time - (t._ts > 0 ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts))), Lt(t), n._dirty || kt(n, t)), t;
            },
            jt = function (t, e) {
                var n;
                if (((e._time || (e._initted && !e._dur)) && ((n = Bt(t.rawTime(), e)), (!e._dur || Yt(0, e.totalDuration(), n) - e._tTime > 1e-8) && e.render(n, !0)), kt(t, e)._dp && t._initted && t._time >= t._dur && t._ts)) {
            ...
            Nt = function (t, e, n, i) {
                return Ne(t, e), t._initted ? (!n && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && g !== xe.frame ? (rt.push(t), (t._lazy = [e, i]), 1) : void 0) : 1;
            },
            qt = function (t) {
                var e = t.data;
            ...
            Wt = function (t, e, n, i) {
                var r = t._repeat,
                    o = vt(e) || 0,
                    s = t._tTime / t._tDur;
                return s && !i && (t._time *= o / t._dur), (t._dur = o), (t._tDur = r ? (r < 0 ? 1e10 : vt(o * (r + 1) + t._rDelay * r)) : o), s && !i ? It(t, (t._tTime = t._tDur * s)) : t.parent && Lt(t), n || kt(t.parent, t), t;
            },
            Vt = function (t) {
                return t instanceof Le ? kt(t) : Wt(t, t._dur);
            },
            Ht = { _start: 0, endTime: nt, totalDuration: nt },
            Gt = function t(e, n, i) {
                var r,
                    o,
                    s,
                ...
                return F(n) && (isNaN(n) || n in a)
                    ? ((o = n.charAt(0)),
                      ...
                      "<" === o || ">" === o
                          ...
                          : r < 0
                          ? (n in a || (a[n] = u), a[n])
                          : ((o = parseFloat(n.charAt(r - 1) + n.substr(r + 1))), s && i && (o = (o / 100) * (W(i) ? i[0] : i).totalDuration()), r > 1 ? t(e, n.substr(0, r - 1), i) + o : u + o))
                    : null == n
                    ? u
                    : +n;
            },
            $t = function (t, e, n) {
                ...
                if ((o && (a.duration = e[1]), (a.parent = n), t)) {
                    for (i = a, r = n; r && !("immediateRender" in i); ) (i = r.vars.defaults || {}), (r = R(r.vars.inherit) && r.parent);
                    (a.immediateRender = R(i.immediateRender)), t < 2 ? (a.runBackwards = 1) : (a.startAt = e[s - 1]);
                }
            ...
            Qt = [].slice,
            Kt = function (t, e) {
                return t && j(t) && "length" in t && ((!e && !t.length) || (t.length - 1 in t && j(t[0]))) && !t.nodeType && t !== f;
            },
            Zt = function (t, e, n) {
                return (
                    void 0 === n && (n = []),
            ...
            Jt = function (t, e, n) {
                return !F(t) || n || (!h && we()) ? (W(t) ? Zt(t, n) : Kt(t) ? Qt.call(t, 0) : t ? [t] : []) : Qt.call((e || m).querySelectorAll(t), 0);
            },
            te = function (t) {
            ...
            ee = function (t) {
                ...
                var e = j(t) ? t : { each: t },
                    ...
                    c = i;
                return (
                    F(i) ? (u = c = { center: 0.5, edges: 0.5, end: 1 }[i] || 0) : !s && a && ((u = i[0]), (c = i[1])),
                    function (t, s, d) {
                        var p,
                            f,
                            h,
                        ...
                        if (!D) {
                            if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, E])[1])) {
                                for (y = -E; y < (y = d[x++].getBoundingClientRect().left) && x < w; );
                                x--;
                            }
                            for (D = o[w] = [], p = a ? Math.min(x, w) * u - 0.5 : i % x, f = a ? (w * c) / x - 0.5 : (i / x) | 0, y = 0, b = E, g = 0; g < w; g++)
                                (h = (g % x) - p), (m = f - ((g / x) | 0)), (D[g] = v = l ? Math.abs("y" === l ? m : h) : k(h * h + m * m)), v > y && (y = v), v < b && (b = v);
                            "random" === i && te(D),
                                (D.max = y - b),
                                (D.min = b),
                                (D.v = w = (parseFloat(e.amount) || parseFloat(e.each) * (x > w ? w - 1 : l ? ("y" === l ? w / x : x) : Math.max(x, w / x)) || 0) * ("edges" === i ? -1 : 1)),
                                (D.b = w < 0 ? r - w : r),
                                (D.u = Ut(e.amount || e.each) || 0),
                                (n = n && w < 0 ? Ee(n) : n);
                        }
                        return (w = (D[t] - D.min) / D.max || 0), vt(D.b + (n ? n(w) : w) * D.v) + D.u;
                    }
                );
            },
            ne = function (t) {
            ...
            ie = function (t, e) {
                var n,
                    ...
                    r = W(t);
                return (
                    !r && j(t) && ((n = r = t.radius || E), t.values ? ((t = Jt(t.values)), (i = !L(t[0])) && (n *= n)) : (t = ne(t.increment))),
                    Xt(
                        e,
                        r
                            ? B(t)
                                ...
                                : function (e) {
                                      for (var r, o, s = parseFloat(i ? e.x : e), a = parseFloat(i ? e.y : 0), l = E, u = 0, c = t.length; c--; )
                                          (r = i ? (r = t[c].x - s) * r + (o = t[c].y - a) * o : Math.abs(t[c] - s)) < l && ((l = r), (u = c));
                                      return (u = !n || l <= n ? t[u] : e), i || u === e || L(e) ? u : u + Ut(e);
                                  }
                            : ne(t)
                    )
                );
            ...
            re = function (t, e, n, i) {
                return Xt(W(t) ? !e : !0 === n ? !!(n = 0) : !i, function () {
                    return W(t) ? t[~~(Math.random() * t.length)] : (n = n || 1e-5) && (i = n < 1 ? Math.pow(10, (n + "").length - 2) : 1) && Math.floor(Math.round((t - n / 2 + Math.random() * (e - t + 0.99 * n)) / n) * n * i) / i;
                });
            },
            oe = function (t, e, n) {
            ...
            se = function (t) {
                for (var e, n, i, r, o = 0, s = ""; ~(e = t.indexOf("random(", o)); )
                    (i = t.indexOf(")", e)), (r = "[" === t.charAt(e + 7)), (n = t.substr(e + 7, i - e - 7).match(r ? Y : V)), (s += t.substr(o, e - o) + re(r ? n : +n[0], r ? 0 : +n[1], +n[2] || 1e-5)), (o = i + 1);
            ...
            ue = function (t, e, n) {
                var i,
                    ...
                    o = t.vars,
                    s = o[e];
                if (s) return (i = o[e + "Params"]), (r = o.callbackScope || t), n && rt.length && yt(), i ? s.apply(r, i) : s.call(r);
            },
            ce = function (t) {
                return At(t), t.scrollTrigger && t.scrollTrigger.kill(!1), t.progress() < 1 && ue(t, "onInterrupt"), t;
            },
            de = function (t) {
                var e = (t = (!t.name && t.default) || t).name,
                    ...
                    i =
                        e && !n && t.init
                            ...
                            : t,
                    r = { init: nt, render: Je, add: Re, kill: en, modifier: tn, rawVars: 0 },
                    o = { targetTest: 0, get: 0, getSetter: Ue, aliases: {}, register: 0 };
                if ((we(), t !== i)) {
                    if (st[e]) return;
                    Dt(i, Dt(Et(t, r), o)), St(i.prototype, St(r, Et(t, o))), (st[(i.prop = e)] = i), t.targetTest && (ut.push(i), (it[e] = 1)), (e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin");
                }
            ...
            ve = function (t, e, n) {
                ...
                if (
                    ((l = l.map(function (t) {
                        return (t = he(t, e, 1)) && u + (e ? t[0] + "," + t[1] + "%," + t[2] + "%," + t[3] : t.join(",")) + ")";
                    })),
                    n && ((o = me(t)), (i = n.c).join(a) !== o.c.join(a)))
                )
                    for (s = (r = t.replace(ge, "1").split(G)).length - 1; c < s; c++) a += r[c] + (~i.indexOf(c) ? l.shift() || u + "0,0,0,0)" : (o.length ? o : l.length ? l : n).shift());
            ...
            be = function (t) {
                var e,
                    n = t.join(" ");
                if (((ge.lastIndex = 0), ge.test(n))) return (e = ye.test(n)), (t[1] = ve(t[1], e)), (t[0] = ve(t[0], e, me(t[1]))), !0;
            },
            xe = (function () {
                var t,
                    e,
                    ...
                    y = function n(f) {
                        var h,
                            ...
                            b = s() - c,
                            x = !0 === f;
                        if ((b > a && (u += b - l), ((h = (v = (c += b) - u) - p) > 0 || x) && ((y = ++i.frame), (r = v - 1e3 * i.time), (i.time = v /= 1e3), (p += h + (h >= d ? 4 : d - h)), (m = 1)), x || (t = e(n)), m))
                ...
                return (i = {
                    ...
                    wake: function () {
                        v &&
                            (!h &&
                                z() &&
                                ((f = h = window), (m = f.document || {}), (Q.gsap = un), (f.gsapVersions || (f.gsapVersions = [])).push(un.version), Z(K || f.GreenSockGlobals || (!f.gsap && f) || {}), (n = f.requestAnimationFrame)),
                            t && i.sleep(),
                            (e =
                                n ||
                                function (t) {
                            ...
                            : De[t] ||
                              (function (t) {
                                  ...
                                  return s && o.length > 1 && s.config
                                      ? s.config.apply(
                                            null,
                                            ~t.indexOf("{") ? [Ce(o[1])] : ((e = t), (n = e.indexOf("(") + 1), (i = e.indexOf(")")), (r = e.indexOf("(", n)), e.substring(n, ~r && r < i ? e.indexOf(")", i + 1) : i)).split(",").map(xt)
                                        )
                                      : De._CE && _e.test(t)
                                      ? De._CE("", t)
                                      : s;
            ...
            Ae = function (t, e, n, i) {
                ...
                return (
                    ht(t, function (t) {
                        for (var e in ((De[t] = Q[t] = o), (De[(r = t.toLowerCase())] = n), o)) De[r + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = De[t + "." + e] = o[e];
                    }),
                    o
                );
            },
        ...
        ht("Linear,Quad,Cubic,Quart,Quint,Strong", function (t, e) {
            ...
            Ae(
                ...
                (_ = function (t) {
                    return t < D ? x * t * t : t < 0.7272727272727273 ? x * Math.pow(t - 1.5 / w, 2) + 0.75 : t < 0.9090909090909092 ? x * (t -= 2.25 / w) * t + 0.9375 : x * Math.pow(t - 2.625 / w, 2) + 0.984375;
                })
            ),
            Ae("Expo", function (t) {
            ...
            (De.SteppedEase = De.steps = Q.SteppedEase = {
                config: function (t, e) {
                    void 0 === t && (t = 1);
                    var n = 1 / t,
                        i = t + (e ? 0 : 1),
        ...
        var Fe = function (t, e) {
                (this.id = A++), (t._gsap = this), (this.target = t), (this.harness = e), (this.get = e ? e.get : ft), (this.set = e ? e.getSetter : Ue);
            },
            Be = (function () {
                function t(t) {
                    (this.vars = t),
                ...
                return (
                    ...
                    (e.totalTime = function (t, e) {
                        ...
                        return (
                            (this._tTime !== t || (!this._dur && !e) || (this._initted && 1e-8 === Math.abs(this._zTime)) || (!t && !this._initted && (this.add || this._ptLookup))) && (this._ts || (this._pTime = t), bt(this, t, e)), this
                        );
                    }),
                    (e.time = function (t, e) {
                    ...
                    (e.timeScale = function (t) {
                        ...
                        return (this._rts = +t || 0), (this._ts = this._ps || -1e-8 === t ? 0 : this._rts), Ot(this.totalTime(Yt(-this._delay, this._tDur, e), !0)), Lt(this), this;
                    }),
                    (e.paused = function (t) {
                    ...
                    (e.then = function (t) {
                        ...
                        return new Promise(function (n) {
                            var i = B(t) ? t : wt,
                                r = function () {
                                    var t = e.then;
                                    (e.then = null), B(i) && (i = i(e)) && (i.then || i === e) && (e.then = t), n(i), (e.then = t);
                                };
        ...
        Dt(Be.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -1e-8, _prom: 0, _ps: !1, _rts: 1 });
        var Le = (function (t) {
            function e(e, n) {
                var i;
                return (
            ...
            return (
                ...
                (n.set = function (t, e, n) {
                    return (e.duration = 0), (e.parent = this), Tt(e).repeatDelay || (e.repeat = 0), (e.immediateRender = !!e.immediateRender), new He(t, e, Gt(this, n), 1), this;
                }),
                (n.call = function (t, e, n) {
                    return Rt(this, He.delayedCall(0, t, e), n);
                }),
                (n.staggerTo = function (t, e, n, i, r, o, s) {
                    return (n.duration = e), (n.stagger = n.stagger || i), (n.onComplete = o), (n.onCompleteParams = s), (n.parent = this), new He(t, n, Gt(this, r)), this;
                }),
                (n.staggerFrom = function (t, e, n, i, r, o, s) {
                    return (n.runBackwards = 1), (Tt(n).immediateRender = R(n.immediateRender)), this.staggerTo(t, e, n, i, r, o, s);
                }),
                (n.staggerFromTo = function (t, e, n, i, r, o, s, a) {
                    return (i.startAt = n), (Tt(i).immediateRender = R(i.immediateRender)), this.staggerTo(t, e, i, r, o, s, a);
                }),
                (n.render = function (t, e, n) {
                    ...
                    if ((this !== p && b > g && t >= 0 && (b = g), b !== this._tTime || n || x)) {
                        if ((v !== this._time && y && ((b += this._time - v), (t += this._time - v)), (i = b), (d = this._start), (l = !(c = this._ts)), x && (y || (v = this._zTime), (t || !e) && (this._zTime = t)), this._repeat)) {
                            if (((h = this._yoyo), (a = y + this._rDelay), this._repeat < -1 && t < 0)) return this.totalTime(100 * a + t, e, n);
                            if (
                                ((i = vt(b % a)),
                                b === g ? ((s = this._repeat), (i = y)) : ((s = ~~(b / a)) && s === b / a && ((i = y), s--), i > y && (i = y)),
                                (f = Ft(this._tTime, a)),
                                ...
                                if (
                                    ...
                                    return this;
                                if (((y = this._dur), (g = this._tDur), D && ((this._lock = 2), (v = w ? y : -1e-4), this.render(v, !0), this.vars.repeatRefresh && !m && this.invalidate()), (this._lock = 0), !this._ts && !l)) return this;
                                Te(this, m);
                            }
                        }
                        if (
                        ...
                        if (u && !e && (this.pause(), (u.render(i >= v ? 0 : -1e-8)._zTime = i >= v ? 1 : -1), this._ts)) return (this._start = d), Lt(this), this.render(t, e, n);
                        this._onUpdate && !e && ue(this, "onUpdate", !0),
                            ((b === g && g >= this.totalDuration()) || (!b && v)) &&
                                ((d !== this._start && Math.abs(c) === Math.abs(this._ts)) ||
                                    ...
                                    e || (t < 0 && !v) || (!b && !v && g) || (ue(this, b === g && t >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(b < g && this.timeScale() > 0) && this._prom())));
                    }
                    return this;
                }),
                (n.add = function (t, e) {
                ...
                (n.getChildren = function (t, e, n, i) {
                    ...
                    for (var r = [], o = this._first; o; ) o._start >= i && (o instanceof He ? e && r.push(o) : (n && r.push(o), t && r.push.apply(r, o.getChildren(!0, e, n)))), (o = o._next);
                    return r;
                }),
                ...
                (n.remove = function (t) {
                    return F(t) ? this.removeLabel(t) : B(t) ? this.killTweensOf(t) : (Pt(this, t), t === this._recent && (this._recent = this._last), kt(this));
                }),
                (n.totalTime = function (e, n) {
                    return arguments.length
                        ? ((this._forcing = 1),
                          !this._dp && this._ts && (this._start = vt(xe.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))),
                ...
                (n.getTweensOf = function (t, e) {
                    for (var n, i = [], r = Jt(t), o = this._first, s = L(e); o; )
                        o instanceof He
                            ? gt(o._targets, r) && (s ? (!Ie || (o._initted && o._ts)) && o.globalTime(0) <= e && o.globalTime(o.totalDuration()) > e : !e || o.isActive()) && i.push(o)
                            ...
                            Dt(
                                {
                                    ...
                                    onStart: function () {
                                        if ((i.pause(), !n)) {
                                            ...
                                            c._dur !== t && Wt(c, t, 0, 1).render(c._time, !0, !0), (n = 1);
                                        }
                                        a && a.apply(c, l || []);
                                    },
                                },
                ...
                (n.tweenFromTo = function (t, e, n) {
                    return this.tweenTo(e, Dt({ startAt: { time: Gt(this, t) } }, n));
                }),
                (n.recent = function () {
                    return this._recent;
                }),
                    ...
                    if (o._dirty) {
                        for (i = o.parent; s; )
                            (e = s._prev),
                                ...
                                (n = s._start) > a && o._sort && s._ts && !o._lock ? ((o._lock = 1), (Rt(o, s, n - s._delay, 1)._lock = 0)) : (a = n),
        ...
        Dt(Le.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
        var Ie,
            je = function (t, e, n, i, r, o, s) {
                var a,
                    ...
                    v = 0,
                    g = 0;
                for (m.b = n, m.e = i, n += "", (f = ~(i += "").indexOf("random(")) && (i = se(i)), o && (o((h = [n, i]), t, e), (n = h[0]), (i = h[1])), l = n.match($) || []; (a = $.exec(i)); )
                    (c = a[0]),
                        ...
                        c !== l[g++] &&
                            ...
                            (v = $.lastIndex));
                return (m.c = v < i.length ? i.substring(v, i.length) : ""), (m.fp = s), (X.test(i) || f) && (m.e = 0), (this._pt = m), m;
            },
            Re = function (t, e, n, i, r, o, s, a, l) {
                B(i) && (i = i(r || 0, t, o));
                var u,
                    c = t[e],
                    d = "get" !== n ? n : B(c) ? (l ? t[e.indexOf("set") || !B(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](l) : t[e]()) : c,
                    p = B(c) ? (l ? Xe : $e) : Ge;
                if ((F(i) && (~i.indexOf("random(") && (i = se(i)), "=" === i.charAt(1) && ((u = parseFloat(d) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (Ut(d) || 0)) || 0 === u) && (i = u)), d !== i))
                    return isNaN(d * i) || "" === i
                        ? (!c && !(e in t) && J(e, i), je.call(this, t, e, d, i, p, a || S.stringFilter, l))
                        : ((u = new on(this._pt, t, e, +d || 0, i - (d || 0), "boolean" == typeof c ? Ke : Qe, 0, p)), l && (u.fp = l), s && u.modifier(s, this, t), (this._pt = u));
            },
                    ...
                    !1 !==
                        (s = new st[t]()).init(
                            ...
                            s.rawVars
                                ? e[t]
                                : (function (t, e, n, i, r) {
                                      if ((B(t) && (t = qe(t, r, e, n, i)), !j(t) || (t.style && t.nodeType) || W(t) || q(t))) return F(t) ? qe(t, r, e, n, i) : t;
                                      var o,
                                          s = {};
            ...
            Ne = function t(e, n) {
                ...
                if (
                    ...
                    if (((v = (c = F[0] ? pt(F[0]).harness : 0) && y[c.prop]), (i = Et(y, it)), M && M.render(-1, !0).kill(), x))
                        if (
                            (At((e._startAt = He.set(F, Dt({ data: "isStart", overwrite: !1, parent: B, immediateRender: !0, lazy: R(D), startAt: null, delay: 0, onUpdate: _, onUpdateParams: S, callbackScope: E, stagger: 0 }, x)))),
                        ...
                        if (M) !k && (e._startAt = 0);
                            ...
                            (n && (w = !1),
                            (o = Dt({ overwrite: !1, data: "isFromStart", lazy: w && R(D), immediateRender: w, stagger: 0, parent: B }, i)),
                            v && (o[c.prop] = v),
                    ...
                    for (e._pt = 0, D = (O && R(D)) || (D && !O), r = 0; r < F.length; r++) {
                        if (
                            ...
                            c &&
                                ...
                                ((e._pt = s = new on(e._pt, a, f.name, 0, 1, f.render, f, 0, f.priority)),
                            ...
                            for (o in i) st[o] && (f = ze(o, i, e, m, a, L)) ? f.priority && (l = 1) : (h[o] = s = Re.call(e, a, o, "get", i[o], m, L, 0, y.stringFilter));
                        e._op && e._op[r] && e.kill(a, e._op[r]), I && e._pt && ((Ie = e), p.killTweensOf(a, h, e.globalTime(n)), (g = !e.parent), (Ie = 0)), e._pt && D && (ot[u.id] = 1);
                    }
            ...
            He = (function (t) {
                function e(e, n, i, r) {
                    ...
                    if (((o._targets = A.length ? dt(A) : tt("GSAP target " + e + " not found. https://greensock.com", !S.nullTargetWarn) || []), (o._ptLookup = []), (o._overwrite = D), _ || w || N(y) || N(b))) {
                        if (((n = o.vars), (s = o.timeline = new Le({ data: "nested", defaults: C || {} })).kill(), (s.parent = s._dp = u(o)), (s._start = 0), _))
                            Tt(Dt(s.vars.defaults, { ease: "none" })),
                                w
                            ...
                            if (((c = A.length), (m = w ? ee(w) : nt), j(w))) for (f in w) ~We.indexOf(f) && (v || (v = {}), (v[f] = w[f]));
                            for (a = 0; a < c; a++) {
                                ...
                                (l.stagger = 0),
                                    ...
                                    !w && 1 === c && l.delay && ((o._delay = b = l.delay), (o._start += b), (l.delay = 0)),
                                    s.to(h, l, m(a, h, A));
                            }
                ...
                return (
                        ...
                        if (h) {
                            if (m !== this._tTime || !t || n || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
                                if (((i = m), (c = this.timeline), this._repeat)) {
                                    ...
                                    if (
                                        ((i = vt(m % s)),
                                        m === f ? ((o = this._repeat), (i = h)) : ((o = ~~(m / s)) && o === m / s && ((i = h), o--), i > h && (i = h)),
                                        (l = this._yoyo && 1 & o) && ((d = this._yEase), (i = h - i)),
                                        (a = Ft(this._tTime, s)),
                                        i === p && !n && this._initted)
                                    )
                                        return this;
                                    o !== a && (c && this._yEase && Te(c, l), !this.vars.repeatRefresh || l || this._lock || ((this._lock = n = 1), (this.render(vt(s * o), !0).invalidate()._lock = 0)));
                                }
                                if (!this._initted) {
                                    if (Nt(this, t < 0 ? t : i, n, e)) return (this._tTime = 0), this;
                                ...
                                (c && c.render(t < 0 ? t : !i && l ? -1e-8 : c._dur * u, e, n)) || (this._startAt && (this._zTime = t)),
                                    this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, n), ue(this, "onUpdate")),
                                    this._repeat && o !== a && this.vars.onRepeat && !e && this.parent && ue(this, "onRepeat"),
                                    (m !== this._tDur && m) ||
                                        this._tTime !== m ||
                                        (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0),
                                        (t || !h) && ((m === this._tDur && this._ts > 0) || (!m && this._ts < 0)) && At(this, 1),
                                        e || (t < 0 && !p) || (!m && !p) || (ue(this, m === f ? "onComplete" : "onReverseComplete", !0), this._prom && !(m < f && this.timeScale() > 0) && this._prom()));
                            }
                        } else
                            !(function (t, e, n, i) {
                                var r,
                                    ...
                                    c = 0;
                                if (
                                    (u && t._repeat && ((c = Yt(0, t._tDur, e)), (o = Ft(c, u)), (s = Ft(t._tTime, u)), t._yoyo && 1 & o && (l = 1 - l), o !== s && ((a = 1 - l), t.vars.repeatRefresh && t._initted && t.invalidate())),
                                    l !== a || i || 1e-8 === t._zTime || (!e && t._zTime))
                                ) {
                                    if (!t._initted && Nt(t, e, i, n)) return;
                                    for (s = t._zTime, t._zTime = e || (n ? 1e-8 : 0), n || (n = e && !s), t.ratio = l, t._from && (l = 1 - l), t._time = 0, t._tTime = c, r = t._pt; r; ) r.r(l, r.d), (r = r._next);
                                    t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                                        t._onUpdate && !n && ue(t, "onUpdate"),
                                        c && t._repeat && !n && t.parent && ue(t, "onRepeat"),
                                        (e >= t._tDur || e < 0) && t.ratio === l && (l && At(t, 1), n || (ue(t, l ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
                    ...
                    (n.kill = function (t, e) {
                        ...
                        if (this.timeline) {
                            ...
                            return this.timeline.killTweensOf(t, e, Ie && !0 !== Ie.vars.overwrite)._first || ce(this), this.parent && n !== this.timeline.totalDuration() && Wt(this, (this._dur * this.timeline._tDur) / n, 0, 1), this;
                        }
                        var i,
                            r,
                            o,
                                ...
                                "all" !== e &&
                                    ...
                                    (e = (function (t, e) {
                                        var n,
                                            ...
                                            a = s && s.aliases;
                                        if (!a) return e;
                                        for (i in ((n = St({}, e)), a)) if ((i in n)) for (r = (o = a[i].split(",")).length; r--; ) n[o[r]] = n[i];
                                        return n;
                                    })(c, e))),
                                u = c.length;
                            u--;
        ...
        Dt(He.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
        ...
        var Ge = function (t, e, n) {
            ...
            on = (function () {
                function t(t, e, n, i, r, o, s, a, l) {
                    (this.t = e), (this.s = i), (this.c = r), (this.p = n), (this.r = o || Qe), (this.d = s || this), (this.set = a || Ge), (this.pr = l || 0), (this._next = t), t && (t._prev = this);
                }
                return (
        ...
        ht(
            ...
            (p = new Le({ sortChildren: !1, defaults: C, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
            (S.stringFilter = be);
        var sn = {
            ...
            quickSetter: function (t, e, n) {
                ...
                var o = st[e],
                    ...
                    l = o
                        ? function (e) {
                              var i = new o();
                              (y._pt = 0), i.init(t, n ? e + n : e, y, 0, [t]), i.render(1, i), y._pt && Je(1, y);
                          }
                        : s.set(t, a);
                return o
                    ? l
            ...
            exportRoot: function (t, e) {
                ...
                var n,
                    i,
                    r = new Le(t);
                for (r.smoothChildTiming = R(t.smoothChildTiming), p.remove(r), r._dp = 0, r._time = r._tTime = p._time, n = p._first; n; )
                    (i = n._next), (!e && !n._dur && n instanceof He && n.vars.onComplete === n._targets[0]) || Rt(r, n, n._start - n._delay), (n = i);
                return Rt(p, r, 0), r;
            },
            utils: {
                ...
                selector: function (t) {
                    return (
                        ...
                        function (e) {
                            ...
                            return Jt(e, n.querySelectorAll ? n : n === t ? tt("Invalid scope") || m.createElement("div") : t);
                        }
                    );
                },
                mapRange: ae,
                        ...
                        i._onInit = function (t) {
                            ...
                            !(function (t, e) {
                                var n,
                                    ...
                                    r,
                                    o = t._targets;
                                for (n in e) for (i = o.length; i--; ) (r = t._ptLookup[i][n]) && (r = r.d) && (r._pt && (r = an(r, n)), r && r.modifier && r.modifier(e[n], t, o[i], n));
                            })(t, n);
                        };
                    },
                };
        ...
        var cn,
            ...
            Nn = function t(e, n, i) {
                ...
                return r[n] || r.getPropertyValue(n.replace(wn, "-$1").toLowerCase()) || r.getPropertyValue(n) || (!i && t(e, Wn(n) || n, 1)) || "";
            },
            ...
            $n = function (t) {
                ...
                return (e && (e.width || e.height)) || t.getBBox === Hn || (e = Hn.call(t, !0)), !e || e.width || e.x || e.y ? e : { x: +Gn(t, ["x", "cx", "x1"]) || 0, y: +Gn(t, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
            },
            Xn = function (t) {
            ...
            Yn = function (t, e) {
                if (e) {
                    var n = t.style;
                    e in gn && e !== Rn && (e = jn), n.removeProperty ? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) || (e = "-" + e), n.removeProperty(e.replace(wn, "-$1").toLowerCase())) : n.removeAttribute(e);
                }
            },
                ...
                return r === c || !u || Qn[r] || Qn[c]
                    ...
                    : ("px" !== c && !m && (u = t(e, n, i, "px")),
                      ...
                      (!v && "%" !== c) || (!gn[n] && !~n.indexOf("adius"))
                          ...
                          : ((o = l ? e.getBBox()[p ? "width" : "height"] : e[h]), mt(v ? (u / o) * 100 : (u / 100) * o)));
            },
            Zn = function (t, e, n, i) {
                var r;
                return (
                    ...
                    gn[e] && "transform" !== e
                        ? ((r = ui(t, i)), (r = "transformOrigin" !== e ? r[e] : r.svg ? r.origin : ci(Nn(t, Rn)) + " " + r.zOrigin + "px"))
                        : (!(r = t.style[e]) || "auto" === r || i || ~(r + "").indexOf("calc(")) && (r = (ni[e] && ni[e](t, e, n)) || Nn(t, e) || ft(t, e) || ("opacity" === e ? 1 : 0)),
            ...
            Jn = function (t, e, n, i) {
                if (!n || "none" === n) {
                    var r = Wn(e, t, 1),
                        o = r && Nn(t, r, 1);
                    o && o !== n ? ((e = r), (n = o)) : "borderColor" === e && (n = Nn(t, "borderTopColor"));
                }
                var s,
                    a,
                    l,
                    ...
                    b = 0,
                    x = 0;
                if (((y.b = n), (y.e = i), (n += ""), "auto" === (i += "") && ((t.style[e] = i), (i = Nn(t, e) || i), (t.style[e] = n)), be((s = [n, i])), (i = s[1]), (l = (n = s[0]).match(G) || []), (i.match(G) || []).length)) {
                    for (; (a = G.exec(i)); )
                        (p = a[0]),
                            ...
                            p !== (d = l[x++] || "") &&
                                ...
                                m || ((m = m || S.units[e] || v), b === i.length && ((i += m), (y.e += m))),
                                v !== m && (u = Kn(t, e, d, m) || 0),
                                (y._pt = { _next: y._pt, p: h || 1 === x ? h : ",", s: u, c: g ? g * f : f - u, m: (c && c < 4) || "zIndex" === e ? Math.round : 0 }));
            ...
            ei = function (t, e) {
                if (e.tween && e.tween._time === e.tween._dur) {
                    ...
                    else for (r = (a = a.split(",")).length; --r > -1; ) (n = a[r]), gn[n] && ((i = 1), (n = "transformOrigin" === n ? Rn : jn)), Yn(o, n);
                    i && (Yn(o, jn), l && (l.svg && o.removeAttribute("transform"), ui(o, 1), (l.uncache = 1)));
                }
            },
            ni = {
            ...
            ai = function (t, e) {
                ...
                return s.svg && t.getAttribute("transform")
                    ...
                    : (l !== ii ||
                          ...
                          ((r = a.display),
                          (a.display = "block"),
                          ((n = t.parentNode) && t.offsetParent) || ((o = 1), (i = t.nextSibling), pn.appendChild(t)),
                          (l = si(t)),
                          r ? (a.display = r) : Yn(t, "display"),
                          o && (i ? n.insertBefore(t, i) : n ? n.appendChild(t) : pn.removeChild(t))),
            ...
            li = function (t, e, n, i, r, o) {
                var s,
                    ...
                    _ = parseFloat(w[1]) || 0;
                n
                    ? c !== ii && (a = m * y - v * g) && ((l = D * (-v / a) + _ * (m / a) - (m * x - v * b) / a), (D = D * (y / a) + _ * (-g / a) + (g * x - y * b) / a), (_ = l))
                    : ((D = (s = $n(t)).x + (~w[0].indexOf("%") ? (D / 100) * s.width : D)), (_ = s.y + (~(w[1] || w[0]).indexOf("%") ? (_ / 100) * s.height : _))),
                    i || (!1 !== i && u.smooth) ? ((b = D - d), (x = _ - p), (u.xOffset = f + (b * m + x * g) - b), (u.yOffset = h + (b * v + x * y) - x)) : (u.xOffset = u.yOffset = 0),
                    (u.xOrigin = D),
                    (u.yOrigin = _),
                    (u.smooth = !!i),
                    (u.origin = e),
                    ...
                    (t.style[Rn] = "0px 0px"),
                    o && (Un(o, u, "xOrigin", d, D), Un(o, u, "yOrigin", p, _), Un(o, u, "xOffset", f, u.xOffset), Un(o, u, "yOffset", h, u.yOffset)),
            ...
            ui = function (t, e) {
                ...
                return (
                    ...
                    (n.svg = !(!t.getCTM || !Xn(t))),
                    (v = ai(t, n.svg)),
                    n.svg && ((T = (!n.uncache || "0px 0px" === R) && !e && t.getAttribute("data-svg-origin")), li(t, T || R, !!T || n.originIsAbsolute, !1 !== n.smooth, v)),
                    (h = n.xOrigin || 0),
                    (m = n.yOrigin || 0),
                    v !== ii &&
                        ((x = v[0]),
                        ...
                        6 === v.length
                            ? ((s = Math.sqrt(x * x + w * w)),
                              (a = Math.sqrt(_ * _ + D * D)),
                              (l = x || w ? xn(w, x) * yn : 0),
                              (d = D || _ ? xn(D, _) * yn + l : 0) && (a *= Math.abs(Math.cos(d * bn))),
                            ...
                            : ((L = v[6]),
                              ...
                              g &&
                                  ...
                                  (L = A)),
                              (c = (g = xn(-D, M)) * yn),
                              g && ((y = Math.cos(-g)), (B = _ * (b = Math.sin(-g)) + B * y), (x = T = x * y - k * b), (w = P = w * y - O * b), (D = A = D * y - M * b)),
                              (l = (g = xn(w, x)) * yn),
                              g && ((T = x * (y = Math.cos(g)) + w * (b = Math.sin(g))), (P = C * y + E * b), (w = w * y - x * b), (E = E * y - C * b), (x = T), (C = P)),
                              ...
                              (f = B ? 1 / (B < 0 ? -B : B) : 0)),
                        n.svg && ((T = t.getAttribute("transform")), (n.forceCSS = t.setAttribute("transform", "") || !oi(Nn(t, jn))), T && t.setAttribute("transform", T))),
            ...
            pi = function (t, e) {
                ...
                if (y && ("0deg" !== c || "0deg" !== u)) {
                    var w,
                        ...
                        _ = Math.sin(D),
                        S = Math.cos(D);
                    (D = parseFloat(c) * bn), (w = Math.cos(D)), (o = di(g, o, _ * w * -y)), (s = di(g, s, -Math.sin(D) * -y)), (a = di(g, a, S * w * -y + y));
                }
                "0px" !== m && (b += "perspective(" + m + ") "),
                    (i || r) && (b += "translate(" + i + "%, " + r + "%) "),
                    (x || "0px" !== o || "0px" !== s || "0px" !== a) && (b += "0px" !== a || x ? "translate3d(" + o + ", " + s + ", " + a + ") " : "translate(" + o + ", " + s + ") "),
                    "0deg" !== l && (b += "rotate(" + l + ") "),
                    "0deg" !== u && (b += "rotateY(" + u + ") "),
                    "0deg" !== c && (b += "rotateX(" + c + ") "),
                ...
                (p = parseFloat(p)),
                    ...
                    p || f
                        ? ((p *= bn),
                          ...
                          (o = mt(o)))
                        : ((n = m), (o = v), (i = r = 0)),
                    ((_ && !~(c + "").indexOf("px")) || (S && !~(d + "").indexOf("px"))) && ((_ = Kn(g, "x", c, "px")), (S = Kn(g, "y", d, "px"))),
                    (y || b || x || w) && ((_ = mt(_ + y - (y * n + b * r) + x)), (S = mt(S + b - (y * i + b * o) + w))),
                    (l || u) && ((s = g.getBBox()), (_ = mt(_ + (l / 100) * s.width)), (S = mt(S + (u / 100) * s.height))),
            ...
            mi = function (t, e, n, i, r, o) {
                ...
                return (
                    l &&
                        ("short" === (s = r.split("_")[1]) && (c %= 360) !== c % 180 && (c += c < 0 ? 360 : -360),
            ...
            gi = function (t, e, n) {
                var i,
                    ...
                    d = n.style;
                for (r in (c.svg
                    ? ((o = n.getAttribute("transform")), n.setAttribute("transform", ""), (d[jn] = e), (i = ui(n, 1)), Yn(n, jn), n.setAttribute("transform", o))
                    : ((o = getComputedStyle(n)[jn]), (d[jn] = e), (i = ui(n, 1)), (d[jn] = o)),
                gn))
                    (o = c[r]) !== (s = i[r]) &&
                        "perspective,force3D,transformOrigin,svgOrigin".indexOf(r) < 0 &&
                        ((a = Ut(o) !== (u = Ut(s)) ? Kn(n, r, o, u) : parseFloat(o)), (l = parseFloat(s)), (t._pt = new on(t._pt, i, r, a, l - a, Cn)), (t._pt.u = u || 0), t._props.push(r));
                vi(i, c);
            };
        ...
        var yi,
            ...
            xi = {
                ...
                init: function (t, e, n, i, r) {
                    ...
                    for (d in (fn || Vn(), e))
                        if ("autoRound" !== d && ((s = e[d]), !st[d] || !ze(d, e, n, i, t, r)))
                            if (((u = typeof s), (c = ni[d]), "function" === u && (u = typeof (s = s.call(n, i, t, r))), "string" === u && ~s.indexOf("random(") && (s = se(s)), c)) c(this, t, d, s, n) && (b = 1);
                                ...
                                if (
                                    (T && d in T
                                        ? ((o = "function" == typeof T[d] ? T[d].call(n, i, t, r) : T[d]),
                                    ...
                                    (a = parseFloat(s)),
                                    d in Sn &&
                                        ("autoAlpha" === d && (1 === l && "hidden" === Zn(t, "visibility") && a && (l = 0), Un(this, E, "visibility", l ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)),
                                        "scale" !== d && "transform" !== d && ~(d = Sn[d]).indexOf(",") && (d = d.split(",")[0])),
                                    (m = d in gn))
                                )
                                    if (
                                        (v ||
                                            (((g = t._gsap).renderTransform && !e.parseTransform) || ui(t, e.parseTransform),
                                            (y = !1 !== e.smoothOrigin && g.smooth),
                                            ((v = this._pt = new on(this._pt, E, jn, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                                        "scale" === d)
                                    )
                                        (this._pt = new on(this._pt, g, "scaleY", g.scaleY, (h ? h * a : a - g.scaleY) || 0)), C.push("scaleY", d), (d += "X");
                                    else {
                                        if ("transformOrigin" === d) {
                                            (w = void 0),
                                                ...
                                                (D = w[0]),
                                                (_ = w[1] || "50%"),
                                                ("top" !== D && "bottom" !== D && "left" !== _ && "right" !== _) || ((x = D), (D = _), (_ = x)),
                                                (w[0] = ti[D] || D),
                                                (w[1] = ti[_] || _),
                                                (s = w.join(" ")),
                                                g.svg ? li(t, s, 0, y, 0, this) : ((f = parseFloat(s.split(" ")[2]) || 0) !== g.zOrigin && Un(this, g, "zOrigin", g.zOrigin, f), Un(this, E, d, ci(o), ci(s)));
                                            continue;
                                        }
                                        if ("svgOrigin" === d) {
                                            li(t, s, 1, y, 0, this);
                                ...
                                if (m || ((a || 0 === a) && (l || 0 === l) && !_n.test(s) && d in E))
                                    a || (a = 0),
                                        (p = (o + "").substr((l + "").length)) !== (f = Ut(s) || (d in S.units ? S.units[d] : p)) && (l = Kn(t, d, o, f)),
                                        (this._pt = new on(this._pt, m ? g : E, d, l, h ? h * a : a - l, m || ("px" !== f && "zIndex" !== d) || !1 === e.autoRound ? Cn : Pn)),
                                        (this._pt.u = f || 0),
                                        p !== f && "%" !== f && ((this._pt.b = o), (this._pt.r = Tn));
                ...
                getSetter: function (t, e, n) {
                    ...
                    return (
                        i && i.indexOf(",") < 0 && (e = i),
                        e in gn && e !== Rn && (t._gsap.x || Zn(t, "x")) ? (n && mn === n ? ("scale" === e ? Bn : Fn) : (mn = n || {}) && ("scale" === e ? Ln : In)) : t.style && !I(t.style[e]) ? On : ~e.indexOf("-") ? Mn : Ue(t, e)
                    );
                },
                core: { _removeProperty: Yn, _getMatrix: ai },
            };
        (un.utils.checkPrefix = Wn),
            (bi = ht("x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + (yi = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function (t) {
                gn[t] = 1;
            })),
            ht(yi, function (t) {
        ...
        var wi,
            ...
            pr = function (t, e) {
                var n = e.s,
                    ...
                    r = e.d,
                    o = e.a;
                return (n = "scroll" + i) && (o = ur(t, n)) ? o() - dr(t)()[r] : lr(t) ? (Ei[n] || Ci[n]) - (_i["inner" + i] || Ci["client" + i] || Ei["client" + i]) : t[n] - t["offset" + i];
            },
            fr = function (t, e) {
                for (var n = 0; n < qi.length; n += 3) (!e || ~e.indexOf(qi[n + 1])) && t(qi[n], qi[n + 1], qi[n + 2]);
            },
            hr = function (t) {
                return "string" == typeof t;
            },
            ...
            Cr = {
                ...
                a: "x",
                sc: function (t) {
                    return arguments.length ? _i.scrollTo(t, Er.sc()) : _i.pageXOffset || Si.scrollLeft || Ci.scrollLeft || Ei.scrollLeft || 0;
                },
            },
            Er = {
                s: "scrollTop",
                ...
                op: Cr,
                sc: function (t) {
                    return arguments.length ? _i.scrollTo(Cr.sc(), t) : _i.pageYOffset || Si.scrollTop || Ci.scrollTop || Ei.scrollTop || 0;
                },
            },
            Tr = function (t) {
            ...
            Ar = function (t, e) {
                var n = e && "matrix(1, 0, 0, 1, 0, 0)" !== Tr(t)[ji] && wi.to(t, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
            ...
            jr = { toggleActions: "play", anticipatePin: 0 },
            Rr = { top: 0, left: 0, center: 0.5, bottom: 1, right: 1 },
            zr = function (t, e) {
                if (hr(t)) {
                    var n = t.indexOf("="),
                        i = ~n ? +(t.charAt(n - 1) + 1) * parseFloat(t.substr(n + 1)) : 0;
                    ~n && (t.indexOf("%") > n && (i *= e / 100), (t = t.substr(0, n - 1))), (t = i + (t in Rr ? Rr[t] * e : ~t.indexOf("%") ? (parseFloat(t) * e) / 100 : parseFloat(t) || 0));
                }
                return t;
            },
            Nr = function (t, e, n, i, r, o, s, a) {
                ...
                return (
                    ...
                    (m || a || !h) && (b += (i === Er ? "right" : "bottom") + ":" + (o + parseFloat(d)) + "px;"),
            ...
            qr = function (t, e, n, i) {
                var r = { display: "block" },
                    o = n[i ? "os2" : "p2"],
                    s = n[i ? "p2" : "os2"];
                (t._isFlipped = i), (r[n.a + "Percent"] = i ? -100 : 0), (r[n.a] = i ? "1px" : 0), (r["border" + o + "Width"] = 1), (r["border" + s + "Width"] = 0), (r[n.p] = e + "px"), wi.set(t, r);
            },
            Wr = [],
            Vr = {},
            Hr = function () {
            ...
            Qr = function (t) {
                var e,
                    ...
                    r = 0;
                if (Xi !== n || Qi) {
                    for (eo(); r < Ur.length; r += 4) (e = _i.matchMedia(Ur[r]).matches) !== Ur[r + 3] && ((Ur[r + 3] = e), e ? i.push(r) : eo(1, Ur[r]) || (mr(Ur[r + 2]) && Ur[r + 2]()));
                    for (to(), r = 0; r < i.length; r++) (e = i[r]), ($i = Ur[e]), (Ur[e + 2] = Ur[e + 1](t));
            ...
            Jr = [],
            to = function (t) {
                for (var e = 0; e < Jr.length; e += 5) (t && Jr[e + 4] !== t) || ((Jr[e].style.cssText = Jr[e + 1]), Jr[e].getBBox && Jr[e].setAttribute("transform", Jr[e + 2] || ""), (Jr[e + 3].uncache = 1));
            },
            eo = function (t, e) {
                var n;
                for (Ri = 0; Ri < Wr.length; Ri++) (n = Wr[Ri]), (e && n.media !== e) || (t ? n.kill(1) : n.revert());
                e && to(e), e || Zr("revert");
            },
            no = function () {
            ...
            so = function () {
                if (!Yi) {
                    var t = Wr.length,
                        ...
                        n = e - tr >= 50,
                        i = t && Wr[0].scroll();
                    if (((oo = ro > i ? -1 : 1), (ro = i), n && (er && !Ii && e - er > 200 && ((er = 0), Zr("scrollEnd")), (Fi = tr), (tr = e)), oo < 0)) {
            ...
            lo = ao.concat(["width", "height", "boxSizing", "maxWidth", "maxHeight", "position", "margin", _r, _r + "Top", _r + "Right", _r + "Bottom", _r + "Left"]),
            uo = function (t, e, n, i) {
                if (t.parentNode !== e) {
                    for (var r, o = ao.length, s = e.style, a = t.style; o--; ) s[(r = ao[o])] = n[r];
            ...
            po = function (t) {
                if (t) {
                    var e,
                        ...
                        r = t.length,
                        o = 0;
                    for ((t.t._gsap || wi.core.getCache(t.t)).uncache = 1; o < r; o += 2) (n = t[o + 1]), (e = t[o]), n ? (i[e] = n) : i[e] && i.removeProperty(e.replace(co, "-$1").toLowerCase());
                }
            },
            fo = function (t) {
                for (var e = lo.length, n = t.style, i = [], r = 0; r < e; r++) i.push(lo[r], n[lo[r]]);
                return (i.t = t), i;
            },
            ho = { left: 0, top: 0 },
            mo = function (t, e, n, i, r, o, s, a, l, u, c, d, p) {
                mr(t) && (t = t(a)), hr(t) && "max" === t.substr(0, 3) && (t = d + ("=" === t.charAt(4) ? zr("0" + t.substr(3), n) : 0));
                var f,
                    h,
                    m,
                    v = p ? p.time() : 0;
                if ((p && p.seek(0), vr(t))) s && qr(s, n, i, !0);
                    ...
                    var g,
                        ...
                        w = t.split(" ");
                    (m = rr(e) || Ei),
                        ((g = Ar(m) || {}) && (g.left || g.top)) || "none" !== Tr(m).display || ((x = m.style.display), (m.style.display = "block"), (g = Ar(m)), x ? (m.style.display = x) : m.style.removeProperty("display")),
                        (y = zr(w[0], g[i.d])),
                        (b = zr(w[1] || "0", n)),
                ...
                if (o) {
                    var D = t + n,
                        _ = o._isStart;
                    (f = "scroll" + i.d2), qr(o, D, i, (_ && D > 20) || (!_ && (c ? Math.max(Ei[f], Ci[f]) : o.parentNode[f]) <= D + 1)), c && ((l = Ar(s)), c && (o.style[i.op.p] = l[i.op.p] - i.op.m - o._offset + Sr));
                }
                return p && m && ((f = Ar(m)), p.seek(d), (h = Ar(m)), (p._caScrollDist = f[i.p] - h[i.p]), (t = (t / p._caScrollDist) * d)), p && p.seek(v), p ? t : Math.round(t);
            },
            ...
            go = function (t, e, n, i) {
                if (t.parentNode !== e) {
                    var r,
                        ...
                        s = t.style;
                    if (e === Ei) {
                        for (r in ((t._stOrig = s.cssText), (o = Tr(t)))) +r || vo.test(r) || !o[r] || "string" != typeof s[r] || "0" === r || (s[r] = o[r]);
                        (s.top = n), (s.left = i);
                ...
                var n,
                    ...
                    s = function e(s, a, l, u, c) {
                        ...
                        return (
                            ...
                            (a.modifiers = f),
                            (f[o] = function (t) {
                                return (t = or(r())) !== n && t !== i && Math.abs(t - n) > 2 ? (d.kill(), (e.tween = 0)) : (t = l + u * d.ratio + c * d.ratio * d.ratio), (i = n), (n = or(t));
                            }),
        ...
        var bo = (function () {
            function t(e, n) {
                Di || t.register(wi) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"), this.init(e, n);
            }
            return (
                (t.prototype.init = function (e, n) {
                    if (((this.progress = this.start = 0), this.vars && this.kill(1), nr)) {
                        var i,
                            ...
                            q,
                            W,
                            V = (e = Pr(hr(e) || vr(e) || e.nodeType ? { trigger: e } : e, jr)),
                            H = V.onUpdate,
                            G = V.toggleClass,
                            $ = V.id,
                            X = V.onToggle,
                            ...
                            ct = e.horizontal || (e.containerAnimation && !1 !== e.horizontal) ? Cr : Er,
                            dt = !U && 0 !== U,
                            pt = rr(e.scroller || _i),
                            ft = wi.core.getCache(pt),
                            ht = lr(pt),
                            mt = "fixed" === ("pinType" in e ? e.pinType : ur(pt, "pinType") || (ht && "fixed")),
                        ...
                        if (
                            ...
                            (ft.tweenScroll = ft.tweenScroll || { top: yo(pt, Er), left: yo(pt, Cr) }),
                            ...
                            Wr.push(xt),
                            rt &&
                                ((gr(rt) && !rt.push) || (rt = { snapTo: rt }),
                                "scrollBehavior" in Ei.style && wi.set(ht ? [Ei, Ci] : pt, { scrollBehavior: "auto" }),
                                (o = mr(rt.snapTo)
                                    ? rt.snapTo
                                    : "labels" === rt.snapTo
                                    ? (function (t) {
                                    ...
                                    .delayedCall(rt.delay || F / 2 || 0.1, function () {
                                        if (Math.abs(xt.getVelocity()) < 10 && !Ii && St !== Ct()) {
                                            var t = n && !dt ? n.totalProgress() : xt.progress,
                                                e = ((t - O) / (Ji() - Fi)) * 1e3 || 0,
                                                r = wi.utils.clamp(-xt.progress, 1 - xt.progress, (Dr(e / 2) * e) / 0.185),
                                            ...
                                            if (c <= u && c >= l && d !== c) {
                                                ...
                                                !1 === rt.inertia && (r = a - xt.progress),
                                                    i(
                                                        d,
                                                        {
                                                            duration: B(Dr((0.185 * Math.max(Dr(s - t), Dr(a - t))) / e / 0.05 || 0)),
                                                            ease: rt.ease || "power3",
                                                            data: Dr(d - c),
                                                            ...
                                                            onComplete: function () {
                                                                (St = Ct()), (k = O = n && !dt ? n.totalProgress() : xt.progress), nt && nt(xt), v && v(xt);
                                                            },
                                                        },
                                                        c,
                                                        r * m,
                            ...
                            (Q = xt.trigger = rr(Q || K)),
                            (K = !0 === K ? Q : rr(K)),
                            hr(G) && (G = { targets: Q, className: G }),
                            K &&
                                (!1 === Z || "margin" === Z || (Z = !(!Z && "flex" === Tr(K.parentNode).display) && _r),
                                (xt.pin = K),
                                !1 !== e.force3D && wi.set(K, { force3D: !0 }),
                                (r = wi.core.getCache(K)).spacer
                                    ? (v = r.pinState)
                                    : (st && ((st = rr(st)) && !st.nodeType && (st = st.current || st.nativeElement), (r.spacerIsNative = !!st), st && (r.spacerState = fo(st))),
                        ...
                        (xt.previous = function () {
                            ...
                            (xt.revert = function (t) {
                                var e = !1 !== t || !xt.enabled,
                                    i = Li;
                                e !== xt.isReverted &&
                                    (e && (xt.scroll.rec || (xt.scroll.rec = Ct()), (j = Math.max(Ct(), xt.scroll.rec || 0)), (I = xt.progress), (R = n && n.progress())),
                                    c &&
                            ...
                            (xt.refresh = function (i, r) {
                                if ((!Li && xt.enabled) || r)
                                    if (K && i && er) Br(t, "scrollEnd", Kr);
                                        ...
                                        (Li = 1), M && M.pause(), J && n && n.progress(0).invalidate(), xt.isReverted || xt.revert();
                                        for (
                                            var o,
                                                h,
                                                x,
                                                ...
                                                q = e.end,
                                                W = e.endTrigger || Q,
                                                V = e.start || (0 !== e.start && Q ? (K ? "0 0" : "0 100%") : 0),
                                            ...
                                            (T = Wr[$]).end || T.refresh(0, 1) || (Li = 1), !(P = T.pin) || (P !== Q && P !== K) || T.isReverted || (O || (O = []), O.unshift(T), T.revert());
                                        for (
                                            mr(V) && (V = V(xt)),
                                                l = mo(V, Q, F, ct, Ct(), c, p, xt, B, bt, mt, L, at) || (K ? -0.001 : 0),
                                                mr(q) && (q = q(xt)),
                                                hr(q) && !q.indexOf("+=") && (~q.indexOf(" ") ? (q = (hr(V) ? V.split(" ")[0] : "") + q) : ((z = zr(q.substr(2), F)), (q = hr(V) ? V : l + z), (W = Q))),
                                                u = Math.max(l, mo(q || (W ? "100% 0" : L), W, F, ct, Ct() + z, d, f, xt, B, bt, mt, L, at)) || -0.001,
                                                m = u - l || ((l -= 0.01) && 0.001),
                                                z = 0,
                                                $ = G;
                                            $--;
                                            ...
                                            (P = (T = Wr[$]).pin) && T.start - T._pinPush < l && !at && ((o = T.end - T.start), (P === Q || P === H) && !vr(V) && (z += o), P === K && (N += o));
                                        if (((l += z), (u += z), (xt._pinPush = N), c && z && (((o = {})[ct.a] = "+=" + z), H && (o[ct.p] = "-=" + Ct()), wi.set([c, d], o)), K))
                                            (o = Tr(K)),
                                                (D = ct === Er),
                                                (x = Ct()),
                                                (_ = parseFloat(w(ct.a)) + N),
                                                !L && u > 1 && ((ht ? Ei : pt).style["overflow-" + ct.a] = "scroll"),
                                                uo(K, b, o),
                                                (y = fo(K)),
                                                (h = Ar(K, !0)),
                                                (A = mt && cr(pt, D ? Cr : Er)()),
                                                Z && (((E = [Z + ct.os2, m + N + Sr]).t = b), ($ = Z === _r ? kr(K, ct) + m + N : 0) && E.push(ct.d, $ + Sr), po(E), mt && Ct(j)),
                                                mt &&
                                                    (((C = { top: h.top + (D ? x - l : A) + Sr, left: h.left + (D ? A : x - l) + Sr, boxSizing: "border-box", position: "fixed" }).width = C.maxWidth = Math.ceil(h.width) + Sr),
                                                    (C.height = C.maxHeight = Math.ceil(h.height) + Sr),
                                                ...
                                                n ? ((k = n._initted), Vi(1), n.render(n.duration(), !0, !0), (S = w(ct.a) - _ + m + N), m !== S && g.splice(g.length - 2, 2), n.render(0, !0, !0), k || n.invalidate(), Vi(0)) : (S = m);
                                        else if (Q && Ct() && !at) for (h = Q.parentNode; h && h !== Ei; ) h._pinOffset && ((l -= h._pinOffset), (u -= h._pinOffset)), (h = h.parentNode);
                                        O &&
                                            ...
                                            xt.revert(!1),
                                            (Li = 0),
                                            n && dt && n._initted && n.progress() !== R && n.progress(R, !0).render(n.time(), !0, !0),
                                            I !== xt.progress && (n && !dt && n.totalProgress(I, !0), (xt.progress = I), xt.update(0, 0, 1)),
                            ...
                            (xt.endAnimation = function () {
                                xr(xt.callbackAnimation), n && (M ? M.progress(1) : n.paused() ? dt || xr(n, xt.direction < 0, 1) : xr(n, n.reversed()));
                            }),
                            (xt.getTrailing = function (t) {
                                var e = Wr.indexOf(xt),
                                    n = xt.direction > 0 ? Wr.slice(0, e).reverse() : Wr.slice(e + 1);
                                return hr(t)
                                    ? n.filter(function (e) {
                            ...
                            (xt.update = function (t, e, r) {
                                if (!at || r || t) {
                                    var o,
                                        ...
                                        F = xt.progress;
                                    if (
                                        (e && ((a = s), (s = at ? Ct() : w), rt && ((O = k), (k = n && !dt ? n.totalProgress() : A))),
                                        tt && !A && K && !Li && !Qi && er && l < w + ((w - a) / (Ji() - Fi)) * tt && (A = 1e-4),
                                        A !== F && xt.enabled)
                                    ) {
                                        if (
                                            ((f = (h = (o = xt.isActive = !!A && A < 1) !== (!!F && F < 1)) || !!A != !!F),
                                            (xt.direction = A > F ? 1 : -1),
                                            (xt.progress = A),
                                            f && !Li && ((c = A && !F ? 0 : 1 === A ? 1 : 1 === F ? 2 : 3), dt && ((d = (!h && "none" !== gt[c + 1] && gt[c + 1]) || gt[c]), (x = n && ("complete" === d || "reset" === d || d in n)))),
                                            ut &&
                                                h &&
                                                (x || U || !n) &&
                                                (mr(ut)
                                            ...
                                            dt || (!M || Li || Qi ? n && n.totalProgress(A, !!Li) : ((M.vars.totalProgress = A), M.invalidate().restart())),
                                            K)
                                        )
                                            if ((t && Z && (b.style[Z + ct.os2] = C), mt)) {
                                                if (f) {
                                                    if (((v = !t && A > F && u + 1 > w && w + 1 >= pr(pt, ct)), ot))
                                                        if (t || (!o && !v)) go(K, b);
                                                        else {
                                                            var B = Ar(K, !0),
                                                                I = w - l;
                                                            go(K, Ei, B.top + (ct === Er ? I : 0) + Sr, B.left + (ct === Er ? 0 : I) + Sr);
                                                        }
                                                    po(o || v ? g : y), (S !== m && A < 1 && o) || D(_ + (1 !== A || v ? 0 : S));
                                                }
                                            } else D(_ + S * A);
                                        rt && !i.tween && !Li && !Qi && L.restart(!0),
                                            G &&
                                                ...
                                                Oi(G.targets).forEach(function (t) {
                                                    return t.classList[o || it ? "add" : "remove"](G.className);
                                                }),
                                            H && !dt && !t && H(xt),
                                            f && !Li
                                                ? (dt && (x && ("complete" === d ? n.pause().totalProgress(1) : "reset" === d ? n.restart(!0).pause() : "restart" === d ? n.restart(!0) : n[d]()), H && H(xt)),
                                                  (!h && Gi) || (X && h && wr(xt, X), vt[c] && wr(xt, vt[c]), it && (1 === A ? xt.kill(!1, 1) : (vt[c] = 0)), h || (vt[(c = 1 === A ? 1 : 3)] && wr(xt, vt[c]))),
                                                  lt && !o && Math.abs(xt.getVelocity()) > (vr(lt) ? lt : 2500) && (xr(xt.callbackAnimation), M ? M.progress(1) : xr(n, !A, 1)))
                                                : dt && H && !Li && H(xt);
                                    }
                                    if (P) {
                                        var j = at ? (w / at.duration()) * (at._caScrollDist || 0) : w;
                            ...
                            (xt.enable = function (e, n) {
                                xt.enabled || ((xt.enabled = !0), Br(pt, "resize", $r), Br(pt, "scroll", Gr), wt && Br(t, "refreshInit", wt), !1 !== e && ((xt.progress = I = 0), (s = a = St = Ct())), !1 !== n && xt.refresh());
                            }),
                            ...
                            (xt.disable = function (e, n) {
                                if (
                                    ...
                                    for (var o = Wr.length; o--; ) if (Wr[o].scroller === pt && Wr[o] !== xt) return;
                ...
                (t.register = function (e) {
                    if (
                        !Di &&
                        ((wi = e || ar()),
                        sr() && window.document && ((_i = window), (Si = document), (Ci = Si.documentElement), (Ei = Si.body)),
                        wi && ((Oi = wi.utils.toArray), (Mi = wi.utils.clamp), (Vi = wi.core.suppressOverwrites || ir), wi.core.globals("ScrollTrigger", t), Ei))
                    ) {
                        (Ai =
                        ...
                        (i.borderTopStyle = "solid"),
                            ...
                            (qi = [
                                ...
                                function () {
                                    var t = _i.innerWidth,
                                        e = _i.innerHeight;
                                    Si.hidden ? ((zi = t), (Ni = e)) : (zi === t && Ni === e) || $r();
                                },
                                Si,
                                "DOMContentLoaded",
                                io,
                ...
                (t.config = function (t) {
                    ...
                    (e && clearInterval(Bi)) || ((Bi = e) && setInterval(Hr, e)), "autoRefreshEvents" in t && (fr(Lr) || fr(Br, t.autoRefreshEvents || "none"), (Hi = -1 === (t.autoRefreshEvents + "").indexOf("resize")));
                }),
                (t.scrollerProxy = function (t, e) {
                    var n = rr(t),
                        i = Zi.indexOf(n),
                        r = lr(n);
                    ~i && Zi.splice(i, r ? 6 : 2), r ? Ki.unshift(_i, e, Ei, e, Ci, e) : Ki.unshift(n, e);
                }),
                    ...
                    for (n in t)
                        (i = Ur.indexOf(n)),
                            ...
                            "all" === n
                                ...
                                : (e = _i.matchMedia(n)) &&
                                  (e.matches && (o = r()),
                                  ~i ? ((Ur[i + 1] = br(Ur[i + 1], r)), (Ur[i + 2] = br(Ur[i + 2], o))) : ((i = Ur.length), Ur.push(n, r, o), e.addListener ? e.addListener(Qr) : e.addEventListener("change", Qr)),
                                  (Ur[i + 3] = e.matches)),
                            ($i = 0);
                    return Ur;
                }),
                ...
                (t.isInViewport = function (t, e, n) {
                    ...
                    return n ? i.right - r > 0 && i.left + r < _i.innerWidth : i.bottom - r > 0 && i.top + r < _i.innerHeight;
                }),
                (t.positionInViewport = function (t, e, n) {
                    hr(t) && (t = rr(t));
                    var i = t.getBoundingClientRect(),
                        r = i[n ? "width" : "height"],
                        o = null == e ? r / 2 : e in Rr ? Rr[e] * r : ~e.indexOf("%") ? (parseFloat(e) * r) / 100 : parseFloat(e) || 0;
        ...
        (bo.version = "3.8.0"),
            (bo.saveStyles = function (t) {
                return t
                    ? Oi(t).forEach(function (t) {
                          if (t && t.style) {
                              var e = Jr.indexOf(t);
                              e >= 0 && Jr.splice(e, 5), Jr.push(t, t.style.cssText, t.getBBox && t.getAttribute("transform"), wi.core.getCache(t), $i);
                          }
                      })
                    : Jr;
            }),
            ...
            (bo.batch = function (t, e) {
                ...
                for (n in e) r[n] = "on" === n.substr(0, 2) && mr(e[n]) && "onRefreshInit" !== n ? a(0, e[n]) : e[n];
                return (
                    mr(s) &&
                        ((s = s()),
        ...
        var wo = (function (t) {
                ...
                function i() {
                    var e;
                    return (e = t.apply(this, arguments) || this).detectBrowser(), e.bindScrolling(), e.ensureWebmSupport(), e;
                }
                (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), xo(e, n);
                var r = i.prototype;
                return (
                    (r.detectBrowser = function () {
                        (this.browser = Object(l.a)()),
                            (this.mobile = this.app.mobile = this.browser.mobile || !!this.browser.os.match(/android/i)),
                            document.documentElement.classList.remove("no-js"),
                            document.documentElement.classList.add(this.browser.name),
                            document.documentElement.classList.add(this.mobile ? "mobile" : "desktop");
                    }),
                    ...
                    (r.scrollEnable = function () {
                        var t;
                        document.documentElement.classList.remove("no-scroll"), null != (t = this.scrollProxy) && t.enable && this.scrollProxy.enable();
                    }),
                    (r.scrollDisable = function () {
                        var t;
                        document.documentElement.classList.add("no-scroll"), null != (t = this.scrollProxy) && t.enable && this.scrollProxy.disable();
                    }),
                    (r.scrollTop = function () {
                        var t;
                        return null != (t = this.scrollProxy) && t.top ? this.scrollProxy.top() : window.pageYOffset;
                    }),
                    (r.scrollLeft = function () {
                        var t;
                        return null != (t = this.scrollProxy) && t.left ? this.scrollProxy.left() : window.pageXOffset;
                    }),
                    (r.scrollHeight = function () {
                        var t;
                        return null != (t = this.scrollProxy) && t.height ? this.scrollProxy.height() : document.documentElement.scrollHeight;
                    }),
                    (r.scrollWidth = function () {
                        var t;
                        return null != (t = this.scrollProxy) && t.width ? this.scrollProxy.width() : document.documentElement.scrollWidth;
                    }),
                    (r.scrollTo = function (t, e, n) {
                        var i;
                        if ((void 0 === e && (e = 0), void 0 === n && (n = {}), (n = Object.assign({}, { offsetY: 0, offsetX: 0, duration: 0.5, callback: null }, n)), "number" != typeof t)) {
                            var r = this.app.query(t);
                            if (!r) return !1;
                            (t = r.offsetTop), (e = r.offsetLeft);
                        }
                        (t += n.offsetY), (e += n.offsetX), null != (i = this.scrollProxy) && i.to ? this.scrollProxy.to(t, e, n) : window.scrollTo(e, t);
                    }),
                    (r.ensureWebmSupport = function () {
                        if ("safari" !== this.browser.name) return !1;
                        document.body.querySelectorAll('source[type="video/webm"]').forEach(function (t) {
                            var e = t.parentNode;
                    ...
                    (r.loadLazyImages = function () {
                        return new Promise(function (t, e) {
                            return (
                                document.body.querySelectorAll('img[loading="lazy"]').forEach(function (t) {
                    ...
                    (r.goToHash = function () {
                        return new Promise(
                            function (t, e) {
                                ...
                                return i && this.scrollTo(i, 0, { duration: 0 }), t();
                            }.bind(this)
                        );
                    }),
                    (r.onInit = function () {
            ...
            Do = (function () {
                ...
                return (
                    (e.init = function () {
                        this.el || this.create(), this.createSetter(), this.bind(), this.render(!0), (this.ticker = this.render.bind(this, !1)), Ui.ticker.add(this.ticker);
                    }),
                    (e.create = function () {
                    ...
                    (e.createSetter = function () {
                        this.setter = {
                            ...
                            inner: { rotation: Ui.quickSetter(this.inner, "rotation", "deg") },
                        };
                    }),
                    (e.bind = function () {
                        var t = this;
                        (this.event.mouseleave = function () {
                            ...
                            this.container.addEventListener("mousedown", this.event.mousedown, { passive: !0 }),
                            this.container.addEventListener("mouseup", this.event.mouseup, { passive: !0 }),
                            ...
                            (this.options.stateDetection || this.options.dataAttr) &&
                                (this.container.addEventListener("mouseover", this.event.mouseover, { passive: !0 }), this.container.addEventListener("mouseout", this.event.mouseout, { passive: !0 }));
                    }),
                    (e.render = function (t) {
                    ...
                    (e.setVideo = function (t) {
                        this.mediaVideo || ((this.mediaVideo = document.createElement("video")), (this.mediaVideo.muted = !0), (this.mediaVideo.loop = !0), (this.mediaVideo.autoplay = !0)),
                            this.mediaVideo.src !== t && ((this.mediaVideo.src = t), this.mediaVideo.load()),
        ...
        var So = (function (t) {
            ...
            function i() {
                var e;
                return ((e = t.apply(this, arguments) || this).page = e.app.get("page")), e.init(), e;
            }
            return (
                (n = t),
        ...
        var Eo = (function (t) {
                ...
                (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Co(e, n);
                var r = i.prototype;
                return (
                    (r.show = function () {
                        this.el.classList.add("-front"), this.el.classList.add("-visible"), document.documentElement.classList.add("loader");
                    }),
                    (r.hide = function () {
                        this.el.classList.remove("-visible"), document.documentElement.classList.remove("loader");
                    }),
                    (r.onInit = function () {
                        return new Promise(function (t, e) {
                            return t(
        ...
        var Uo = function (t) {
            return null == t ? (void 0 === t ? "[object Undefined]" : "[object Null]") : Yo && Yo in Object(t) ? Go(t) : Xo(t);
        };
        var Qo = function (t) {
        ...
        var is = function (t, e, n) {
            return void 0 === n && ((n = e), (e = void 0)), void 0 !== n && (n = (n = ns(n)) == n ? n : 0), void 0 !== e && (e = (e = ns(e)) == e ? e : 0), Oo(ns(t), e, n);
        };
        function rs(t, e) {
            return (
                void 0 === t && (t = -1 / 0),
                ...
                function (n, i) {
                    ...
                    Object.defineProperty(n, i, {
                        ...
                        set: function (n) {
                            Object.defineProperty(this, r, { value: is(n, t, e), enumerable: !1, writable: !0, configurable: !0 });
                        },
                        enumerable: !0,
                        configurable: !0,
                    });
        ...
        var us = function (t, e, n) {
            ...
            return (
                (e = ns(e) || 0),
                Io(n) && ((c = !!n.leading), (o = (d = "maxWait" in n) ? as(ns(n.maxWait) || 0, e) : o), (p = "trailing" in n ? !!n.trailing : p)),
                (y.cancel = function () {
        ...
        function cs() {
            ...
            return function (e, n, i) {
                ...
                return {
                    get: function () {
                        return this.hasOwnProperty(n) || Object.defineProperty(this, n, { value: us.apply(void 0, ko([r], t)) }), this[n];
                    },
                };
            };
        }
            ...
            return (
                ...
                function (t, n, i) {
                    ...
                    n.split(/\s+/g).forEach(function (n) {
                        e.push({ elem: t, eventName: n, handler: r }), t.addEventListener(n, r, hs());
                    });
                }
            );
        }
        ...
        var ws,
            Ds = (function () {
                function t(t) {
                    (this.updateTime = Date.now()), (this.delta = { x: 0, y: 0 }), (this.velocity = { x: 0, y: 0 }), (this.lastPosition = { x: 0, y: 0 }), (this.lastPosition = vs(t));
                }
                return (
                    (t.prototype.update = function (t) {
                        var e = this.velocity,
                            ...
                            l = (s.x / a) * 16,
                            u = (s.y / a) * 16;
                        (e.x = 0.9 * l + 0.1 * e.x), (e.y = 0.9 * u + 0.1 * e.y), (this.delta = s), (this.updateTime = r), (this.lastPosition = o);
                    }),
                    t
                );
            })(),
        ...
        var Ss = (function () {
                ...
                return (
                    ...
                    (t.prototype.update = function (t, e, n) {
                        (this.realSize = Math.min(e / n, 1) * e), (this.displaySize = Math.max(this.realSize, this._minSize)), (this.offset = (t / n) * (e + (this.realSize - this.displaySize))), xs(this.element, this._getStyle());
                    }),
            ...
            Cs = (function () {
                ...
                return (
                    ...
                    (t.prototype.update = function (t, e, n) {
                        xs(this.element, { display: n <= e ? "none" : "block" }), this.thumb.update(t, e, n);
                    }),
                    t
                );
            })(),
            Es = (function () {
                function t(t) {
                    ...
                    (this.xAxis = new Cs(ws.X, e)), (this.yAxis = new Cs(ws.Y, e)), this.xAxis.attachTo(t.containerEl), this.yAxis.attachTo(t.containerEl), t.options.alwaysShowTracks && (this.xAxis.show(), this.yAxis.show());
                }
                return (
        ...
        var As = (function () {
                function t(t, e) {
                    ...
                    (this.scrollbar = t), (this.name = n.pluginName), (this.options = Po(Po({}, n.defaultOptions), e));
                }
                return (
        ...
        function Ls(t) {
            ...
            function p(t) {
                return gs(t, [u.element, u.thumb.element]) ? Bs.X : gs(t, [c.element, c.thumb.element]) ? Bs.Y : void 0;
            }
            s(a, "click", function (e) {
                ...
                s(a, "mousedown", function (n) {
                    if (gs(n.target, [u.thumb.element, c.thumb.element])) {
                        ...
                        (r = p(s)), (i = { x: l.x - d.left, y: l.y - d.top }), (o = a.getBoundingClientRect()), xs(t.containerEl, { "-user-select": "none" });
                    }
                }),
                ...
                s(window, "mouseup blur", function () {
                    (e = n = !1), xs(t.containerEl, { "-user-select": "" });
                });
        }
        !(function (t) {
            (t[(t.X = 0)] = "X"), (t[(t.Y = 1)] = "Y");
        ...
        function Ns(t) {
            ms(t)(t.options.delegateTo || t.containerEl, "onwheel" in window || document.implementation.hasFeature("Events.wheel", "3.0") ? "wheel" : "mousewheel", function (e) {
                var n = (function (t) {
                        if ("deltaX" in t) {
                            var e = (function (t) {
                                return Vs[t] || Vs[0];
                            })(t.deltaMode);
                            return { x: (t.deltaX / qs) * e, y: (t.deltaY / qs) * e };
                        }
                        if ("wheelDeltaX" in t) return { x: t.wheelDeltaX / Ws, y: t.wheelDeltaY / Ws };
                        return { x: 0, y: t.wheelDelta / Ws };
                    })(e),
                    i = n.x,
                    r = n.y;
            ...
            Gs = (function () {
                function t(t, e) {
                    ...
                    (this.options = new ps(e)),
                        ...
                        xs(t, { overflow: "hidden", outline: "none" }),
                ...
                return (
                    ...
                    (t.prototype.getSize = function () {
                        return (
                            ...
                            (r = ["paddingTop", "paddingBottom", "paddingLeft", "paddingRight"].map(function (t) {
                                return i[t] ? parseFloat(i[t]) : 0;
                            })),
                            (o = r[0] + r[1]),
                            (s = r[2] + r[3]),
                            { container: { width: e.clientWidth, height: e.clientHeight }, content: { width: n.offsetWidth - n.clientWidth + n.scrollWidth + s, height: n.offsetHeight - n.clientHeight + n.scrollHeight + o } }
                        );
                        var t, e, n, i, r, o, s;
                    }),
                    (t.prototype.update = function () {
                    ...
                    (t.prototype.setPosition = function (t, e, n) {
                        ...
                        var r = (function (t, e, n) {
                            ...
                            return (
                                ...
                                e === r.x && n === r.y ? null : ((r.x = e), (r.y = n), xs(a, { "-transform": "translate3d(" + -e + "px, " + -n + "px, 0)" }), s.update(), { offset: Po({}, r), limit: Po({}, o) })
                            );
                        })(this, t, e);
                        r &&
                            !n.withoutCallbacks &&
                            ...
                            (function (t, e, n, i, r) {
                                ...
                                cancelAnimationFrame(Ts.get(t)),
                                    (function e() {
                                        ...
                                        if ((t.setPosition(p + h * r, f + m * r), n >= i)) "function" == typeof l && l.call(t);
                                        else {
                    ...
                    Ao([cs(100, { leading: !0 })], t.prototype, "_updateDebounced", null),
                    t
                );
            })(),
            $s = !1;
        ...
        var Ys = (function (t) {
            ...
            return (
                (function (t, e) {
                    ...
                    To(t, e), (t.prototype = null === e ? Object.create(e) : ((n.prototype = e.prototype), new n()));
                })(e, t),
                (e.init = function (t, e) {
        ...
        (Qs.pluginName = "Disable"), (Qs.defaultOptions = { disable: !1 });
        var Ks = Qs;
        function Zs(t, e) {
            return (Zs =
                Object.setPrototypeOf ||
        ...
        var Js = (function (t) {
            ...
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Zs(e, n);
            var r = i.prototype;
            return (
                ...
                (r.onRender = function (t) {
                    var e = t.x,
                        n = t.y;
                    n < 0 && !this.lockY && Math.abs(n) >= this.scrollbar.scrollTop && (this.scrollbar.setMomentum(0, -this.scrollbar.scrollTop), (this.lockY = -1)),
                        e < 0 && !this.lockX && Math.abs(e) >= this.scrollbar.scrollLeft && (this.scrollbar.setMomentum(-this.scrollbar.scrollLeft, 0), (this.lockX = -1)),
                        e > 0 && !this.lockX && Math.abs(e) >= this.scrollbar.limit.x - this.scrollbar.scrollLeft && (this.scrollbar.setMomentum(this.scrollbar.limit.x - this.scrollbar.scrollLeft, 0), (this.lockX = 1)),
                        n > 0 && !this.lockY && Math.abs(n) >= this.scrollbar.limit.y - this.scrollbar.scrollTop && (this.scrollbar.setMomentum(0, this.scrollbar.limit.y - this.scrollbar.scrollTop), (this.lockY = 1)),
                        0 === n && (this.lockY = null),
                        0 === e && (this.lockX = null);
                }),
                i
        ...
        document.documentMode && (window.requestAnimationFrame = window.requestAnimationFrame.bind(window)), Ui.registerPlugin(bo);
        var na = {
                el: document.body,
                vars: {
                    scrollTop: function (t) {
                        return arguments.length && (na.scrollbar.scrollTop = t), na.scrollbar.scrollTop;
                    },
            ...
            ia = (function (t) {
                ...
                function i(e, n) {
                    var i;
                    return (i = t.call(this, e, n) || this), (na.scrollbar = e), bo.scrollerProxy(na.el, na.vars), bo.defaults({ pinType: "transform" }), e.addListener(bo.update), i;
                }
                return (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), ea(e, n), i;
            })(Ys.ScrollbarPlugin);
        ...
        var sa = (function (t) {
            ...
            function i() {
                var e;
                return ((e = t.apply(this, arguments) || this).page = e.app.get("page")), (e.options = Object.assign({}, { continuousScrolling: !1, renderByPixels: !0, damping: 0.13 }, e.options)), e.init(), e;
            }
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), oa(e, n);
            var r = i.prototype;
            return (
                (r.init = function () {
                    var t = this;
                ...
                (r.override = function () {
                    ...
                    this.page.scrollProxy = {
                        ...
                        enable: function () {
                            return t.ssb.updatePluginOptions("Disable", { disable: !1 });
                        },
                        disable: function () {
                            return t.ssb.updatePluginOptions("Disable", { disable: !0 });
                        },
                    };
                }),
                (r.destroy = function () {
                    this.ssb.destroy(), (this.ssb = null), (this.page.scrollProxy = {}), document.documentElement.classList.remove("smooth");
                }),
        ...
        var ua = (function (t) {
                ...
                return (
                    ...
                    (n.bindScrollTo = function () {
                        ...
                        this.el.dataset.scrollTo &&
                            this.el.addEventListener("click", function (e) {
                                e.preventDefault(), e.stopPropagation(), t.page.scrollTo(t.el.dataset.scrollTo);
                            });
                    }),
                    e
                );
            ...
            ca = (function (t) {
                function e() {
                    var e;
                    return ((e = t.apply(this, arguments) || this).fill = e.el.querySelector(".pt-btn_cta-fill")), (e.ripple = e.el.querySelectorAll(".pt-btn_cta-ripple")), (e.outTl = e.tlOut()), (e.hoverTl = e.tlHover()), e.bindHover(), e;
                }
                aa(e, t);
                var n = e.prototype;
                return (
                    (n.bindHover = function () {
                        ...
                        this.ripple.length && Ui.set(this.ripple, { display: "block" }),
                    ...
                    (n.tlHover = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return (
                            t.set(this.fill, { willChange: "transform", scale: 1 }),
                            t.to(this.fill, { scaleX: 1.03, scaleY: 0.98, duration: 1, ease: "elastic.out(1, 0.3)", force3D: !0 }, 0),
                            t.set(this.fill, { willChange: "auto" }),
                            this.ripple.length &&
                                (t.set(this.ripple, { willChange: "transform" }),
                                t.fromTo(this.ripple, { xPercent: -100 }, { xPercent: 0, stagger: { each: 0.2 }, duration: 1, ease: "expo.out", force3D: !0 }, 0),
                                t.set(this.ripple, { willChange: "auto" })),
                            t
                        );
                    }),
                    (n.tlOut = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return (
                            t.set(this.fill, { scaleX: 1.03, scaleY: 0.98, willChange: "transform" }, 0),
                            t.to(this.fill, { scaleX: 1, scaleY: 1, ease: "elastic.out(1, 0.3)", duration: 1, force3D: !0 }, 0),
                            t.set(this.fill, { willChange: "auto" }),
                            this.ripple.length &&
                                (t.set(this.ripple, { willChange: "transform" }),
                                t.set(this.ripple, { xPercent: 0 }, 0),
                                t.to(this.ripple, { xPercent: 100, stagger: { each: 0.2, from: "end" }, duration: 1, ease: "expo.out", immediateRender: !1, force3D: !0 }, 0),
                                t.set(this.ripple, { willChange: "auto" })),
                            t
                        );
                    }),
            ...
            da = (function (t) {
                function e() {
                    var e;
                    return ((e = t.apply(this, arguments) || this).fill = e.el.querySelector(".pt-btn_nav-fill")), (e.outTl = e.tlOut()), (e.hoverTl = e.tlHover()), e.bindHover(), e;
                }
                aa(e, t);
                var n = e.prototype;
                return (
                    ...
                    (n.tlHover = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return t.set(this.fill, { willChange: "transform" }), t.to(this.fill, { scale: 0.95, ease: "elastic.out(1, 0.3)", duration: 1, force3D: !0 }, 0), t.set(this.fill, { willChange: "auto" }), t;
                    }),
                    (n.tlOut = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return t.set(this.fill, { willChange: "transform" }), t.to(this.fill, { scale: 1, ease: "elastic.out(1, 0.3)", duration: 1, force3D: !0 }, 0), t.set(this.fill, { willChange: "auto" }), t;
                    }),
                    e
                );
            })(r),
            pa = (function (t) {
                function e() {
                    var e;
                    return ((e = t.apply(this, arguments) || this).fill = e.el.querySelector(".pt-btn_play-fill")), (e.outTl = e.tlOut()), (e.hoverTl = e.tlHover()), e.bindHover(), e;
                }
                aa(e, t);
                var n = e.prototype;
                return (
                    ...
                    (n.tlHover = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return t.set(this.fill, { willChange: "transform" }), t.to(this.fill, { scale: 0.9, ease: "elastic.out(1, 0.3)", duration: 1, force3D: !0 }, 0), t.set(this.fill, { willChange: "auto" }), t;
                    }),
                    (n.tlOut = function () {
                        var t = new Ui.timeline({ paused: !0 });
                        return t.set(this.fill, { willChange: "transform" }), t.to(this.fill, { scale: 1, ease: "elastic.out(1, 0.3)", duration: 1, force3D: !0 }, 0), t.set(this.fill, { willChange: "auto" }), t;
        ...
        var ha = (function (t) {
            ...
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), fa(e, n);
            var r = i.prototype;
            return (
                ...
                (r.hide = function () {
                    ...
                    this.trigger("hide"),
                        ...
                        clearInterval(this.visibleInt),
                        (this.visibleInt = setTimeout(function () {
                            t.el.classList.add("-show"), document.documentElement.classList.remove("modal"), t.trigger("hidden"), t.autoDestroy && t.destroy();
                        }, this.hideTimeout));
                }),
                (r.destroy = function () {
        ...
        var va = (function (t) {
            ...
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), ma(e, n);
            var r = i.prototype;
            return (
                (r.bind = function () {
                    var t = this;
                    this.toggleBtn &&
                        ...
                        this.app.on("scrolling", function (e) {
                            t.el.classList.toggle("-fixed", e > 10), t.lastY && t.el.classList.toggle("-visible", e > 10 && e < t.lastY), (t.lastY = e);
                        });
                }),
                (r.toggle = function () {
                ...
                (r.onEnter = function () {
                    return new Promise(
                        function (t, e) {
                            return this.page.scrollTop() > 10 && this.el.classList.add("-visible"), t();
                        }.bind(this)
                    );
                }),
                (r.onLeave = function () {
        ...
        var ya = (function (t) {
            ...
            function i() {
                var e;
                return ((e = t.apply(this, arguments) || this).page = e.app.get("page")), (e.button = e.el.querySelector("button")), e.bindScroll(), e.bindClick(), e;
            }
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), ga(e, n);
            var r = i.prototype;
            return (
        ...
        var xa = (function (t) {
            ...
            function i() {
                var e;
                return ((e = t.apply(this, arguments) || this).src = e.el.dataset.src), e.bindSwitch(), e;
            }
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), ba(e, n);
            var r = i.prototype;
            return (
        ...
        var Da = (function (t) {
                ...
                function i() {
                    var e;
                    return (
                        ((e = t.apply(this, arguments) || this).canvas = e.el.querySelector("canvas")),
                        (e.context = e.canvas.getContext("2d")),
                        (e.mouse = { x: e.el.offsetWidth / 2, y: -e.el.offsetHeight }),
                        (e.dots = []),
                        (e.enabled = !1),
                        (e.needsUpdate = !1),
                        e.init(),
                ...
                (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), wa(e, n);
                var r = i.prototype;
                return (
                    (r.init = function () {
                        var t = this;
                    ...
                    (r.refresh = function () {
                        if (this.height === this.el.offsetHeight && this.width === this.el.offsetWidth) return !1;
                    ...
                    (r.drawDot = function (t) {
                        var e = Math.sqrt(Math.pow(t.x - this.mouse.x, 2) + Math.pow(t.y - this.mouse.y, 2)),
                            n = Ui.utils.mapRange(t.radiusOrig, t.radiusOrig + this.proximityRatio, this.growthRatio, 0, e);
                        (t.radius = Math.max(n, t.radiusOrig, 0)),
                            this.context.moveTo(t.x * window.devicePixelRatio, t.y * window.devicePixelRatio),
                            this.context.arc(t.x * window.devicePixelRatio, t.y * window.devicePixelRatio, t.radius * window.devicePixelRatio, 0, 2 * Math.PI);
                    }),
                    (r.createDots = function (t, e) {
                        for (var n = Math.ceil(this.width / e) + 1, i = Math.ceil(this.height / e) + 1, r = Math.ceil(n * i), o = [], s = 0; s < r; s++) {
                            var a = e * (s % n),
                                l = e * ~~(s / n);
                            o.push({ x: a, y: l, radiusOrig: t, radius: t, size: e });
                        }
                        return o;
                    }),
                    (r.destroy = function () {
                        this.observer.disconnect(), (this.enabled = !1), Ui.ticker.remove(this.renderFn), window.removeEventListener("resize", this.resizeFn), document.body.removeEventListener("mousemove", this.mousemoveFn);
                    }),
                    (r.onDestroy = function () {
                        return new Promise(
                            function (t, e) {
        ...
        var Ea = (function (t) {
            ...
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Ca(e, n);
            var r = i.prototype;
            return (
                (r.startObserver = function () {
                    var t = this;
                ...
                (r.createWorld = function () {
                    (this.height = this.el.offsetHeight),
                        ...
                        (this.mouseConstraint = Sa.a.MouseConstraint.create(this.engine, { mouse: this.mouse, constraint: { render: { visible: !1 } } })),
                ...
                (r.createWalls = function () {
                    (this.wallL = Sa.a.Bodies.rectangle(-250, this.height / 2, 500, 4 * this.height, { isStatic: !0 })),
                        (this.wallR = Sa.a.Bodies.rectangle(this.width + 250, this.height / 2, 500, 4 * this.height, { isStatic: !0 })),
                        (this.wallB = Sa.a.Bodies.rectangle(0, this.height + 250, 2 * this.width, 500, { isStatic: !0 })),
                        Sa.a.Composite.add(this.engine.world, [this.wallB, this.wallL, this.wallR]);
                }),
                (r.createTopWall = function () {
                    (this.wallT = Sa.a.Bodies.rectangle(0, -250, 2 * this.width, 500, { isStatic: !0 })), Sa.a.Composite.add(this.engine.world, [this.wallT]);
                }),
                ...
                (r.updateWalls = function () {
                    this.wallT && Sa.a.Body.setVertices(this.wallT, Sa.a.Bodies.rectangle(0, -250, 2 * this.width, 500, { isStatic: !0 }).vertices),
                        this.wallL && (Sa.a.Body.setPosition(this.wallL, { x: -250, y: this.height / 2 }), Sa.a.Body.setVertices(this.wallL, Sa.a.Bodies.rectangle(-250, this.height / 2, 500, 4 * this.height, { isStatic: !0 }).vertices)),
                        this.wallR &&
                            (Sa.a.Body.setPosition(this.wallR, { x: this.width + 250, y: this.height / 2 }),
                            Sa.a.Body.setVertices(this.wallR, Sa.a.Bodies.rectangle(this.width + 250, this.height / 2, 500, 4 * this.height, { isStatic: !0 }).vertices)),
                        this.wallB && (Sa.a.Body.setPosition(this.wallB, { x: 0, y: this.height + 250 }), Sa.a.Body.setVertices(this.wallB, Sa.a.Bodies.rectangle(0, this.height + 250, 2 * this.width, 500, { isStatic: !0 }).vertices));
                }),
                    ...
                    (this.bodies = []),
                        this.item.forEach(function (e, n) {
                            var i = e.querySelector("span"),
                                ...
                                d = Sa.a.Bodies.rectangle(u, l, r.width, r.height, { chamfer: { radius: c }, angle: a, isStatic: !0, restitution: 0.3 });
                            t.bodies.push(d),
                                Sa.a.Composite.add(t.engine.world, [d]),
                                Sa.a.Events.on(t.runner, "tick", function () {
                                    t.runner.enabled && ((i.style.transform = "translate(-50%,-50%) rotate(" + d.angle.toFixed(2) + "rad)"), s(d.position.y.toFixed(1)), o(d.position.x.toFixed(1)));
                                });
                        });
                }),
                (r.updateBodies = function () {
                    ...
                    this.item.forEach(function (e, n) {
                        var i = t.bodies[n],
                            ...
                            a = Sa.a.Bodies.rectangle(i.position.x, i.position.y, o.width, o.height, { chamfer: { radius: s }, angle: i.angle });
                        if ((Sa.a.Body.setVertices(i, a.vertices), i.position.y > t.height && Sa.a.Body.setPosition(i, { y: t.height / 2, x: i.position.x }), i.position.x > t.width)) {
                            var l = Ui.utils.random(o.width / 2, t.width - o.width / 2);
                            Sa.a.Body.setPosition(i, { y: i.position.y, x: l });
                        }
                    });
                }),
                (r.unfoldBodies = function () {
                    ...
                    var n = !0;
                    Sa.a.Events.on(this.runner, "tick", function () {
                        n && t.bodies[t.bodies.length - 1].position.y > 70 && (t.createTopWall(), t.isLg || t.makeScrollGravity(), (n = !1));
                    });
                }),
                (r.destroy = function () {
                    this.observer.disconnect(), this.unfoldObserver.disconnect(), (this.runner.enabled = !1), Sa.a.Runner.stop(this.runner), window.removeEventListener("resize", this.resizeFn);
                }),
                (r.onDestroy = function () {
                    return new Promise(
                        function (t, e) {
        ...
        var Pa,
            ...
            Fa = (function (t) {
                ...
                function i() {
                    ...
                    return (
                        ((e = t.apply(this, arguments) || this).canvas = e.el.querySelector("canvas")),
                        (e.context = e.canvas.getContext("2d")),
                        (e.mouse = { x: -window.innerWidth, y: -window.innerHeight }),
                        (e.arrows = []),
                        (e.enabled = !1),
                        (e.needsUpdate = !1),
                        e.init(),
                ...
                (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Ta(e, n);
                var r = i.prototype;
                return (
                    (r.init = function () {
                        var t = this;
                    ...
                    (r.refresh = function () {
                        ...
                        (this.height = this.el.offsetHeight),
                            ...
                            (this.canvas.width = this.canvas.offsetWidth * window.devicePixelRatio),
                            (this.canvas.height = this.canvas.offsetHeight * window.devicePixelRatio),
                            (this.arrows = window.innerWidth > 1200 ? this.createArrows(60, 60, 2, 15) : this.createArrows(40, 40, 2, 10)),
                            this.render(!0);
                    }),
                    (r.clear = function () {
                        this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
                    ...
                    (r.drawArrow = function (t) {
                        this.context.save(),
                            this.context.translate(t.x * window.devicePixelRatio, t.y * window.devicePixelRatio),
                    ...
                    (r.createArrows = function (t, e, n, i) {
                        for (var r = Math.ceil(this.canvas.width / t), o = Math.ceil(this.canvas.height / e), s = (this.canvas.width - r * t) / 2, a = (this.canvas.height - o * e) / 2, l = [], u = 0; u < r; u++)
                            for (var c = 0; c < o; c++) {
                                var d = s + t / 2 + u * t,
                                    p = a + e / 2 + c * e;
                                l.push({ x: d, y: p, column: u, row: c, rotation: 0, radius: n, size: i });
                            }
                        return l;
                    }),
                    (r.destroy = function () {
            ...
            Ia = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
            ja = { rect: ["width", "height"], circle: ["r", "r"], ellipse: ["rx", "ry"], line: ["x2", "y2"] },
            Ra = function (t) {
            ...
            $a = function (t) {
                ...
                var e,
                    ...
                    c = 1,
                    d = 1;
                Ga(t) && ((d = t.getScreenCTM()), (c = Wa(d.a * d.a + d.b * d.b)), (d = Wa(d.d * d.d + d.c * d.c)));
                try {
                    n = t.getBBox();
                } catch (t) {
                    Ha("Some browsers won't measure invisible elements (like display:none or masks inside defs).");
                }
                ...
                if (
                    ((n && (m || v)) ||
                        !ja[l] ||
                        ((m = qa(t, ja[l][0])), (v = qa(t, ja[l][1])), "rect" !== l && "line" !== l && ((m *= 2), (v *= 2)), "line" === l && ((f = qa(t, "x1")), (h = qa(t, "y1")), (m = Math.abs(m - f)), (v = Math.abs(v - h)))),
                    "path" === l)
                )
                    (r = u.strokeDasharray),
                        (u.strokeDasharray = "none"),
                        (e = t.getTotalLength() || 0),
                        c !== d && Ha("Warning: <path> length cannot be measured when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."),
                        (e *= (c + d) / 2),
                        (u.strokeDasharray = r);
                else if ("rect" === l) e = 2 * m * c + 2 * v * d;
                else if ("line" === l) e = Va(f, h, f + m, h + v, c, d);
                else if ("polyline" === l || "polygon" === l)
                    for (i = t.getAttribute("points").match(Ia) || [], "polygon" === l && i.push(i[0], i[1]), e = 0, o = 2; o < i.length; o += 2) e += Va(i[o - 2], i[o - 1], i[o], i[o + 1], c, d) || 0;
                else ("circle" !== l && "ellipse" !== l) || ((s = (m / 2) * c), (a = (v / 2) * d), (e = Math.PI * (3 * (s + a) - Wa((3 * s + a) * (s + 3 * a)))));
                return e || 0;
            },
            Xa = function (t, e) {
                ...
                var n = ka.getComputedStyle(t),
                    ...
                    o = i.indexOf(",");
                return o < 0 && (o = i.indexOf(" ")), (i = o < 0 ? e : za(i.substr(0, o))) > e && (i = e), [-r || 0, i - r || 0];
            },
            Ya = function () {
                Ba() && (document, (ka = window), (Ma = Pa = La()), (Aa = Pa.utils.toArray), (Oa = -1 !== ((ka.navigator || {}).userAgent || "").indexOf("Edge")));
            },
            Ua = {
                version: "3.8.0",
                name: "drawSVG",
                    ...
                    return (
                        ...
                        (s = (function (t, e, n) {
                            var i,
                                r,
                                o = t.indexOf(" ");
                            return o < 0 ? ((i = void 0 !== n ? n + "" : t), (r = t)) : ((i = t.substr(0, o)), (r = t.substr(o + 1))), (i = Na(i, e)) > (r = Na(r, e)) ? [r, i] : [i, r];
                        })(e, l, (o = Xa(t, l))[0])),
                        (this._length = Ra(l)),
                        ...
                        Oa && (a = ka.getComputedStyle(t)).strokeLinecap !== a.strokeLinejoin && ((s = za(a.strokeMiterlimit)), this.add(t.style, "strokeMiterlimit", s, s + 0.01)),
                ...
                render: function (t, e) {
                    ...
                    if (s) {
                        for (
                            ...
                            ((i = n / e._length), (e._length = n), e._offsetPT && ((e._offsetPT.s *= i), (e._offsetPT.c *= i)), e._dashPT ? ((e._dashPT.s *= i), (e._dashPT.c *= i)) : (e._dash *= i));
                            s;
                        ...
                        (r = e._dash || (t && 1 !== t && 1e-4) || 0),
                            (n = e._length - r + 0.1),
                            (o = e._offset),
                            r && o && r + Math.abs(o % e._length) > e._length - 0.2 && (o += o < 0 ? 0.1 : -0.1) && (n += 0.1),
                            (a.strokeDashoffset = r ? o : o + 0.001),
                            (a.strokeDasharray = n < 0.2 ? "none" : r ? r + "px," + (e._nowrap ? 999999 : n) + "px" : "0px, 999999px");
                    }
                },
                getLength: $a,
                getPosition: Xa,
        ...
        var Qa = /([\uD800-\uDBFF][\uDC00-\uDFFF](?:[\u200D\uFE0F][\uD800-\uDBFF][\uDC00-\uDFFF]){2,}|\uD83D\uDC69(?:\u200D(?:(?:\uD83D\uDC69\u200D)?\uD83D\uDC67|(?:\uD83D\uDC69\u200D)?\uD83D\uDC66)|\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC69\u200D(?:\uD83D\uDC69\u200D)?\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC69\u200D(?:\uD83D\uDC69\u200D)?\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|\uD83C\uDFF3\uFE0F\u200D\uD83C\uDF08|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD37-\uDD39\uDD3D\uDD3E\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])\u200D[\u2640\u2642]\uFE0F|\uD83D\uDC69(?:\uD83C[\uDFFB-\uDFFF])\u200D(?:\uD83C[\uDF3E\uDF73\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92])|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC6F\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD37-\uDD39\uDD3C-\uDD3E\uDDD6-\uDDDF])\u200D[\u2640\u2642]\uFE0F|\uD83C\uDDFD\uD83C\uDDF0|\uD83C\uDDF6\uD83C\uDDE6|\uD83C\uDDF4\uD83C\uDDF2|\uD83C\uDDE9(?:\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF])|\uD83C\uDDF7(?:\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC])|\uD83C\uDDE8(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF5\uDDF7\uDDFA-\uDDFF])|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uFE0F\u200D[\u2640\u2642]|(?:\uD83C[\uDFFB-\uDFFF])\u200D[\u2640\u2642])\uFE0F|(?:\uD83D\uDC41\uFE0F\u200D\uD83D\uDDE8|\uD83D\uDC69(?:\uD83C[\uDFFB-\uDFFF])\u200D[\u2695\u2696\u2708]|\uD83D\uDC69\u200D[\u2695\u2696\u2708]|\uD83D\uDC68(?:(?:\uD83C[\uDFFB-\uDFFF])\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708]))\uFE0F|\uD83C\uDDF2(?:\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF])|\uD83D\uDC69\u200D(?:\uD83C[\uDF3E\uDF73\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69]))|\uD83C\uDDF1(?:\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE])|\uD83C\uDDEF(?:\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5])|\uD83C\uDDED(?:\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA])|\uD83C\uDDEB(?:\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7])|[#\*0-9]\uFE0F\u20E3|\uD83C\uDDE7(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF])|\uD83C\uDDE6(?:\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF])|\uD83C\uDDFF(?:\uD83C[\uDDE6\uDDF2\uDDFC])|\uD83C\uDDF5(?:\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE])|\uD83C\uDDFB(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA])|\uD83C\uDDF3(?:\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF])|\uD83C\uDFF4\uDB40\uDC67\uDB40\uDC62(?:\uDB40\uDC77\uDB40\uDC6C\uDB40\uDC73|\uDB40\uDC73\uDB40\uDC63\uDB40\uDC74|\uDB40\uDC65\uDB40\uDC6E\uDB40\uDC67)\uDB40\uDC7F|\uD83D\uDC68(?:\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83D\uDC68|(?:(?:\uD83D[\uDC68\uDC69])\u200D)?\uD83D\uDC66\u200D\uD83D\uDC66|(?:(?:\uD83D[\uDC68\uDC69])\u200D)?\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|\uD83C[\uDF3E\uDF73\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92])|(?:\uD83C[\uDFFB-\uDFFF])\u200D(?:\uD83C[\uDF3E\uDF73\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]))|\uD83C\uDDF8(?:\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF])|\uD83C\uDDF0(?:\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF])|\uD83C\uDDFE(?:\uD83C[\uDDEA\uDDF9])|\uD83C\uDDEE(?:\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9])|\uD83C\uDDF9(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF])|\uD83C\uDDEC(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE])|\uD83C\uDDFA(?:\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF])|\uD83C\uDDEA(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA])|\uD83C\uDDFC(?:\uD83C[\uDDEB\uDDF8])|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uD83C[\uDFFB-\uDFFF])|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD37-\uDD39\uDD3D\uDD3E\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])|(?:[\u261D\u270A-\u270D]|\uD83C[\uDF85\uDFC2\uDFC7]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC70\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDCAA\uDD74\uDD7A\uDD90\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC]|\uD83E[\uDD18-\uDD1C\uDD1E\uDD1F\uDD30-\uDD36\uDDD1-\uDDD5])(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC68(?:\u200D(?:(?:(?:\uD83D[\uDC68\uDC69])\u200D)?\uD83D\uDC67|(?:(?:\uD83D[\uDC68\uDC69])\u200D)?\uD83D\uDC66)|\uD83C[\uDFFB-\uDFFF])|(?:[\u261D\u26F9\u270A-\u270D]|\uD83C[\uDF85\uDFC2-\uDFC4\uDFC7\uDFCA-\uDFCC]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66-\uDC69\uDC6E\uDC70-\uDC78\uDC7C\uDC81-\uDC83\uDC85-\uDC87\uDCAA\uDD74\uDD75\uDD7A\uDD90\uDD95\uDD96\uDE45-\uDE47\uDE4B-\uDE4F\uDEA3\uDEB4-\uDEB6\uDEC0\uDECC]|\uD83E[\uDD18-\uDD1C\uDD1E\uDD1F\uDD26\uDD30-\uDD39\uDD3D\uDD3E\uDDD1-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])?|(?:[\u231A\u231B\u23E9-\u23EC\u23F0\u23F3\u25FD\u25FE\u2614\u2615\u2648-\u2653\u267F\u2693\u26A1\u26AA\u26AB\u26BD\u26BE\u26C4\u26C5\u26CE\u26D4\u26EA\u26F2\u26F3\u26F5\u26FA\u26FD\u2705\u270A\u270B\u2728\u274C\u274E\u2753-\u2755\u2757\u2795-\u2797\u27B0\u27BF\u2B1B\u2B1C\u2B50\u2B55]|\uD83C[\uDC04\uDCCF\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF93\uDFA0-\uDFCA\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF4\uDFF8-\uDFFF]|\uD83D[\uDC00-\uDC3E\uDC40\uDC42-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDD7A\uDD95\uDD96\uDDA4\uDDFB-\uDE4F\uDE80-\uDEC5\uDECC\uDED0-\uDED2\uDEEB\uDEEC\uDEF4-\uDEF8]|\uD83E[\uDD10-\uDD3A\uDD3C-\uDD3E\uDD40-\uDD45\uDD47-\uDD4C\uDD50-\uDD6B\uDD80-\uDD97\uDDC0\uDDD0-\uDDE6])|(?:[#\*0-9\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u2660\u2663\u2665\u2666\u2668\u267B\u267F\u2692-\u2697\u2699\u269B\u269C\u26A0\u26A1\u26AA\u26AB\u26B0\u26B1\u26BD\u26BE\u26C4\u26C5\u26C8\u26CE\u26CF\u26D1\u26D3\u26D4\u26E9\u26EA\u26F0-\u26F5\u26F7-\u26FA\u26FD\u2702\u2705\u2708-\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763\u2764\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC04\uDCCF\uDD70\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE02\uDE1A\uDE2F\uDE32-\uDE3A\uDE50\uDE51\uDF00-\uDF21\uDF24-\uDF93\uDF96\uDF97\uDF99-\uDF9B\uDF9E-\uDFF0\uDFF3-\uDFF5\uDFF7-\uDFFF]|\uD83D[\uDC00-\uDCFD\uDCFF-\uDD3D\uDD49-\uDD4E\uDD50-\uDD67\uDD6F\uDD70\uDD73-\uDD7A\uDD87\uDD8A-\uDD8D\uDD90\uDD95\uDD96\uDDA4\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA-\uDE4F\uDE80-\uDEC5\uDECB-\uDED2\uDEE0-\uDEE5\uDEE9\uDEEB\uDEEC\uDEF0\uDEF3-\uDEF8]|\uD83E[\uDD10-\uDD3A\uDD3C-\uDD3E\uDD40-\uDD45\uDD47-\uDD4C\uDD50-\uDD6B\uDD80-\uDD97\uDDC0\uDDD0-\uDDE6])\uFE0F)/;
        var Ka,
            Za,
            Ja,
            tl = /(?:\r|\n|\t\t)/g,
            ...
            ol = function (t, e) {
                var n;
                return il(t) ? t : "string" == (n = typeof t) && !e && t ? rl.call(Ka.querySelectorAll(t), 0) : t && "object" === n && "length" in t ? rl.call(t, 0) : t ? [t] : [];
            },
            sl = function (t) {
            ...
            pl = function t(e) {
                ...
                for (n = 0; n < o; n++)
                    (i = r[n])._isSplit
                        ...
                        ? ((i.previousSibling.nodeValue += 3 === i.nodeType ? i.nodeValue : i.firstChild.nodeValue), e.removeChild(i))
            ...
            hl = function (t, e, n, i, r, o, s) {
                var a,
                    ...
                    q = "flex" === b.display,
                    W = t.style.display;
                for (z && (R = R.split("++").join("")), q && (t.style.display = "block"), u = (l = t.getElementsByTagName("*")).length, d = [], a = 0; a < u; a++) d[a] = l[a];
                if (B || j)
                    for (a = 0; a < u; a++)
                        ((p = (c = d[a]).parentNode === t) || j || (I && !L)) &&
                            ((y = c.offsetTop),
                            B && p && Math.abs(y - w) > E && ("BR" !== c.nodeName || 0 === a) && ((f = []), B.push(f), (w = y)),
                            j && ((c._x = c.offsetLeft), (c._y = y), (c._w = c.offsetWidth), (c._h = c.offsetHeight)),
                            B &&
                                (((c._isSplit && p) || (!I && p) || (L && p) || (!L && c.parentNode.parentNode === t && !c.parentNode._isSplit)) && (f.push(c), (c._x -= x), dl(c, t, O) && (c._wordEnd = !0)),
                ...
                for (a = 0; a < u; a++)
                    if (((p = (c = d[a]).parentNode === t), "BR" !== c.nodeName))
                        if (
                            ...
                            if (c._isSplit) for (c._next = l = c.nextSibling, c.parentNode.appendChild(c); l && 3 === l.nodeType && " " === l.textContent; ) (c._next = l.nextSibling), c.parentNode.appendChild(l), (l = l.nextSibling);
                            else
                                c.parentNode._isSplit
                                    ...
                                    : p ||
                                      ...
                                      P.push(c));
                        else c.parentNode._isSplit && !c._isSplit && "" !== c.innerHTML ? A.push(c) : I && !c._isSplit && ("span" === M && (c.style.display = "inline"), P.push(c));
                    else B || j ? (c.parentNode && c.parentNode.removeChild(c), d.splice(a--, 1), u--) : L || t.appendChild(c);
                for (a = N.length; --a > -1; ) N[a].parentNode.removeChild(N[a]);
                if (B) {
                    for (
                        j && ((v = Ka.createElement(M)), t.appendChild(v), (g = v.offsetWidth + "px"), (y = v.offsetParent === t ? 0 : t.offsetLeft), t.removeChild(v)), m = t.style.cssText, t.style.cssText = "display:none;";
                        t.firstChild;
                    ...
                    for (h = " " === O && (!j || (!L && !I)), a = 0; a < B.length; a++) {
                        for (
                            f = B[a], (v = Ka.createElement(M)).style.cssText = "display:block;text-align:" + T + ";position:" + (j ? "absolute;" : "relative;"), R && (v.className = R + (z ? a + 1 : "")), k.push(v), u = f.length, l = 0;
                            l < u;
                            l++
                        )
                            "BR" !== f[l].nodeName &&
                                ...
                                j && (0 === l && ((v.style.top = c._y + "px"), (v.style.left = x + y + "px")), (c.style.top = "0px"), y && (c.style.left = c._x - y + "px")));
                        0 === u ? (v.innerHTML = "&nbsp;") : L || I || (pl(v), ul(v, String.fromCharCode(160), " ")), j && ((v.style.width = g), (v.style.height = c._h + "px")), t.appendChild(v);
                    }
                    t.style.cssText = m;
                }
                j &&
                    (s > t.clientHeight && ((t.style.height = s - S + "px"), t.clientHeight < s && (t.style.height = s + D + "px")),
                    o > t.clientWidth && ((t.style.width = o - C + "px"), t.clientWidth < o && (t.style.width = o + _ + "px"))),
            ...
            ml = function (t, e, n, i) {
                var r,
                    ...
                    g = "</" + p + ">",
                    y = 1,
                    b = e.specialChars ? ("function" == typeof e.specialChars ? e.specialChars : al) : null,
                ...
                for (
                    ...
                    if (((u = r.charAt(s)), b && (d = b(r.substr(s), e.specialChars)))) (u = r.substr(s, d || 1)), (o += f && " " !== u ? i() + u + "</" + p + ">" : u), (s += d - 1);
                        ...
                        "{" === u && "{{LT}}" === r.substr(s, 6)
                            ? ((o += f ? i() + "{{LT}}</" + p + ">" : "{{LT}}"), (s += 5))
                            : (u.charCodeAt(0) >= 55296 && u.charCodeAt(0) <= 56319) || (r.charCodeAt(s + 1) >= 65024 && r.charCodeAt(s + 1) <= 65039)
                            ? ((a = ((r.substr(s, 12).split(Qa) || [])[1] || "").length || 2), (o += f && " " !== u ? i() + r.substr(s, a) + "</" + p + ">" : r.substr(s, a)), (s += a - 1))
                            : (o += f && " " !== u ? i() + u + "</" + p + ">" : u);
                ...
                if (3 !== e.nodeType || l > 1) {
                    for (n.absolute = !1, o = 0; o < l; o++)
                        ((s = a[o])._next = s._isFirst = s._parent = s._wordEnd = null),
                            (3 !== s.nodeType || /\S+/.test(s.nodeValue)) && (u && 3 !== s.nodeType && "inline" === nl(s).display && ((s.style.display = "inline-block"), (s.style.position = "relative")), (s._isSplit = !0), t(s, n, i, r));
            ...
            gl = (function () {
                function t(t, e) {
                    Ja || ((Ka = document), (Za = window), (Ja = 1)), (this.elements = ol(t)), (this.chars = []), (this.words = []), (this.lines = []), (this._originals = []), (this.vars = e || {}), this.split(e);
                }
                var e = t.prototype;
                return (
                    (e.split = function (t) {
                        this.isSplit && this.revert(), (this.vars = t = t || this.vars), (this._originals.length = this.chars.length = this.words.length = this.lines.length = 0);
                        for (var e, n, i, r = this.elements.length, o = t.tag ? t.tag : t.span ? "span" : "div", s = ll(t.wordsClass, o), a = ll(t.charsClass, o); --r > -1; )
                            (i = this.elements[r]), (this._originals[r] = i.innerHTML), (e = i.clientHeight), (n = i.clientWidth), vl(i, t, s, a), hl(i, t, this.chars, this.words, this.lines, n, e);
        ...
        var yl = function (t, e) {
                ...
                var r = new Ui.timeline(),
                    o = new gl(t, { type: "lines" });
                return (
                    r.set(t, { perspective: "1000px", transformStyle: "preserve-3d", transformOrigin: "center center" }, 0),
                    r.set(o.lines, { willChange: "transform" }, 0),
                    r.fromTo(o.lines, { opacity: 0 }, { opacity: 1, stagger: null != (n = e.stagger) ? n : 0.15, duration: 0.15 }, 0),
                    r.fromTo(
                        o.lines,
            ...
            bl = function (t, e) {
                ...
                return i.set(t, { willChange: "transform" }), i.fromTo(t, { scaleX: 1 }, { scaleX: 0.98, duration: null != (n = e.duration) ? n : 1, ease: "none", force3D: !0 }), i.set(t, { willChange: "auto" }), i;
            },
            xl = function (t, e, n) {
                var i;
                void 0 === n && (n = {});
            ...
            wl = function (t, e) {
                ...
                return (
                    n.set(i, { willChange: "transform" }, 0),
                    n.from(i, { opacity: 0, duration: 0.1 }, 0),
                    n.from(i, { scaleX: 0.3, duration: 1.6, ease: "elastic.out(0.4, 0.3)", force3D: !0 }, 0),
                    n.from(r, { opacity: 0, duration: 0.2 }, 0.2),
                    n.set(r, { willChange: "auto" }),
                    n
                );
            },
            Dl = function (t, e) {
                ...
                return (
                    n.set([t, i], { willChange: "transform" }, 0),
                    n.from(t, { opacity: 0, duration: 0.4 }, 0),
                    n.from(t, { scale: 0.2, duration: 2, ease: "expo.out", force3D: !0 }, 0),
                    n.from(i, { scale: 1.7, duration: 2, ease: "expo.out", force3D: !0 }, 0),
                    n.set([t, i], { willChange: "auto" }),
                    n
                );
            };
        function _l(t, e) {
        ...
        var Sl = (function (t) {
            ...
            (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), _l(e, n);
            var r = i.prototype;
            return (
                    ...
                    this.video.addEventListener("click", function () {
                        ...
                        this.cursor.follower &&
                            (this.video.addEventListener("mouseenter", function () {
                                t.videoLoaded && t.videoPlayed && t.cursor.follower.setIcon("times-o");
                            }),
                ...
                (r.playDemoVideo = function () {
                    this.videoLoaded || this.injectDemoVideo(), this.videoPlayer.play(), (this.videoPlay.style.display = "none"), (this.videoPlayed = !0), this.cursor.follower && this.cursor.follower.setIcon("times-o");
                }),
                (r.stopDemoVideo = function () {
                    this.videoPlayer.pause(), (this.videoPlay.style.display = ""), (this.videoPlayed = !1), this.cursor.follower && this.cursor.follower.removeIcon();
                }),
                (r.tlShow = function () {
                    var t = new Ui.timeline({ paused: !0 });
                    return (
                        t.add(yl(this.header, { stagger: 0.15 })),
                        t.add(wl(this.action), 0.45),
                        t.fromTo(this.notice, { opacity: 0 }, { opacity: 1, duration: 0.6 }, 0.9),
                        t.set(this.video, { willChange: "transform" }),
                        t.fromTo(this.video, { y: 40, opacity: 0 }, { y: 0, opacity: 1, duration: 2, ease: "expo.out", force3D: !0 }, 0.8),
                        t.set(this.video, { willChange: "auto" }),
                        t
                    );
                }),
                ...
                (r.tlScroll = function () {
                    ...
                    return (
                        t.fromTo(this.mask[0], { scale: 0.1 }, { scale: Math.max(r, i), duration: 0.6, ease: "none", force3D: !1 }, 0),
                        t.fromTo(this.line, { color: "#000" }, { color: "#bbb", duration: 0.2, ease: "none" }, 0),
                        t.fromTo(this.linePath, { drawSVG: "0% 0%" }, { drawSVG: "100% 0", duration: 0.7, ease: "none" }, 0),
                        t.set(this.fill, { backgroundColor: o }, 0.7),
                        t.set(this.mask, { display: "none" }, 0.7),
                        t.add(function () {}, 1),
                        t
                    );
                }),
                ...
                (r.tlHeadlineRoll = function () {
                    var t = this,
                        e = Ui.timeline();
                    return (
                        e.set(this.headlines, { willChange: "transform" }, 0),
                        e.to(
                            this.headlines,
                            {
                                x: function () {
                    ...
                    bo.saveStyles([this.fill]),
                        bo.matchMedia({
                            "(min-width:1024px)": function () {
                                bo.create({ animation: bl(t.fill), trigger: t.el, start: "bottom bottom", end: "bottom 90%", scrub: 0.2 });
                            },
                        });
                }),
                    ...
                    bo.matchMedia({
                        "(min-width:1024px)": function () {
                            bo.create({
                                ...
                                toggleClass: { targets: t.app.get("navbar").el, className: "-inverse" },
                            });
                        },
                    });
                }),
                (r.onInit = function () {
                    return new Promise(
                        function (t, e) {
                            return this.magicScroll(), this.magicHeadline(), this.magicFill(), this.magicNavbarInverse(), this.handleEnter(), t();
                        }.bind(this)
                    );
                }),
                (r.onEnter = function () {
        ...
        function El(t = {}, e = {}) {
            Object.keys(e).forEach((n) => {
                void 0 === t[n] ? (t[n] = e[n]) : Cl(e[n]) && Cl(t[n]) && Object.keys(e[n]).length > 0 && El(t[n], e[n]);
            });
        }
        const Tl = {
            body: {},
        ...
        function Il(t) {
            return function (...e) {
                if (void 0 === e[0]) {
                    for (let e = 0; e < this.length; e += 1) Ll.indexOf(t) < 0 && (t in this[e] ? this[e][t]() : Bl(this[e]).trigger(t));
                    return this;
                }
                return this.on(t, ...e);
            };
        ...
        const jl = {
                ...
                for (let t = 0; t < this.length; t += 1) {
                    ...
                    if (n)
                        for (l = 0; l < a.length; l += 1) {
                            const t = a[l];
                            e.dom7LiveListeners || (e.dom7LiveListeners = {}), e.dom7LiveListeners[t] || (e.dom7LiveListeners[t] = []), e.dom7LiveListeners[t].push({ listener: i, proxyListener: o }), e.addEventListener(t, o, r);
                        }
                    else
                        for (l = 0; l < a.length; l += 1) {
                            const t = a[l];
                            e.dom7Listeners || (e.dom7Listeners = {}), e.dom7Listeners[t] || (e.dom7Listeners[t] = []), e.dom7Listeners[t].push({ listener: i, proxyListener: s }), e.addEventListener(t, s, r);
                        }
                }
                return this;
            },
                        ...
                        if ((!n && o.dom7Listeners ? (s = o.dom7Listeners[e]) : n && o.dom7LiveListeners && (s = o.dom7LiveListeners[e]), s && s.length))
                            for (let t = s.length - 1; t >= 0; t -= 1) {
                                ...
                                (i && n.listener === i) || (i && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === i)
                                    ...
                                    : i || (o.removeEventListener(e, n.proxyListener, r), s.splice(t, 1));
                            }
                    }
                }
                return this;
            ...
            trigger: function (...t) {
                ...
                for (let r = 0; r < n.length; r += 1) {
                    ...
                    for (let n = 0; n < this.length; n += 1) {
                        const r = this[n];
                        if (e.CustomEvent) {
                            const n = new e.CustomEvent(o, { detail: i, bubbles: !0, cancelable: !0 });
            ...
            is: function (t) {
                ...
                if (t.nodeType || t instanceof Ol) {
                    for (r = t.nodeType ? [t] : t, o = 0; o < r.length; o += 1) if (r[o] === i) return !0;
                    return !1;
                }
                return !1;
            },
            ...
            append: function (...t) {
                ...
                for (let i = 0; i < t.length; i += 1) {
                    ...
                    for (let t = 0; t < this.length; t += 1)
                        ...
                        } else if (e instanceof Ol) for (let n = 0; n < e.length; n += 1) this[t].appendChild(e[n]);
            ...
            prepend: function (t) {
                ...
                for (n = 0; n < this.length; n += 1)
                    ...
                    } else if (t instanceof Ol) for (i = 0; i < t.length; i += 1) this[n].insertBefore(t[i], this[n].childNodes[0]);
            ...
            prev: function (t) {
                if (this.length > 0) {
                    const e = this[0];
                    return t ? (e.previousElementSibling && Bl(e.previousElementSibling).is(t) ? Bl([e.previousElementSibling]) : Bl([])) : e.previousElementSibling ? Bl([e.previousElementSibling]) : Bl([]);
                }
                return Bl([]);
            },
            prevAll: function (t) {
            ...
            parent: function (t) {
                const e = [];
                for (let n = 0; n < this.length; n += 1) null !== this[n].parentNode && (t ? Bl(this[n].parentNode).is(t) && e.push(this[n].parentNode) : e.push(this[n].parentNode));
                return Bl(e);
            },
            parents: function (t) {
                const e = [];
        ...
        Object.keys(jl).forEach((t) => {
            Object.defineProperty(Bl.fn, t, { value: jl[t], writable: !0 });
        });
        var Rl = Bl;
        function zl(t, e = 0) {
        ...
        function ql(t, e = "x") {
            ...
            return (
                ...
                "x" === e && (r = n.WebKitCSSMatrix ? o.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
                "y" === e && (r = n.WebKitCSSMatrix ? o.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
                r || 0
            );
        }
        function Wl(t) {
            ...
            for (let r = 1; r < t.length; r += 1) {
                ...
                if (null != o && ((i = o), !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                    ...
                    for (let n = 0, i = t.length; n < i; n += 1) {
                        ...
                        void 0 !== r && r.enumerable && (Wl(e[i]) && Wl(o[i]) ? (o[i].__swiper__ ? (e[i] = o[i]) : Vl(e[i], o[i])) : !Wl(e[i]) && Wl(o[i]) ? ((e[i] = {}), o[i].__swiper__ ? (e[i] = o[i]) : Vl(e[i], o[i])) : (e[i] = o[i]));
                    }
                }
            }
            var i;
        ...
        function Gl({ swiper: t, targetPosition: e, side: n }) {
            ...
            const l = e > r ? "next" : "prev",
                ...
                c = () => {
                    ...
                    let p = r + d * (e - r);
                    if ((u(p, e) && (p = e), t.wrapperEl.scrollTo({ [n]: p }), u(p, e)))
                        return (
                    ...
                    (Yl = (function ({ userAgent: t } = {}) {
                        ...
                        return (
                            !u &&
                                f &&
                                e.touch &&
                                ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${s}x${a}`) >= 0 &&
                                ((u = r.match(/(Version)\/([\d.]+)/)), u || (u = [0, 1, "13_0_0"]), (f = !1)),
        ...
        function Jl(t) {
            ...
            !!o.noSwipingClass && "" !== o.noSwipingClass && l.target && l.target.shadowRoot && t.path && t.path[0] && (u = Rl(t.path[0]));
            ...
            if (
                ...
                (d
                    ? (function (t, e = this) {
                          return (function e(n) {
                              return n && n !== Pl() && n !== kl() ? (n.assignedSlot && (n = n.assignedSlot), n.closest(t) || e(n.getRootNode().host)) : null;
                          })(e);
                      })(c, l.target)
                    : u.closest(c)[0])
            )
            ...
            if (
                ...
                let t = !0;
                u.is(r.focusableElements) && (t = !1), n.activeElement && Rl(n.activeElement).is(r.focusableElements) && n.activeElement !== u[0] && n.activeElement.blur();
                const i = t && e.allowTouchMove && o.touchStartPreventDefault;
                (!o.touchStartForcePreventDefault && !i) || u[0].isContentEditable || l.preventDefault();
            }
            e.emit("touchStart", l);
        }
        function tu(t) {
            ...
            if (!n.allowTouchMove) return (n.allowClick = !1), void (i.isTouched && (Object.assign(o, { startX: c, startY: d, currentX: c, currentY: d }), (i.touchStartTime = Nl())));
            ...
            if (i.isTouchEvent && e.activeElement && l.target === e.activeElement && Rl(l.target).is(i.focusableElements)) return (i.isMoved = !0), void (n.allowClick = !1);
            ...
            if (void 0 === i.isScrolling) {
                ...
                (n.isHorizontal() && o.currentY === o.startY) || (n.isVertical() && o.currentX === o.startX)
                    ? (i.isScrolling = !1)
                    : p * p + f * f >= 25 && ((t = (180 * Math.atan2(Math.abs(f), Math.abs(p))) / Math.PI), (i.isScrolling = n.isHorizontal() ? t > r.touchAngle : 90 - t > r.touchAngle));
            }
            ...
            (o.diff = h), (h *= r.touchRatio), s && (h = -h), (n.swipeDirection = h > 0 ? "prev" : "next"), (i.currentTranslate = h + i.startTranslate);
            let m = !0,
                v = r.resistanceRatio;
            if (
                (r.touchReleaseOnEdges && (v = 0),
                h > 0 && i.currentTranslate > n.minTranslate()
                    ? ((m = !1), r.resistance && (i.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + i.startTranslate + h) ** v))
                    : h < 0 && i.currentTranslate < n.maxTranslate() && ((m = !1), r.resistance && (i.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - i.startTranslate - h) ** v)),
        ...
        function eu(t) {
            ...
            let d;
            if (((n.isTouched = !1), (n.isMoved = !1), (n.startMoving = !1), (d = i.followFinger ? (o ? e.translate : -e.translate) : -n.currentTranslate), i.cssMode)) return;
            ...
            for (let t = 0; t < s.length; t += t < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
                ...
                void 0 !== s[t + e] ? d >= s[t] && d < s[t + e] && ((p = t), (f = s[t + e] - s[t])) : d >= s[t] && ((p = t), (f = s[s.length - 1] - s[s.length - 2]));
            }
            const h = (d - s[p]) / f,
                m = p < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
            if (c > i.longSwipesMs) {
                if (!i.longSwipes) return void e.slideTo(e.activeIndex);
                "next" === e.swipeDirection && (h >= i.longSwipesRatio ? e.slideTo(p + m) : e.slideTo(p)), "prev" === e.swipeDirection && (h > 1 - i.longSwipesRatio ? e.slideTo(p + m) : e.slideTo(p));
            } else {
                ...
                e.navigation && (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl)
                    ? l.target === e.navigation.nextEl
                        ? e.slideTo(p + m)
                        : e.slideTo(p)
                    : ("next" === e.swipeDirection && e.slideTo(p + m), "prev" === e.swipeDirection && e.slideTo(p));
            }
        }
        function nu() {
            const t = this,
        ...
        const au = (t, e) => {
            const n = Pl(),
                ...
                d = e;
            if (l.touch) {
                const e = !("touchstart" !== r.start || !l.passiveListener || !i.passiveListeners) && { passive: !0, capture: !1 };
                o[c](r.start, t.onTouchStart, e), o[c](r.move, t.onTouchMove, l.passiveListener ? { passive: !1, capture: u } : u), o[c](r.end, t.onTouchEnd, e), r.cancel && o[c](r.cancel, t.onTouchEnd, e);
            } else o[c](r.start, t.onTouchStart, !1), n[c](r.move, t.onTouchMove, u), n[c](r.end, t.onTouchEnd, !1);
            (i.preventClicks || i.preventClicksPropagation) && o[c]("click", t.onClick, !0),
                i.cssMode && s[c]("scroll", t.onScroll),
                i.updateOnWindowResize ? t[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", nu, !0) : t[d]("observerUpdate", nu, !0);
        };
            ...
            return function (n = {}) {
                ...
                "object" == typeof r && null !== r
                    ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === t[i] && (t[i] = { auto: !0 }),
                      i in t && "enabled" in r ? (!0 === t[i] && (t[i] = { enabled: !0 }), "object" != typeof t[i] || "enabled" in t[i] || (t[i].enabled = !0), t[i] || (t[i] = { enabled: !1 }), Vl(e, n)) : Vl(e, n))
                    : Vl(e, n);
            };
        }
        const du = {
                ...
                update: {
                    updateSize: function () {
                        ...
                        (e = void 0 !== t.params.width && null !== t.params.width ? t.params.width : i[0].clientWidth),
                            (n = void 0 !== t.params.height && null !== t.params.height ? t.params.height : i[0].clientHeight),
                            (0 === e && t.isHorizontal()) ||
                                (0 === n && t.isVertical()) ||
                    ...
                    updateSlides: function () {
                        ...
                        "string" == typeof b && b.indexOf("%") >= 0 && (b = (parseFloat(b.replace("%", "")) / 100) * o),
                            ...
                            i.centeredSlides && i.cssMode && (Hl(t.wrapperEl, "--swiper-centered-offset-before", ""), Hl(t.wrapperEl, "--swiper-centered-offset-after", ""));
                        ...
                        for (let r = 0; r < d; r += 1) {
                            S = 0;
                            const s = c.eq(r);
                            if ((_ && t.grid.updateSlide(r, s, d, e), "none" !== s.css("display"))) {
                                if ("auto" === i.slidesPerView) {
                                    C && (c[r].style[e("width")] = "");
                                    const o = getComputedStyle(s[0]),
                                        a = s[0].style.transform,
                                        l = s[0].style.webkitTransform;
                                    if ((a && (s[0].style.transform = "none"), l && (s[0].style.webkitTransform = "none"), i.roundLengths)) S = t.isHorizontal() ? s.outerWidth(!0) : s.outerHeight(!0);
                                    else {
                                        const t = n(o, "width"),
                                            e = n(o, "padding-left"),
                                            i = n(o, "padding-right"),
                                    ...
                                    a && (s[0].style.transform = a), l && (s[0].style.webkitTransform = l), i.roundLengths && (S = Math.floor(S));
                                } else (S = (o - (i.slidesPerView - 1) * b) / i.slidesPerView), i.roundLengths && (S = Math.floor(S)), c[r] && (c[r].style[e("width")] = S + "px");
                                c[r] && (c[r].swiperSlideSize = S),
                                    ...
                                    i.centeredSlides
                                        ? ((x = x + S / 2 + w / 2 + b),
                                          ...
                                          f.push(x))
                                        : (i.roundLengths && (x = Math.floor(x)), (D - Math.min(t.params.slidesPerGroupSkip, D)) % t.params.slidesPerGroup == 0 && p.push(x), f.push(x), (x = x + S + b)),
                                    (t.virtualSize += S + b),
                                    (w = S),
                                    (D += 1);
                            }
                        ...
                        if (
                            ...
                            s && a && ("slide" === i.effect || "coverflow" === i.effect) && r.css({ width: t.virtualSize + i.spaceBetween + "px" }),
                            i.setWrapperSize && r.css({ [e("width")]: t.virtualSize + i.spaceBetween + "px" }),
                            ...
                            for (let n = 0; n < p.length; n += 1) {
                                let r = p[n];
                                i.roundLengths && (r = Math.floor(r)), p[n] <= t.virtualSize - o && e.push(r);
                            }
                            (p = e), Math.floor(t.virtualSize - o) - Math.floor(p[p.length - 1]) > 1 && p.push(t.virtualSize - o);
                        }
                        if ((0 === p.length && (p = [0]), 0 !== i.spaceBetween)) {
                            const n = t.isHorizontal() && s ? "marginLeft" : e("marginRight");
                            c.filter((t, e) => !i.cssMode || e !== c.length - 1).css({ [n]: b + "px" });
                        }
                        ...
                        if ((Object.assign(t, { slides: c, snapGrid: p, slidesGrid: f, slidesSizesGrid: h }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                            Hl(t.wrapperEl, "--swiper-centered-offset-before", -p[0] + "px"), Hl(t.wrapperEl, "--swiper-centered-offset-after", t.size / 2 - h[h.length - 1] / 2 + "px");
                            const e = -t.snapGrid[0],
                                n = -t.slidesGrid[0];
                            (t.snapGrid = t.snapGrid.map((t) => t + e)), (t.slidesGrid = t.slidesGrid.map((t) => t + n));
                        }
                        d !== u && t.emit("slidesLengthChange"),
                            p.length !== g && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")),
                    ...
                    updateSlidesProgress: function (t = (this && this.translate) || 0) {
                        ...
                        for (let t = 0; t < i.length; t += 1) {
                            ...
                            ((d >= 0 && d < e.size - 1) || (p > 1 && p <= e.size) || (d <= 0 && p >= e.size)) && (e.visibleSlides.push(a), e.visibleSlidesIndexes.push(t), i.eq(t).addClass(n.slideVisibleClass)),
                                (a.progress = r ? -u : u),
                    ...
                    updateProgress: function (t) {
                        ...
                        const a = o,
                            l = s;
                        0 === i ? ((r = 0), (o = !0), (s = !0)) : ((r = (t - e.minTranslate()) / i), (o = r <= 0), (s = r >= 1)),
                            Object.assign(e, { progress: r, isBeginning: o, isEnd: s }),
                    ...
                    updateSlidesClasses: function () {
                        const t = this,
                            { slides: e, params: n, $wrapperEl: i, activeIndex: r, realIndex: o } = t,
                        ...
                        e.removeClass(`${n.slideActiveClass} ${n.slideNextClass} ${n.slidePrevClass} ${n.slideDuplicateActiveClass} ${n.slideDuplicateNextClass} ${n.slideDuplicatePrevClass}`),
                            (a = s ? t.$wrapperEl.find(`.${n.slideClass}[data-swiper-slide-index="${r}"]`) : e.eq(r)),
                    ...
                    updateActiveIndex: function (t) {
                        const e = this,
                            ...
                            { slidesGrid: i, snapGrid: r, params: o, activeIndex: s, realIndex: a, snapIndex: l } = e;
                        let u,
                            c = t;
                        if (void 0 === c) {
                            for (let t = 0; t < i.length; t += 1) void 0 !== i[t + 1] ? (n >= i[t] && n < i[t + 1] - (i[t + 1] - i[t]) / 2 ? (c = t) : n >= i[t] && n < i[t + 1] && (c = t + 1)) : n >= i[t] && (c = t);
                        ...
                        if ((u >= r.length && (u = r.length - 1), c === s)) return void (u !== l && ((e.snapIndex = u), e.emit("snapIndexChange")));
                        const d = parseInt(e.slides.eq(c).attr("data-swiper-slide-index") || c, 10);
                        Object.assign(e, { snapIndex: u, realIndex: d, previousIndex: s, activeIndex: c }),
                    ...
                    updateClickedSlide: function (t) {
                        ...
                        (e.clickedSlide = i),
                            e.virtual && e.params.virtual.enabled ? (e.clickedIndex = parseInt(Rl(i).attr("data-swiper-slide-index"), 10)) : (e.clickedIndex = r),
                ...
                translate: {
                    ...
                    setTranslate: function (t, e) {
                        ...
                        n.isHorizontal() ? (u = i ? -t : t) : (c = t),
                            ...
                            r.cssMode ? (s[n.isHorizontal() ? "scrollLeft" : "scrollTop"] = n.isHorizontal() ? -u : -c) : r.virtualTranslate || o.transform(`translate3d(${u}px, ${c}px, 0px)`),
                    ...
                    translateTo: function (t = 0, e = this.params.speed, n = !0, i = !0, r) {
                        ...
                        const l = o.minTranslate(),
                            u = o.maxTranslate();
                        let c;
                        if (((c = i && t > l ? l : i && t < u ? u : t), o.updateProgress(c), s.cssMode)) {
                            const t = o.isHorizontal();
                            if (0 === e) a[t ? "scrollLeft" : "scrollTop"] = -c;
                            else {
                                if (!o.support.smoothScroll) return Gl({ swiper: o, targetPosition: -c, side: t ? "left" : "top" }), !0;
                                a.scrollTo({ [t ? "left" : "top"]: -c, behavior: "smooth" });
                            }
                            return !0;
                        }
                        return (
                            0 === e
                                ? (o.setTransition(0), o.setTranslate(c), n && (o.emit("beforeTransitionStart", e, r), o.emit("transitionEnd")))
                                : (o.setTransition(e),
                                  o.setTranslate(c),
                                  n && (o.emit("beforeTransitionStart", e, r), o.emit("transitionStart")),
                                  o.animating ||
                                      ((o.animating = !0),
                ...
                transition: {
                    ...
                    transitionStart: function (t = !0, e) {
                        const n = this,
                            { params: i } = n;
                        i.cssMode || (i.autoHeight && n.updateAutoHeight(), Zl({ swiper: n, runCallbacks: t, direction: e, step: "Start" }));
                    },
                    transitionEnd: function (t = !0, e) {
                        const { params: n } = this;
                        (this.animating = !1), n.cssMode || (this.setTransition(0), Zl({ swiper: this, runCallbacks: t, direction: e, step: "End" }));
                    },
                },
                slide: {
                    slideTo: function (t = 0, e = this.params.speed, n = !0, i, r) {
                        ...
                        if ((o.updateProgress(g), a.normalizeSlideIndex))
                            for (let t = 0; t < u.length; t += 1) {
                                ...
                                void 0 !== u[t + 1] ? (e >= n && e < i - (i - n) / 2 ? (s = t) : e >= n && e < i && (s = t + 1)) : e >= n && (s = t);
                            }
                        ...
                        if (((y = s > d ? "next" : s < d ? "prev" : "reset"), (p && -g === o.translate) || (!p && g === o.translate)))
                            return o.updateActiveIndex(s), a.autoHeight && o.updateAutoHeight(), o.updateSlidesClasses(), "slide" !== a.effect && o.setTranslate(g), "reset" !== y && (o.transitionStart(n, y), o.transitionEnd(n, y)), !1;
                        if (a.cssMode) {
                            const t = o.isHorizontal(),
                                n = p ? g : -g;
                            if (0 === e) {
                                ...
                                if (!o.support.smoothScroll) return Gl({ swiper: o, targetPosition: n, side: t ? "left" : "top" }), !0;
                    ...
                    slidePrev: function (t = this.params.speed, e = !0, n) {
                        const i = this,
                            { params: r, animating: o, snapGrid: s, slidesGrid: a, rtlTranslate: l, enabled: u } = i;
                        if (!u) return i;
                        if (r.loop) {
                        ...
                        return (
                            ...
                            r.rewind && i.isBeginning ? i.slideTo(i.slides.length - 1, t, e, n) : i.slideTo(h, t, e, n)
                        );
                    },
                    ...
                    slideToClickedSlide: function () {
                        ...
                        if (e.loop) {
                            ...
                            (r = parseInt(Rl(t.clickedSlide).attr("data-swiper-slide-index"), 10)),
                                e.centeredSlides
                                    ? o < t.loopedSlides - i / 2 || o > t.slides.length - t.loopedSlides + i / 2
                                        ? (t.loopFix(),
                                          (o = n.children(`.${e.slideClass}[data-swiper-slide-index="${r}"]:not(.${e.slideDuplicateClass})`).eq(0).index()),
                                          zl(() => {
                                              t.slideTo(o);
                                          }))
                                        : t.slideTo(o)
                    ...
                    loopCreate: function () {
                        ...
                        if (n.loopFillGroupWithBlank) {
                            ...
                            if (t !== n.slidesPerGroup) {
                                for (let i = 0; i < t; i += 1) {
                                    const t = Rl(e.createElement("div")).addClass(`${n.slideClass} ${n.slideBlankClass}`);
                                    r.append(t);
                                }
                        ...
                        o.each((e, n) => {
                            const i = Rl(e);
                            n < t.loopedSlides && a.push(e), n < o.length && n >= o.length - t.loopedSlides && s.push(e), i.attr("data-swiper-slide-index", n);
                        });
                        for (let t = 0; t < a.length; t += 1) r.append(Rl(a[t].cloneNode(!0)).addClass(n.slideDuplicateClass));
                        for (let t = s.length - 1; t >= 0; t -= 1) r.prepend(Rl(s[t].cloneNode(!0)).addClass(n.slideDuplicateClass));
                    },
                    loopFix: function () {
                        const t = this;
                        t.emit("beforeLoopFix");
                        const { activeIndex: e, slides: n, loopedSlides: i, allowSlidePrev: r, allowSlideNext: o, snapGrid: s, rtlTranslate: a } = t;
                        let l;
                ...
                breakpoints: {
                    setBreakpoint: function () {
                        const t = this,
                            { activeIndex: e, initialized: n, loopedSlides: i = 0, params: r, $el: o } = t,
                            s = r.breakpoints;
                        ...
                        const l = (a in s ? s[a] : void 0) || t.originalParams,
                            ...
                            d = r.enabled;
                        u && !c
                            ? (o.removeClass(`${r.containerModifierClass}grid ${r.containerModifierClass}grid-column`), t.emitContainerClasses())
                            : !u &&
                              c &&
                        ...
                        Object.assign(t, { allowTouchMove: t.params.allowTouchMove, allowSlideNext: t.params.allowSlideNext, allowSlidePrev: t.params.allowSlidePrev }),
                            ...
                            f && n && (t.loopDestroy(), t.loopCreate(), t.updateSlides(), t.slideTo(e - i + t.loopedSlides, 0, !1)),
                            t.emit("breakpoint", l);
                    },
                ...
                classes: {
                    addClasses: function () {
                        const { classNames: t, params: e, rtl: n, $el: i, device: r, support: o } = this,
                            s = (function (t, e) {
                                const n = [];
                                return (
                                    t.forEach((t) => {
                ...
                images: {
                    loadImage: function (t, e, n, i, r, o) {
                        ...
                        Rl(t).parent("picture")[0] || (t.complete && r) ? l() : e ? ((a = new s.Image()), (a.onload = l), (a.onerror = l), i && (a.sizes = i), n && (a.srcset = n), e && (a.src = e)) : l();
                    },
        ...
        class fu {
            constructor(...t) {
                let e, n;
                if ((1 === t.length && t[0].constructor && "Object" === Object.prototype.toString.call(t[0]).slice(8, -1) ? (n = t[0]) : ([e, n] = t), n || (n = {}), (n = Vl({}, n)), e && !n.el && (n.el = e), n.el && Rl(n.el).length > 1)) {
                    const t = [];
                    return (
                        Rl(n.el).each((e) => {
                            const i = Vl({}, n, { el: e });
                ...
                (i.__swiper__ = !0),
                    (i.support = Xl()),
                    (i.device = Ul({ userAgent: n.userAgent })),
                    (i.browser = Kl()),
                    (i.eventsListeners = {}),
                ...
                const r = {};
                i.modules.forEach((t) => {
                    t({ swiper: i, extendParams: cu(n, r), on: i.on.bind(i), once: i.once.bind(i), off: i.off.bind(i), emit: i.emit.bind(i) });
                });
                const o = Vl({}, uu, r);
                return (
                    (i.params = Vl({}, o, pu, n)),
            ...
            update() {
                ...
                n.breakpoints && t.setBreakpoint(),
                    ...
                    t.params.freeMode && t.params.freeMode.enabled
                        ...
                        : ((r = ("auto" === t.params.slidesPerView || t.params.slidesPerView > 1) && t.isEnd && !t.params.centeredSlides ? t.slideTo(t.slides.length - 1, 0, !1, !0) : t.slideTo(t.activeIndex, 0, !1, !0)), r || i()),
            ...
            static use(t) {
                return Array.isArray(t) ? (t.forEach((t) => fu.installModule(t)), fu) : (fu.installModule(t), fu);
            }
        }
                    ...
                    e("init", () => {
                        t.params.resizeObserver && void 0 !== i.ResizeObserver
                            ? t &&
                              ...
                              r.observe(t.el))
                            : (i.addEventListener("resize", o), i.addEventListener("orientationchange", s));
                    }),
                        e("destroy", () => {
                            r && r.unobserve && t.el && (r.unobserve(t.el), (r = null)), i.removeEventListener("resize", o), i.removeEventListener("orientationchange", s);
                        });
                },
                function ({ swiper: t, extendParams: e, on: n, emit: i }) {
                    const r = [],
                        ...
                        s = (t, e = {}) => {
                            ...
                            n.observe(t, { attributes: void 0 === e.attributes || e.attributes, childList: void 0 === e.childList || e.childList, characterData: void 0 === e.characterData || e.characterData }), r.push(n);
                        };
                    e({ observer: !1, observeParents: !1, observeSlideChildren: !1 }),
                        n("init", () => {
                            if (t.params.observer) {
                                ...
                                s(t.$el[0], { childList: t.params.observeSlideChildren }), s(t.$wrapperEl[0], { attributes: !1 });
                            }
                        }),
                        n("destroy", () => {
                            r.forEach((t) => {
                ...
                t.params.createElements &&
                    Object.keys(i).forEach((o) => {
                        if (!n[o] && !0 === n.auto) {
                            ...
                            s || ((s = r.createElement("div")), (s.className = i[o]), t.$el.append(s)), (n[o] = s), (e[o] = s);
                        }
                    }),
                n
            );
        ...
        hu.use(function ({ swiper: t, extendParams: e, on: n, emit: i }) {
            function r(e) {
                let n;
                return e && ((n = Rl(e)), t.params.uniqueNavElements && "string" == typeof e && n.length > 1 && 1 === t.$el.find(e).length && (n = t.$el.find(e))), n;
            }
            function o(e, n) {
                const i = t.params.navigation;
                e &&
                    e.length > 0 &&
                    (e[n ? "addClass" : "removeClass"](i.disabledClass), e[0] && "BUTTON" === e[0].tagName && (e[0].disabled = n), t.params.watchOverflow && t.enabled && e[t.isLocked ? "addClass" : "removeClass"](i.lockClass));
            }
            function s() {
            ...
            function u() {
                ...
                if (((t.params.navigation = mu(t, t.originalParams.navigation, t.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !e.nextEl && !e.prevEl)) return;
                const n = r(e.nextEl),
                    i = r(e.prevEl);
                n && n.length > 0 && n.on("click", l),
                    i && i.length > 0 && i.on("click", a),
                    Object.assign(t.navigation, { $nextEl: n, nextEl: n && n[0], $prevEl: i, prevEl: i && i[0] }),
                    t.enabled || (n && n.addClass(e.lockClass), i && i.addClass(e.lockClass));
            }
            function c() {
                const { $nextEl: e, $prevEl: n } = t.navigation;
                e && e.length && (e.off("click", l), e.removeClass(t.params.navigation.disabledClass)), n && n.length && (n.off("click", a), n.removeClass(t.params.navigation.disabledClass));
            }
            e({ navigation: { nextEl: null, prevEl: null, hideOnClick: !1, disabledClass: "swiper-button-disabled", hiddenClass: "swiper-button-hidden", lockClass: "swiper-button-lock" } }),
                ...
                Object.assign(t.navigation, { update: s, init: u, destroy: c });
        });
        function yu(t, e) {
            return (yu =
                Object.setPrototypeOf ||
        ...
        new o({
            define: [
                { namespace: "ajax", component: a, options: { updateSelectors: ["title", "meta", "#view-main"] } },
                { namespace: "page", component: wo },
                { namespace: "cursor", component: So },
                { namespace: "loader", assign: ".pt-loader", component: Eo },
                { namespace: "scrollbar", assign: ".pt-layout", component: sa },
                { namespace: "button", assign: ".pt-btn", component: ua },
                { namespace: "button.cta", assign: ".pt-btn_cta", component: ca },
                { namespace: "button.nav", assign: ".pt-btn_nav", component: da },
                { namespace: "button.play", assign: ".pt-btn_play", component: pa },
                { namespace: "modal", assign: ".pt-modal", component: ha },
                { namespace: "navbar", assign: ".pt-navbar", component: va },
                { namespace: "scroller", assign: ".pt-scroller", component: ya },
                { namespace: "embedded", assign: ".pt-embedded", component: xa },
                { namespace: "glancebox", assign: ".pt-glancebox", component: Da },
                { namespace: "fallbox", assign: ".pt-fallbox", component: Ea },
                { namespace: "chevronbox", assign: ".pt-chevronbox", component: Fa },
                { namespace: "hero", assign: ".pt-hero", component: Sl },
                {
                    namespace: "overview",
                    assign: ".pt-overview",
                    component: (function (t) {
                        ...
                        function i() {
                            ...
                            return (
                                ...
                                (e.navPrevBtn = e.el.querySelector(".pt-overview-nav.-prev button")),
                                (e.navNextBtn = e.el.querySelector(".pt-overview-nav.-next button")),
                                e.initCarousel(),
                                e
                            );
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), vu(e, n);
                        var r = i.prototype;
                        return (
                            (r.initCarousel = function () {
                                this.swiper = new hu(this.carousel, {
                                    ...
                                    spaceBetween: 20,
                                    speed: 800,
                                    navigation: { prevEl: this.navPrevBtn, nextEl: this.navNextBtn, lockClass: "-lock", hiddenClass: "-hidden", disabledClass: "-disabled" },
                            ...
                            (r.magicParallax = function () {
                                ...
                                bo.saveStyles([this.carousel]),
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ trigger: t.carousel, animation: t.tlParallax(), start: "top bottom", end: "bottom top", scrub: 0.3 });
                                        },
                                    });
                            }),
                            (r.tlParallax = function () {
                                var t = new Ui.timeline();
                                return t.set(this.carousel, { willChange: "transform" }), t.fromTo(this.carousel, { x: -100 }, { x: 100, ease: "none", force3D: !0 }, 0), t.set(this.carousel, { willChange: "auto" }), t;
                            }),
                            (r.magicMarquee = function () {
                                ...
                                this.logo.forEach(function (t) {
                                    ...
                                    this.logos.append(e);
                                var n = function () {
                                    bo.create({ animation: xl(t.logos, t.logo), trigger: t.bundle, start: "top bottom", end: "bottom top", toggleActions: "play pause play pause" });
                                };
                                bo.saveStyles([this.logos]), bo.matchMedia({ "(min-width:0px)": n, "(min-width:768px)": n, "(min-width:1600px)": n });
                            }),
                            (r.magicShow = function () {
                                bo.create({ animation: yl(this.header), trigger: this.header, start: "top bottom", once: !0 });
                            }),
                            (r.onInit = function () {
                                return new Promise(
                                    function (t, e) {
                                        return this.magicMarquee(), this.magicParallax(), this.magicShow(), t();
                                    }.bind(this)
                                );
                            }),
                            (r.onDestroy = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).fill = e.el.querySelector(".pt-definition-fill")),
                        ...
                        return (
                            (r.magicShow = function () {
                                ...
                                bo.create({
                                    ...
                                    bo.create({ animation: this.tlShow(), trigger: this.text, start: "top bottom", once: !0 });
                            }),
                            (r.tlShow = function () {
                                var t = Ui.timeline();
                                return (
                                    t.add(yl(this.text)),
                                    t.from(this.figure, { yPercent: window.innerWidth >= 1200 ? 100 : 50, duration: 2, ease: "expo.out", force3D: !0 }, 0.2),
                                    t.add(wl(this.action), 0.7),
                                    t.fromTo(this.notice, { opacity: 0 }, { opacity: 1, duration: 1 }, 0.9),
                                    t
                                );
                            }),
                            (r.magicFill = function () {
                                ...
                                bo.saveStyles([this.fill]),
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ animation: bl(t.fill), trigger: t.el, start: "top top-=90px", end: "20%", scrub: !0 });
                                        },
                                    });
                            }),
                            (r.onInit = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).fill = e.el.querySelector(".pt-billboard-fill")), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), yu(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicFill = function () {
                                var t = this;
                                bo.saveStyles([this.fill]),
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ animation: bl(t.fill), trigger: t.el, start: "center center", end: "bottom center", scrub: !0 });
                                        },
                                    });
                            }),
                            (r.onInit = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).roll = e.el.querySelector(".pt-feature-roll")),
                        ...
                        return (
                            (r.magicRoll = function () {
                                ...
                                bo.saveStyles([this.roll]),
                                    ...
                                    this.section.forEach(function (n, i) {
                                        var r = bo.create({ animation: t.tlShowSection(n), trigger: n, start: i > 1 && window.innerWidth >= 1024 ? "left right" : "center bottom", once: !0, horizontal: i > 1 && window.innerWidth >= 1024 });
                                        e.push(r);
                                    });
                            }),
                            ...
                            (r.tlRoll = function () {
                                var t = this,
                                    e = new Ui.timeline();
                                return (
                                    e.set(this.secions, { willChange: "transform" }),
                                    e.to(this.secions, {
                                        x: function () {
                                    ...
                                    this.section.forEach(function (t, n) {
                                        if (0 !== n) {
                                            ...
                                            e.set(i, { willChange: "transform" }),
                                                1 === n &&
                                                    e.to(
                                                        i,
                                                        {
                                                            x: function () {
                                                                return r.clientWidth - i.clientWidth;
                                                            },
                                                            duration: 0.35,
                                                            ease: "none",
                                                        },
                                                ...
                                                3 === n &&
                                                    e.to(
                                                        ...
                                                        {
                                                            x: function () {
                                                                return (r.clientWidth - i.clientWidth) / 2;
                                                            },
                                                            duration: 0.2,
                                                            ease: "none",
                                                        },
                                                ...
                                                e.set(i, { willChange: "auto" });
                                        }
                                    }),
                                    e.set(this.secions, { willChange: "auto" }, 1),
                                    e
                                );
                            }),
                            ...
                            (r.onDestroy = function () {
                                return new Promise(
                                    function (t, e) {
                                        return this.navbarNavObserver && this.navbarNavObserver.disconnect(), t();
                                    }.bind(this)
                                );
                            }),
                            i
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).header = e.el.querySelectorAll(".pt-advantage-header h2")), (e.section = e.el.querySelectorAll(".pt-advantage-section")), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), xu(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicShow = function () {
                                bo.create({ animation: yl(this.header), trigger: this.header, start: "top bottom", once: !0 });
                            ...
                            (r.magicFigure = function () {
                                ...
                                this.section.forEach(function (e, n) {
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ animation: t.tlSection(e, n), trigger: e, start: "top bottom", end: "bottom top", scrub: !0 });
                                        },
                                    });
                                    var i = e.querySelector("h3");
                                    bo.create({ animation: yl(i), trigger: i, start: "top bottom", once: !0 });
                                });
                            }),
                            (r.tlSection = function (t, e) {
                                ...
                                return (
                                    ...
                                    n.fromTo(i, { y: 100 }, { y: -100, duration: 1, ease: "none" }, 0),
                                    n.fromTo(r, { yPercent: -30 }, { yPercent: 30, duration: 1, ease: "none" }, 0),
                            ...
                            (r.magicNavbarInverse = function () {
                                ...
                                bo.matchMedia({
                                    "(min-width:1024px)": function () {
                                        bo.create({ trigger: t.el, start: "top top+=50px", end: "bottom top+=70px", toggleClass: { targets: t.app.get("navbar").el, className: "-inverse" } });
                                    },
                                });
                            }),
                            (r.onInit = function () {
                                return new Promise(
                                    function (t, e) {
                                        return this.magicShow(), this.magicFigure(), this.magicNavbarInverse(), t();
                                    }.bind(this)
                                );
                            }),
                            i
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).header = e.el.querySelector(".pt-explore-header > *")),
                        ...
                        return (
                            (r.magicShow = function () {
                                bo.create({ animation: yl(this.header), trigger: this.header, start: "top bottom", once: !0 }),
                                    bo.create({ animation: Dl(this.figure), trigger: this.figure, start: "top bottom", once: !0 }),
                                    bo.create({ animation: this.tlShowDetails(), trigger: this.details, start: "top bottom", once: !0 });
                            }),
                            (r.tlShowDetails = function () {
                                var t = new Ui.timeline();
                                return (
                                    t.set(this.detail, { willChange: "transform" }),
                                    t.from(this.detail, { opacity: 0, duration: 0.4, stagger: 0.1 }, 0),
                                    t.from(this.detail, { y: 40, duration: 2, stagger: 0.1, ease: "expo.out" }, 0),
                                    t.set(this.detail, { willChange: "auto" }),
                                    t
                                );
                            }),
                            (r.magicFill = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).header = e.el.querySelector(".pt-partner-header > *")),
                        ...
                        return (
                            (r.magicShow = function () {
                                bo.create({ animation: this.tlShow(), trigger: this.header, start: "top bottom", once: !0 });
                            }),
                            (r.tlShow = function () {
                                var t = new Ui.timeline();
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).header = e.el.querySelector(".pt-pricing-header.-lg > *")),
                        ...
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), _u(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicShow = function () {
                                var t = this;
                                bo.create({ animation: this.tlShowHeader(), trigger: this.header, start: "top bottom", once: !0 }),
                                    this.item.forEach(function (e, n) {
                                        bo.create({ animation: t.tlShowItem(e).delay(window.innerWidth >= 1024 ? 0.3 * n : 0), trigger: e, start: "top bottom", once: !0 });
                                    });
                            }),
                            (r.tlShowHeader = function () {
                                var t = new Ui.timeline();
                                return t.add(yl(this.header)), t.add(Dl(this.char), 0.4), t.add(yl(this.headerXs), 0.7), t;
                            }),
                            (r.tlShowItem = function (t, e) {
                                var n = new Ui.timeline();
                                return (
                                    n.set(t, { willChange: "transform" }), n.from(t, { opacity: 0, duration: 0.4, stagger: 0.1 }, 0), n.from(t, { y: 100, duration: 2, ease: "expo.out", force3D: !0 }, 0), n.set(t, { willChange: "auto" }), n
                                );
                            }),
                            (r.startNavbarNavObserver = function () {
                                var t = this.app.get("navbar").nav.find(function (t) {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return (
                                ((e = t.apply(this, arguments) || this).content = e.el.querySelector(".pt-tophead-content")),
                        ...
                        return (
                            ...
                            (r.tlShow = function () {
                                var t = new Ui.timeline({ paused: !0 });
                                return (
                                    this.header && t.add(yl(this.header, { stagger: 0.2, noRevert: !0 })),
                                    this.text && (t.set(this.text, { willChange: "transform" }), t.from(this.text, { y: 40, opacity: 0, duration: 2, ease: "expo.out" }, 1), t.set(this.text, { willChange: "auto" })),
                                    t
                                );
                            }),
                            (r.magicFill = function () {
                                ...
                                bo.saveStyles([this.fill, this.scene]),
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ animation: bl([t.fill, t.scene]), trigger: t.el, start: "bottom bottom", end: "bottom center", scrub: !0 });
                                        },
                                    });
                            }),
                            (r.magicNavbarInverse = function () {
                                bo.create({ trigger: this.el, start: "top top+=50px", end: "bottom top+=100px", scrub: !0, toggleClass: { targets: this.app.get("navbar").el, className: "-inverse" } });
                            }),
                            (r.onInit = function () {
                                return new Promise(
                                    function (t, e) {
                                        return this.magicFill(), this.magicNavbarInverse(), this.handleEnter(), t();
                                    }.bind(this)
                                );
                            }),
                            (r.onEnter = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).item = e.el.querySelectorAll(".pt-faq-item")), e.bindToggle(), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Cu(e, n);
                        var r = i.prototype;
                        return (
                            ...
                            (r.magicShow = function () {
                                Ui.set(this.item, { opacity: 0 }),
                                    bo.batch(this.item, {
                                        onEnter: function (t, e) {
                                            Ui.to(t, { opacity: 1, stagger: 0.15 });
                                        },
                                    });
                            }),
                            (r.onInit = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).item = Array.from(e.el.querySelectorAll(".pt-card-item"))), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Eu(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicShow = function () {
                                Ui.set(this.item, { opacity: 0, scale: 0.9 }),
                                    bo.batch(this.item, {
                                        onEnter: function (t, e) {
                                            Ui.set(t, { willChange: "transform" }),
                                                Ui.to(t, {
                                                    opacity: 1,
                                                    scale: 1,
                                                    stagger: 0.15,
                                                    force3D: !0,
                                                    onComplete: function () {
                                                        return Ui.set(t, { willChange: "auto" });
                                                    },
                                                });
                                        },
                                    });
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).header = e.el.querySelector(".pt-demo-header h1")), (e.text = e.el.querySelector(".pt-demo-text p")), (e.iframe = e.el.querySelector(".pt-demo-iframe")), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Tu(e, n);
                        var r = i.prototype;
                        return (
                            (r.handleEnter = function () {
                                this.enterTl = this.tlShow();
                            ...
                            (r.tlShow = function () {
                                var t = new Ui.timeline({ paused: !0 });
                                return this.header && t.add(yl(this.header)), this.text && t.add(yl(this.text), 0.2), this.iframe && t.fromTo(this.iframe, { opacity: 0 }, { opacity: 1, duration: 0.4, ease: "none" }, 0.6), t;
                            }),
                            (r.onInit = function () {
                                return new Promise(
                                    function (t, e) {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).header = e.el.querySelector(".pt-outro-header h2")), (e.action = e.el.querySelector(".pt-outro-action")), (e.fill = e.el.querySelector(".pt-outro-fill")), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Pu(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicShow = function () {
                                bo.create({ animation: this.tlShow(), trigger: this.header, start: "top bottom", once: !0 });
                            ...
                            (r.tlShow = function () {
                                var t = new Ui.timeline({ paused: !0 });
                                return t.add(yl(this.header, { stagger: 0.2 })), t.add(wl(this.action), 0.7), t;
                            }),
                            (r.magicFill = function () {
                                var t = this;
                                bo.saveStyles([this.fill]),
                                    bo.matchMedia({
                                        "(min-width:1024px)": function () {
                                            bo.create({ animation: bl(t.fill), trigger: t.el, start: "top top-=90px", end: "bottom center", scrub: !0 });
                                        },
                                    });
                            }),
                            (r.onInit = function () {
                ...
                },
                {
                    ...
                    component: (function (t) {
                        ...
                        function i() {
                            var e;
                            return ((e = t.apply(this, arguments) || this).main = e.el.querySelectorAll(".pt-footer-main")), e;
                        }
                        (n = t), ((e = i).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), Au(e, n);
                        var r = i.prototype;
                        return (
                            (r.magicParallax = function () {
                                var t = this;
                                bo.saveStyles([this.main]),
                                    bo.matchMedia({
                                        "(min-width:1050px)": function () {
                                            bo.create({ animation: t.tlParallax(), trigger: t.el, start: "top bottom", end: "bottom bottom", scrub: !0 });
                                        },
                                    });
                            }),
                            (r.tlParallax = function () {
                                var t = new Ui.timeline();
                                return t.set(this.main, { willChange: "transform" }), t.fromTo(this.main, { yPercent: -50 }, { yPercent: 0, ease: "none", force3D: !0 }), t.set(this.main, { willChange: "auto" }), t;
                            }),
                            (r.onInit = function () {
                                return new Promise(
                                    function (t, e) {
